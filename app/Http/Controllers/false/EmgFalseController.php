...
class EmgFalseController extends Controller
{
    ...
    public function false_emg_registation(Request $request)
    {
        ...
        $todays_revisit = EmgPatientDetails::where('appointment_date', 'like', $date . '%')->where('visit_type', '=', 'Revisit')->count();
        ...
        $todays_new_sys = EmgPatientDetails::where('appointment_date', 'like', $date . '%')->where('ins_by', '=', 'sys')->where('visit_type', '=', 'New Visit')->count();
        ...
        $todays_new_ori = EmgPatientDetails::where('appointment_date', 'like', $date . '%')->where('visit_type', '=', 'New Visit')->where('ins_by', '=', 'ori')->count();
        ...
        if (@$date) {
            return view('false.emg.false_patient_list', compact('radiology_category', 'emg_registaion_list', 'date',  'pathology_category', 'radiology_category', 'todays_total_emg', 'todays_new', 'todays_revisit', 'todays_total_for_this_department', 'todays_total_emg_sys', 'todays_new_sys', 'todays_revisit_sys', 'todays_total_for_this_department_sys', 'todays_total_emg_ori', 'todays_new_ori', 'todays_revisit_ori', 'todays_total_for_this_department_ori', 'pathology_category'));
        } else {
    ...
    public function registation_false_emg(Request $request)
    {
        try {
            ...
            foreach ($patient_details as $value) {
                ...
                $emg_visit_details->visit_type                  = $request->visit_type;
