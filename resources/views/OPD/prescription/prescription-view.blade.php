    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <span class="head_name">Date</span> : <span class="value_name">{{ @$opdPrescription->prescription_date }}</span>
                </div>

                <div class="col-md-4">
                    <span class="head_name">Note</span> : <span class="value_name">{{ @$opdPrescription->note}}</span>
                </div>
