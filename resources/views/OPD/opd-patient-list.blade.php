                    ...
                    <tbody>
                        @if (isset($opd_registaion_list))
                            @foreach ($opd_registaion_list as $value)
                                <tr>
                                    <td><a class="textlink"
                                            href="{{ route('opd-profile', ['id' => base64_encode($value->id)]) }}">{{ @$value->opd_prefix }}{{ @$value->id }}</a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @if (isset($value->latest_opd_visit_details_for_patient->appointment_date))
                                            ...
                                            {{ date('d-m-Y h:i A', strtotime($value->latest_opd_visit_details_for_patient->appointment_date)) }}
                                        @endif
                                    </td>
                                    <td>
