            ...
            <table>
                <tr>
                    ...
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;width:270px;">
                        ...
                        <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode('@@$opd_patient_details-all_patient_details->>patient_prefix @@$opd_patient_details->all_patient_details->patient_id', $generatorPNG::TYPE_CODE_128)) }}" style="width: 170px;height: 50px;">
                    </td>
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;width:260px;">
                        ...
                        ?>
                        <!-- <img src="{{ asset('public/hospital_details/qr.png') }}" style="width: 80px;"> -->
                        <span style="width: 60px;height:60px">{!! QrCode::size(55)->generate($opd_de); !!} </span>
                    </td>
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>Appointment Date: {{@$opd_patient_details->latest_opd_visit_details_for_patient->appointment_date}}</b>
                    </td>
            ...
            <table style="width: 100%; margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{@$opd_patient_details->all_patient_details->first_name}} {{@$opd_patient_details->all_patient_details->middle_name}}
                        {{@$opd_patient_details->all_patient_details->last_name}}
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Guardian Name
                    </th>
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{@$opd_patient_details->all_patient_details->gurdaian_name}}
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Mobile No.
                    </th>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td colspan="7" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{@$opd_patient_details->all_patient_details->address}},{{@$opd_patient_details->all_patient_details->_state->name}},
                        {{@$opd_patient_details->all_patient_details->_district->name}},
                        {{@$opd_patient_details->all_patient_details->pin_no}}
                    </td>
...
border-bottom: 1px solid black;">
                <tr>
                    ...
                    <td style="text-align: left;font-size: 13px;">
                        {{@$opdPaymentDetails->payment_date }}
                    </td>
                    ...
                    <td style="text-align: right;font-size: 13px; padding: 0px 10px 0px 0px;">
                        {{@$opdPaymentDetails->payment_amount }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 13px;">
                        {{@$opdPaymentDetails->generated_by->first_name }} {{@$opdPaymentDetails->generated_by->last_name }}
                    </td>
                    <th style="text-align: left;font-size: 13px;">
                        Payment Mode:
                    </th>
                    <td style="text-align: right;font-size: 13px; padding: 0px 10px 0px 0px;">
                    {{@$opdPaymentDetails->payment_mode }}
                    </td>
                ...
                <!-- <tr>
                    ...
                    <td style="text-align: right;font-size: 13px; padding: 0px 10px 0px 0px;">
                        {{@$opdPaymentDetails->payment_recived_by }}
                    </td>
                </tr> -->
            </table>
        </table>
