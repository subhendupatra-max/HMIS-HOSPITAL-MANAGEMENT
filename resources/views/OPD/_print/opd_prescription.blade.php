        ...
        <table style="width: 100%;border-collapse: collapse">
            ...
            <table>
                <tr>
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>UHID No:IIMSAR & DR.BCRHH/1050610</b>
                    </td>
                    ...
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>Cons. Doctor: {{$opd_patient_details->generator_details->first_name}} {{$opd_patient_details->generator_details->last_name}}</b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b>Department: {{$opd_patient_details->department_details->department_name}}</b></td>
                </tr>
            </table>
            <table style="width: 100%; ;margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
                <tr>
                    ...
                    {{$opd_patient_details->patient_details->first_name}}    {{$opd_patient_details->patient_details->middle_name}}
                    {{$opd_patient_details->patient_details->last_name}}
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Guardian Name
                    </th>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{$opd_patient_details->patient_details->year}}
                        {{$opd_patient_details->patient_details->month}}
                        {{$opd_patient_details->patient_details->day}}
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Gender
                    </th>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Bds 2nd Year,Purba-Medinipur,west bengal
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Blood Group
                    </th>
