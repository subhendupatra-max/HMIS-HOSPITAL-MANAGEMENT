                        ...
                        <div class="mt-2">
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Bill No : </span><span
                                    class="requisition_text">{{ @$bill_details->bill_prefix }}{{ @$bill_details->id }}</span>
                            </div>
                            <div class="col-md-12 mt-3 mb-3">
                            ...
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Created By : </span><span
                                    class="requisition_text">{{ @$bill_details->created_details->first_name }}
                                    {{ @$bill_details->created_details->last_name }}</span>
                            </div>
                  
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Payment Status </span><span
                                    class="badge badge-success">{{ $bill_details->payment_status }}</span>
                            </div>
                  
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Discount Status </span><span
                                    class="badge badge-success">{{ $bill_details->discount_status }}</span>
                            </div>
                            @if($bill_details->discount_status != 'Not applied')
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Requested Discount Amount  : </span><span
                                        style="color:red"> {{ $discount_details->discount->asking_discount_amount }} {{ $discount_details->discount->discount_type == 'flat' ? 'Rs' : '%' }}</span>
                                </div>
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Requested Discount Date </span><span
                                        class="requisition_text"> : <?= date('d-m-Y h:i', strtotime($discount_details->discount->asking_discount_time)) ?></span>
                                </div>
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Requested Discount By  </span><span
                                        class="requisition_text"> : {{ $discount_details->discount->request_by_details->first_name }} {{ $discount_details->discount->request_by_details->last_name }} </span>
                                </div>
                            @endif
                            @if($bill_details->discount_status == 'Approved')
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Appoved Discount Amount </span><span
                                        class=requisition_text"> : {{ $discount_details->discount->given_discount_amount }} {{ $discount_details->discount->given_discount_type == 'flat' ? 'Rs' : '%' }}</span>
                                </div>
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Appoved Discount Date </span><span
                                        class="requisition_text"> : <?= date('d-m-Y h:i', strtotime($discount_details->discount->given_discount_time)) ?></span>
                                </div>
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Appoved Discount By </span><span
                                        class="requisition_text"> : {{ $discount_details->discount->given_by_details->first_name }} {{ $discount_details->discount->given_by_details->last_name }} </span>
                                </div>
                            @endif
                                    ...
                                    @if($bill_details->discount_status == 'Approved' )
                                        <div class="d-flex justify-content-end">
                                            <span class="bilpo_name">Discount </span><span class="bilpo_value"> :
                                                {{ @$discount_details->discount->given_discount_amount }} {{ @$discount_details->discount->given_discount_type == 'flat' ? 'Rs': '%' }}</span>
                                        </div>                         
                                    @endif
                                        <div class="d-flex justify-content-end">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <span class="bilpo_name">Grand Total </span><span class="bilpo_value"> :
                                                {{ number_format((float) $bill_details->grand_total, 2, '.', '') }} Rs</span>
                                        </div>
