            ...
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <div class="d-block">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{route('print-opd-bill',['bill_id'=>base64_encode($bill_details->id)])}}" data-placement="top" data-toggle="tooltip" title="Print Bill Copy"><i class="fa fa-print"></i> Print</a>
