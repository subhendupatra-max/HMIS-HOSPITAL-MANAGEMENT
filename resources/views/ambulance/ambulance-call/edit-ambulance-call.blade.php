            ...
            <form action="{{ route('update-ambulance-call-details') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control select2-show-search select2-hidden-accessible" value="{{ old('vehicle_model') }}" name="vehicle_model" id="vehicle_model" required>
                            <optgroup>
                                ...
                                <option value="{{$item->id}}" {{ $item->id == $editAmbulanceCall->vehicle_model ? 'selected' : " "}}>{{$item->vehicle_model}}</option>
                                @endforeach
                            </optgroup>
                        </select>
                        @error('vehicle_model')
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" id="date" name="date" @if(isset($editAmbulanceCall->date)) value="{{ date('Y-m-d',strtotime($editAmbulanceCall->date)) }}" @endif>
                        @error('date')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="charge_category" class="form-control select2-show-search" name="charge_category" required  data-subcatagory_id="{{$editAmbulanceCall->charge_sub_category}}">
                            <option value=" ">Select Catagory</option>
                            @foreach ($catagory as $item)
                            <option value="{{$item->id}}" {{ $item->id == $editAmbulanceCall->charge_category ? 'selected' : " "}}>{{$item->charges_catagories_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="charge_sub_category" class="form-control select2-show-search" id="charge_sub_category" required data-charge_id="{{$editAmbulanceCall->charge_name}}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="tax" value="{{ old('tax') }}" onkeyup="totalAmount()" name="tax" value="{{ $editAmbulanceCall->tax }}" required>
                        @error('tax')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4 ">
                        ...
                        <input type="text" class="form-control" id="total_amount" name="total_amount" required readonly value="{{ $editAmbulanceCall->total_amount }}">
                        @error('total_amount')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4 ">
                        ...
                        <input type="text" class="form-control" id="net_amount" name="net_amount" required readonly value="{{ $editAmbulanceCall->net_amount }}">
                        @error('net_amount')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="payment_mode" class="form-control" name="payment_mode" onchange="paymentMode(this.value)" required>
                            ...
                            <option value="{{$item}}" {{ $item == $editAmbulanceCall->payment_mode ? 'selected' : " "}}> {{$item}}</option>
                            @endforeach
                        </select>
                        @error('payment_mode')
                        <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="form-group col-md-4 ">
                        ...
                        <input type="text" class="form-control" id="payment_amount" name="payment_amount" readonly required value="{{ @$editAmbulanceCall->payment_amount }}">
                    ...
                    <div class="mt-3 form-group col-md-12" id="check" style="display:none">
                        <div class="row">
                            <div class="form-group col-lg-4 ">
                                ...
                                <input type="text" class="form-control" id="cheque_no" name="cheque_no" value="{{ @$editAmbulanceCall->payment_amount }}">
                                @error('cheque_no')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-lg-4 ">
                                ...
                                <input type="date" class="form-control" id="cheque_date" name="cheque_date" @if(isset($editAmbulanceCall->cheque_date)) value="{{ date('Y-m-d',strtotime($editAmbulanceCall->cheque_date)) }}" @endif>
                                @error('cheque_date')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
