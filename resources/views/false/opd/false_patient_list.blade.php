        ...
        <div class="card-header  d-block">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <div class="d-block">
                        <a class="btn btn-primary btn-sm" href="{{ route('opd-false-generation') }}"><i class="fa fa-reply"></i> Change Department</a>
                    </div>
                </div>
...
<div class="col-lg-3 col-xl-3">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <ul class="list-group">
                    <li class="list-group-item"><i class="fa fa-cog text-danger" aria-hidden="true"></i> Today's total OPD Patient : {{
                                            @$todays_total_opd }} <br>
                        <span class="badge badge-success badge-pill">Original : {{
                                                @$todays_total_opd_ori }}</span> <span class="badge badge-danger badge-pill">False : {{ @$todays_total_opd_sys
                                                }}</span>
                    </li>
