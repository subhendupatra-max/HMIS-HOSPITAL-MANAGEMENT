        ...
        <div class="card-header  d-block">
            <div class="row">
                <div class="col-md-6 card-title">
                    OPD // <span style="color:blue">{{ @$department_details->department_name }}</span>
                    // <span>{{ date('d-m-Y',strtotime($date))}}</span>
                </div>

                <div class="col-md-6 text-right">
                    <div class="d-block">
                        <a class="btn btn-primary btn-sm" href="{{ route('opd-false-generation') }}"><i
                                    ...
                                    <small class="text-danger">{{ $message }}</sma>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 newaddappon ">
                                                <label class="date-format"> From Age(in year) <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="radiology_from_age" id="radiology_from_age"
                                                    required />
                                            ...
                                            <div class="form-group col-md-6 newaddappon ">
                                                <label class="date-format"> To Age(in year) <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="radiology_to_age" id="radiology_to_age"
                                                    required />
                                            ...
                                            <div class="form-group col-md-12 newaddappon">
                                                <label for="radiology_visit_type">Visit Type <span
                                                        class="text-danger">*</span></label>
                                                <select name="radiology_visit_type" id="visit_type"
                                                    class="form-control select2-show-search" id="radiology_visit_type"
                                                    required>
                                                    <option value="">Select One</option>
                                                    <option value="New Visit">New-Visit</option>
                                                    <option value="Revisit">Revisit</option>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item"><i class="fa fa-cog text-danger"
                                            ...
                                            <span class="badge badge-success badge-pill">Original : {{
                                                @$todays_total_opd_ori }}</span> <span
                                                class="badge badge-danger badge-pill">False : {{ @$todays_total_opd_sys
                                                }}</span>
                                        </li>
                                        <li class="list-group-item"><i class="fa fa-cog text-primary"
                                                aria-hidden="true"></i> New Patient : {{ @$todays_new }}
                                            <br>
                                        ...
                                        <li class="list-group-item"><i class="fa fa-cog text-success"
                                                aria-hidden="true"></i> Revisit Patient : {{ @$todays_revisit }}
                                            <br> <span class="badge badge-success badge-pill">Original : {{
                                                @$todays_revisit_ori }}</span> <span
                                                class="badge badge-danger badge-pill">False : {{ @$todays_revisit_sys
                                                }}</span>
                                        </li>
...
<script>
   ...
   function savePatientopdpathology()
   {
    ...
    var pathology_department_id_ = $('#pathology_department_id').val();
        ...
        $.ajax({
                url: "{{ route('false-pathology-test-add-opd') }}",
                type: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
   ...
   function savePatientopdradiology()
   {
    ...
    var radiology_department_id_ = $('#radiology_department_id').val();
        ...
        $.ajax({
                url: "{{ route('false-radiology-test-add-opd') }}",
                type: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
