...
<div class="col-lg-3 col-xl-3">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <ul class="list-group">
                    <li class="list-group-item"><i class="fa fa-cog text-danger" aria-hidden="true"></i> Today's total Emg Patient : {{
                                            @$todays_total_emg }} <br>
                        <span class="badge badge-success badge-pill">Original : {{
                                                @$todays_total_emg_ori }}</span> <span class="badge badge-danger badge-pill">False : {{ @$todays_total_emg_sys
                                                }}</span>
                    </li>
        ...
        <table class="table table-bordered text-nowrap" id="example">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ @$value->case_id }}</td>
                    <td>
                        @if (isset($value->latest_emg_visit_details_for_patient->department_id))
                        <i class="fa fa-cubes text-primary"></i>
                        {{
                                    @$value->latest_emg_visit_details_for_patient->department_details->department_name
                                    }}
                        <br>
                        @endif
                        @if (isset($value->latest_emg_visit_details_for_patient->cons_doctor))
                        <i class="fas fa-user-md text-primary"></i>
                        {{ @$value->latest_emg_visit_details_for_patient->doctor->first_name }}
                        {{ @$value->latest_emg_visit_details_for_patient->doctor->last_name }}<br>
                        @endif
                        @if (isset($value->latest_emg_visit_details_for_patient->appointment_date))
