...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('update-appointments-details') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="doctor" class="form-label">Doctor<span class="text-danger">*</span></label>
                        <select class="form-control select2-show-search select2-hidden-accessible" value="{{ old('doctor') }}" name="doctor" id="doctor" required>
                            <optgroup>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control select2-show-search select2-hidden-accessible" value="{{ old('vehicle_model') }}" name="shift" id="shift" required>
                            <optgroup>
