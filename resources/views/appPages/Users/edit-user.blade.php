                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" id="employee_id"value="{{ $user_details->employee_id }}"
                                        ...
                                        @if (isset($all_role))
                                            @foreach ($all_role as $item)
                                                <option value="{{ $item->name }}"
                                                    {{ @$item->name == $user_details->role ? 'selected' : ' ' }}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        @endif
                                    </optgroup>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" id="designation"value="{{ $user_details->designation }}"
                                    ...
                                    @if (isset($department))
                                        @foreach ($department as $item)
                                            <option value="{{ $item->id }}"
                                                {{ @$item->department_name == $user_details->department ? 'selected' : ' ' }}>
                            ...
                            <div class="col-md-3">
                                <input type="text" id="specialist" value="{{ $user_details->specialist }}"
                            ...
                            <div class="col-md-6 newuserlistchange ">
                                ...
                                <input type="text" name="last_name" value="{{ $user_details->last_name }}"id="last_name"
                                    required="">
                            ...
                            <div class="col-md-6 newuserlistchange ">
                                ...
                                <input type="text"
                                    name="father_name"value="{{ $user_details->father_name }}"id="father_name"
                                    required="">
                            ...
                            <div class="col-md-6 newuserlistchange ">
                                ...
                                <input type="text" name="mother_name" value="{{ $user_details->mother_name }}"
                                ...
                                <select name="gender" class="form-control" id="gender">
                                    ...
                                    @foreach (Config::get('static.gender') as $lang => $genders)
                                        <option value="{{ $genders }}"
                                            {{ @$genders == $user_details->gender ? 'selected' : ' ' }}>
                                            {{ $genders }}</option>
                                    @endforeach
                                </select>
                                @error('gender')
                                ...
                                <select name="marital_status" class="form-control" id="marital_status">
                                    ...
                                    @foreach (Config::get('static.marital_status') as $lang => $marital)
                                        <option value="{{ $marital }}"
                                            {{ @$marital == $user_details->marital_status ? 'selected' : ' ' }}>
                                            {{ $marital }}</option>
                                    @endforeach
                                </select>
                                ...
                                <select name="blood_group" class="form-control" id="blood_group">
                                    ...
                                    @foreach (Config::get('static.blood_groups') as $lang => $blood_group)
                                        <option value="{{ $blood_group }}"
                                            {{ @$blood_group == $user_details->blood_group ? 'selected' : ' ' }}>
                                            {{ $blood_group }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 ">
                                ...
                                <input type="date" name="date_of_birth" id="date_of_birth"
                                    @if (isset($user_details->date_of_birth)) value="{{ date('Y-m-d', strtotime($user_details->date_of_birth)) }}" @endif>
                            ...
                            <div class="col-md-3 datetypeform">
                                ...
                                <input type="date" name="date_of_joining" id="date_of_joining"
                                    @if (isset($user_details->date_of_joining)) value="{{ date('Y-m-d', strtotime($user_details->date_of_joining)) }}" @endif>
                            ...
                            <div class="col-md-3 newuserchangeeli">
                                ...
                                <input type="number" name="phone_no" id="phone_no"
                                    value="{{ $user_details->phone_no }}" required="">
                            ...
                            <div class="col-md-3 newuserchangeeli">
                                ...
                                <input type="number" name="whatsapp_no" id="whatsapp_no"
                                    value="{{ $user_details->whatsapp_no }}" required="">
                            ...
                            <div class="col-md-3 newuserchangeeli ">
                                ...
                                <input type="number" name="emg_phone_no" id="emg_phone_no"
                                    value="{{ $user_details->emg_phone_no }}" required="">
                            ...
                            <div class="col-md-6 newuserrchange ">
                                ...
                                <input type="text"name="current_address"
                                    id="current_address"{{ $user_details->current_address }} required="">
                            ...
                            <div class="col-md-6 newuserchange ">
                                ...
                                <input type="text" name="permanent_address" id="permanent_address"
                                    {{ $user_details->permanent_address }} required="">
                            ...
                            <div class="col-md-3 newuserchange">
                                ...
                                <input type="text" name="qualification"
                                    id="qualification"{{ $user_details->qualification }} required="">
                            ...
                            <div class="col-md-6 newuserchange ">
                                ...
                                <input type="text"name="specialization"
                                    id="specialization"{{ $user_details->specialization }} required="">
                            ...
                            <div class="col-md-4 newuserchange ">
                                ...
                                <input type="text" name="pan_number" id="pan_number"
                                    value="{{ $user_details->pan_number }}" required="">
                            ...
                            <div class="col-md-4 newuserchange">
                                ...
                                <input type="text" name="identification_number" id="identification_number"
                                    value="{{ $user_details->identification_number }}" required="">
                            ...
                            <div class="col-md-4 newuserchange">
                                ...
                                <input type="text"name="local_identification_number" id="local_identification_number"
                                    value="{{ $user_details->local_identification_number }}" required="">
