            ...
            <table>
                <tr>
                    ...
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;width:285px">
                        ...
                        <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode('@$emg_patient_details->opd_prefix @$emg_patient_details->id', $generatorPNG::TYPE_CODE_128)) }}" style="width: 160px;height:50px">
                    </td>
                    ...
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        ...
                        <b>Date: {{ @$emg_patient_details->all_emg_visit_details->appointment_date}}</b>
                    </td>
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>Cons. Doctor: {{ @$emg_patient_details->doctor->first_name}} {{ @$emg_patient_details->doctor->last_name}}</b>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b>EMG No : {{ @$emg_patient_details->ipd_prefix}}{{ @$emg_patient_details->id}} </b></td>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b>Department: {{ @$emg_patient_details->all_emg_visit_details->department_details->department_name}}</b></td>
                </tr>
            </table>
            <table style="width: 100%; ;margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$emg_patient_details->all_patient_details->first_name}} {{ @$emg_patient_details->all_patient_details->middle_name}} {{ @$emg_patient_details->all_patient_details->last_name}}
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Guardian Name
                    </th>
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$emg_patient_details->all_patient_details->guardian_name}}
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$emg_patient_details->all_patient_details->year}}Y {{ @$emg_patient_details->all_patient_details->first_name}}M {{ @$emg_patient_details->all_patient_details->first_name}}D
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Gender
                    </th>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$emg_patient_details->all_patient_details->address}}, {{ @$emg_patient_details->all_patient_details->_state->name}}, {{ @$emg_patient_details->all_patient_details->_district->name}}
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Blood Group
                    </th>
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$emg_patient_details->all_patient_details->blood_group}}
                    </td>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="position: fixed; right: 20px; bottom: 15px;">
                    <b>Date:</b> {{$emgPrescription->prescription_date}}
                </td>
            </tr>
        </table>
        <!-- =================================================================================================== -->
