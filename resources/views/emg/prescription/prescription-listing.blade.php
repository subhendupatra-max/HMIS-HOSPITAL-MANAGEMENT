                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="{{ route('prescription-view-in-emg',['id'=> base64_encode($item->id),'emg_id'=> base64_encode($emg_patient_details->id)]) }}"><i class="fa fa-eye"></i> View</a>
                                            @endcan
                                            ...
                                            <a class="dropdown-item" href="{{ route('print-prescription-in-emg',['id'=> base64_encode($item->id), 'emg_id'=> base64_encode($emg_patient_details->id)]) }}"><i class="fa fa-print"></i> Print</a>
                                            @endcan
