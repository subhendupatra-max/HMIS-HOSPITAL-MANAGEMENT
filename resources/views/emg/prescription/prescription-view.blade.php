...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-10">
                    <span class="head_name">Test Name</span> : <span class="value_name">{{ @$pathologyTest->test_name }}</span>
                </div>
                <div class="col-md-2">
                    <div class="row">
                        @can('edit pathology test')
                        <a class="btn btn-primary btn-sm mb-2" href="{{ route('edit-pathology-test-details',['id'=> base64_encode($emg_id)]) }}"><i class="fa fa-edit"></i> Edit</a>
                        @endcan

                        @can('delete pathology test')
                        <a class="btn btn-primary btn-sm ml-2 mb-2" href="{{ route('delete-pathology-test-details',['id'=> base64_encode($emg_id)]) }}"><i class="fa fa-trash"></i> Delete</a>
                        @endcan
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <span class="head_name">Date</span> : <span class="value_name">{{ @$emgPrescription->prescription_date }}</span>
                </div>

                <div class="col-md-4">
                    <span class="head_name">Note</span> : <span class="value_name">{{ @$emgPrescription->note}}</span>
                </div>
