        ...
        <table style="width: 100%;border-collapse: collapse">
            ...
            <table>
                <tr>
                    ...
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;">
                        ...
                        <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode('@$emg_patient_details->patient_prefix @$emg_patient_details->patient_id', $generatorPNG::TYPE_CODE_128)) }}" style="width: 100px;height: 40px;">

                    </td>
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;">

                        {!! QrCode::size(200)->generate('@$emg_patient_details->patient_prefix') !!}
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b>Department: {{@$emg_patient_details->department_name}}</b></td>
                </tr>
            </table>
            <table style="width: 100%; ;margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{@$emg_patient_details->year}}Y
                        {{@$emg_patient_details->month}}M
                        {{@$emg_patient_details->day}}D
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Gender
                    </th>
                ...
                <tr>
                    <td height="00px" valign="top" style="border-right-style: dotted;border-width: 1px;">
                        ...
                        <p style="border-top: 1px solid #899499;padding: 10px 0px 7px 10px;margin: 0px;font-size: 13px;">
                            <b>Height - {{@$emg_patient_details->height}}</b>
                        </p>
                        <p style="border-top: 1px solid #899499;padding: 7px 0px 7px 10px;margin: 0px;font-size: 13px;">
                            <b>Weight - {{@$emg_patient_details->weight}}</b>
                        </p>
                        <p style="border-top: 1px solid #899499;padding: 7px 0px 7px 10px;margin: 0px;font-size: 13px;">
                            <b>BP - {{@$emg_patient_details->bp}}</b>
                        </p>
                        <p style="border-top: 1px solid #899499;padding: 7px 0px 7px 10px;margin: 0px;font-size: 13px;">
                            <b>RR. - {{@$emg_patient_details->respiration}}</b>
                        </p>
                        <p style="border-top: 1px solid #899499;padding: 7px 0px 7px 10px;margin: 0px;font-size: 13px;">
                            <b>Temperature - {{@$emg_patient_details->temperature}}</b>
                        </p>
                        <p style="border-top: 1px solid #899499;padding: 7px 0px 7px 10px;margin: 0px;font-size: 13px; ">
                            <b>&nbsp;SPO<sub>2</sub> -</b>
                        </p>
