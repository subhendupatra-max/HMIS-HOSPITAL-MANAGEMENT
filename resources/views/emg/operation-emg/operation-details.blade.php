        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    @can('edit patient')
                    <a href="{{ route('edit-emg-operation-in-emg',['id' => base64_encode($operation_booking_id)] ) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit Details</a>
                    @endcan
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-5">
                                            ...
                                            <a class="textlink" href="{{ route('emg-patient-profile', ['id' => base64_encode($operation_details->emg_id)]) }}">({{@$operation_details->emg_id}})</a>
