    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3"  method="POST" action="{{ route('permissionEditAction') }}">
                    @csrf
                    <div class="col-md-12">
                        <div class="form-floating">
                            <input type="text" value="{{ $permission->name }}" class="form-control" id="permission" name="permission"
