             ...
             <div class="row">
                 ...
                 <div class="col-md-8 text-right">
                     <div class="d-block">
                         ...
                         @can('')
                         <a href="{{ route('blood-issue-listing') }}" class="btn btn-primary btn-sm"><i class="fa fa-vials"></i> Blood Issue Details </a>
                         @endcan
                         @can('')
                         <a href="{{ route('listing-blood-components-details') }}" class="btn btn-primary btn-sm"><i class="fa fa-mortar-pestle"></i> Components Issue </a>
                         @endcan
