...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('save-blood-donor') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="donor_name" class="form-label">Donor Name<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="donor_name" value="{{ old('donor_name') }}" name="donor_name" placeholder="Enter Donor Name">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="father_name" value="{{ old('father_name') }}" name="father_name" placeholder="Enter Father Name">
                        <small class="text-danger">{{ $errors->first('father_name') }}</small>
                    </div>

                    <div class="form-group col-md-4">
                        <label for="ph_no" class="form-label">Contact No</label>
                        <input type="text" class="form-control" id="ph_no" value="{{ old('ph_no') }}" name="ph_no" placeholder="Enter Contact No">
