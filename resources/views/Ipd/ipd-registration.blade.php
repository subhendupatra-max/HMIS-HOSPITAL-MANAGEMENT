...
@section('content')
    <form method="post" action="{{ route('ipd-registation') }}">
        ...
        <input type="hidden" name="patient_source_id" value="{{ $patient_source_id }}" />
        <input type="hidden" name="patient_source" value="{{ $patient_source }}" />
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-12">
                            ...
                            <div class="widget-user-image mx-auto mt-1"><img alt="User Avatar" class="rounded-circle"
                                    src="{{ asset('public/patient_image/patient_icon.png') }}"
                            ...
                            <div class="card-body text-center">
                                <div class="pro-user">
                                    ...
                                    @can('edit patient')
                                        <a href="{{ route('edit-patient-details', base64_encode($visit_details->all_patient_details->id)) }}"
                                            ...
                                            <select name="symptoms_type" class="form-control select2-show-search"
                                                ...
                                                @foreach ($symptoms_types as $key => $symptoms_type)
                                                    <option value="{{ $symptoms_type->id }}">
                                                        {{ $symptoms_type->symptoms_type_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <input type="hidden" name="patient_id"
                                value="{{ @$visit_details->all_patient_details->id }}" />
                            <div class="form-group col-md-12">
                                <label for="date_of_birth">Date Of Birth <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="date_of_birth" name="date_of_birth"
                                    onchange="getage(this.value)"
                                    value="{{ @$visit_details->all_patient_details->date_of_birth }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" id="date_of_birth_year"
                                            ...
                                            value="{{ @$visit_details->all_patient_details->year }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" id="date_of_birth_month"
                                            ...
                                            value="{{ @$visit_details->all_patient_details->month }}" required>
                                        <small class="text-danger">{{ $errors->first('date_of_birth_month') }}</small>
                                    </div>
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control"
                                            value="{{ @$visit_details->all_patient_details->day }}"
