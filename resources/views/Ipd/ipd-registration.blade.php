                        ...
                        <div class="card-body text-center">
                            <div class="pro-user">
                                <h4 class="pro-user-username text-dark mb-1 font-weight-bold">
                                    {{ $visit_details->all_patient_details->prefix }} {{ $visit_details->all_patient_details->first_name }}
                                    {{ $visit_details->all_patient_details->middle_name }} {{ $visit_details->all_patient_details->last_name }}
                                </h4>
                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-0">{{ $visit_details->all_patient_details->guardian_name_realation }}
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-0">{{ $visit_details->all_patient_details->blood_group }}</td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 px-0">
                            ...
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="credit_limit" value="{{ 20000 }}" />
