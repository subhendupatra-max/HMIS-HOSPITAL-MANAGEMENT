            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-4 col-xl-4 border-right">
                    ...
                    <div class="options px-5 pt-2  border-bottom pb-1">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <span style="font-weight: bold; font-size: 15px;">Apply Charges Amount : ₹{{
                                    $billing_amount }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="options px-5 pt-2  border-bottom pb-1">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                @if (@$operation_details_fetch[0]->operation_name != null)
                                <div class="table-responsive">
                                    <table class="table card-table table-vcenter text-nowrap table-success">
                                        <thead class="bg-success text-white">
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($operation_details_fetch as $item)
                                            <tr>
