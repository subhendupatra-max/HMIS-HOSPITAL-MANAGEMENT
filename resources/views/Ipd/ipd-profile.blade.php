        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    ...
                    <div class="d-block">
                        <a href="{{ route('print-ipd-discharge-patient',['ipd_id' => base64_encode(@$ipd_details->id)] ) }}" class="btn btn-primary btn-sm"><i class="far fa-calendar-check"></i> Admission Form</a>
