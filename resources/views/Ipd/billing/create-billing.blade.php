...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <form method="post" action="{{ route('add-new-ipd-billing') }}">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="border-bottom border-top">
                    <span style="color: #ff6014;font-size: 14px;"> Are You want to add Medicine Bill ?<input type="checkbox" id="add_medicine_bill" name="add_medicine_bill" onchange="addMedicineBill({{ $ipd_details->case_id }})" value="yes" /></span>
