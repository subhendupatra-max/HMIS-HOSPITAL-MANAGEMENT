        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <div class="d-block">
                        @can('add ipd billing')
                        <a href="{{ route('add-ipd-billing', ['id' => base64_encode($ipd_id)]) }}" class="btn btn-primary btn-sm"><i class="fa fa-money-bill"></i> Add Billing </a>
                        @endcan
            ...
            <div class="">
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap" id="example">
                        ...
                        <tbody>
                            @if (@$ipd_billing_details)
                            @foreach ($ipd_billing_details as $value)
                            <tr>
                                <td><a class="text-info" href="{{ route('ipd-bill-details', ['bill_id' => base64_encode($value->id)]) }}">{{ $value->bill_prefix }}{{ $value->id }}</a>
                                </td>
