            ...
            <div class="row no-gutters">
                <div class="col-lg-4 col-xl-4 border-right">
                    ...
                    <div class="options px-5 pt-2  border-bottom pb-1">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <a class="btn btn-primary btn-sm" href="{{route('add_new_patient-in-ipd')}}"><i class="fa fa-plus"></i> Add New Patient</a>
                            </div>
                        </div>
                    </div>
                    {{-- ================== add new patient ====================== --}}
                    <div class="options px-5 pt-5  border-bottom pb-3">
                        ...
                        <form method="post" action="{{route('direct-ipd-admission') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    <select class="form-control  select2-show-search" name="patient_id">
                                        ...
                                        <option value="{{@$patient->id}}" {{ @$patient_details_information->id == $patient->id ? 'Selected' : '' }}> {{@$patient->prefix}} {{@$patient->first_name}} {{@$patient->middle_name}} {{@$patient->last_name}} ( {{@$patient->id}} ) ( {{@$patient->phone}} ) </option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                ...
                <div class="col-lg-8 col-xl-8">
                    <form method="post" action="{{ route('ipd-registation') }}">
                        @csrf
                        ...
                        <div class="options px-5 pt-1  border-bottom pb-3">
                            <div class="row">
                                <div class="form-group col-md-2 newaddappon">
                                    ...
                                    <input type="date" required class="form-control" id="date_of_birth" name="date_of_birth" onchange="getagefromdate(this.value)" value="{{ date('Y-m-d',strtotime($patient_details_information->date_of_birth)) }}" required />
                                ...
                                <div class="form-group col-md-4 ">
                                    <div class="row">
                                        <div class="col-lg-4 newdesignadd">
                                            <input type="text" required onkeyup="getage()" id="date_of_birth_year" value="{{ @$patient_details_information->year }}" name="date_of_birth_year">
                                        ...
                                        <div class="col-lg-4 newdesignadd">
                                            <input type="text" required onkeyup="getage()" id="date_of_birth_month" value="{{ @$patient_details_information->month }}" name="date_of_birth_month">
                                        ...
                                        <div class="col-lg-4 newdesignadd">
                                            <input type="text" required onkeyup="getage()" id="date_of_birth_day" value="{{ @$patient_details_information->day }}" name="date_of_birth_day">
                                ...
                                <div class="col-md-3 newdesignadd">
                                    <input type="text" required id="admitted_by" value="{{ @$patient_details_information->local_guardian_name }}" name="admitted_by">
                                    <label for="admitted_by"> Admitted By</label>
                                    <small class="text-danger">{{
                                        $errors->first('admitted_by') }}</small>
                                </div>
                                <div class="col-md-3 newdesignadd">
                                    <input type="text" required id="admitted_by_contact_no" value="{{ @$patient_details_information->local_guardian_contact_no	 }}" name="admitted_by_contact_no">
                        ...
                        <div class="options px-5 pt-1  border-bottom pb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 ipd-registrationproadd">
                                    ...
                                    <select name="unit" onchange="getBed()" class="form-control select2-show-search" id="unit">
                                        ...
                                        <option value="{{ $unit->id }}"> {{ $unit->bedUnit_name }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('unit')
                            ...
                            <div class="row">
                                <div class="col-md-6 ipd-registrationproadd">
                                    ...
                                    @error('icd_code_at_the_time_of_admission')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6 ipd-registrationproaddd">
