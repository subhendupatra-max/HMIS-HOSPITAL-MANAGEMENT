...
<a class="dropdown-item {{ Request::segment(2) == 'ipd-bed-histroy' ? 'active' : '' }}" href="{{ route('bed-transfar-history-in-ipd', ['ipd_id' => base64_encode($ipd_details->id)]) }}"><i class="fa fa-bed"></i> Bed History</a>
<a class="dropdown-item {{ Request::segment(2) == 'ipd-physical-condition' ? 'active' : '' }}" href="{{ route('physical-condition-in-ipd', ['ipd_id' => base64_encode(@$ipd_details->id)]) }}"><i class="fa fa-bed"></i> Physical Condition </a>
