<div class="scrollable">
    ...
    <a class="dropdown-item {{ Request::segment(2) == 'ipd-prescription' ? 'active' : '' }}" href="{{ route('prescription-lisitng-in-ipd', ['id' => base64_encode($ipd_details->id)]) }}"><i class="fa fa-prescription"></i> Prescription</a>
