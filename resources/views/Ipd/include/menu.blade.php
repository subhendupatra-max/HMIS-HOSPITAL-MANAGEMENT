...
<a class="dropdown-item {{ Request::segment(2) == 'opd-profile' ? 'active' : '' }}" href=""><i class="fa fa-dna"></i> Oxygen Monitoring</a>
<a class="dropdown-item {{ Request::segment(2) == 'opd-profile' ? 'active' : '' }}" href=""><i class="fa fa-tablets"></i> Medication</a>
<a class="dropdown-item {{ Request::segment(2) == 'opd-profile' ? 'active' : '' }}" href=""><i class="fa fa-scissors"></i> Operation</a>
