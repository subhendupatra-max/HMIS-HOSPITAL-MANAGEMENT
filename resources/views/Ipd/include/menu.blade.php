<div class="scrollable">
    ...
    <a class="dropdown-item {{ Request::segment(2) == 'ipd-blood-details' ? 'active' : '' }}" href="{{ route('blood-bank-detials-in-ipd', ['id' => base64_encode($ipd_details->id)]) }}"><i class="fa-solid fa-droplet"></i>Blood Details</a>
