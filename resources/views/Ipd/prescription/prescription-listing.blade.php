            ...
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <div class="d-block">
                        ...
                        <a href="{{ route('add-prescription-in-ipd',['id'=> base64_encode($ipd_id)]) }}" class="btn btn-primary btn-sm"><i class="fa fa-prescription"></i> Create Prescription </a>
                        @endcan
                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="{{ route('prescription-view-in-ipd',['id'=> base64_encode($item->id),'ipd_id'=> base64_encode($ipd_details->id)]) }}"><i class="fa fa-eye"></i> View</a>
                                            @endcan
                                            ...
                                            <a class="dropdown-item" href="{{ route('print-prescription-in-ipd',['id'=> base64_encode($item->id), 'ipd_id'=> base64_encode($ipd_details->id)]) }}"><i class="fa fa-print"></i> Print</a>
                                            @endcan
