...
<div style="padding: 0px 7px 0px 7px;">
  ...
  <table style="width: 100%; border:1px soild black;border-collapse: collapse">
    ...
    <tr style="width:100%">
      <td style="width:100%">
        <h1
          style="text-align:center;font-size: 20px;margin: 40px 0px 20px 0px; color: #000;padding: 15px 0px 15px 0px;  width: 100%;">
          ADMISSION FORM</h1>
      </td>
    </tr>
