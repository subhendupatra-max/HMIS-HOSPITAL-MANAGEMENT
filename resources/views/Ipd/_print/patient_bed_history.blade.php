            ...
            <table>
                <tr>
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>UHID No. :{{ @$ipd_details->patient_prefix }}{{ @$ipd_details->patient_id
                            }}</b>
                    </td>
                    ...
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;">
                        <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode('@$ipd_details->ipd_prefix @$ipd_details->patient_id', $generatorPNG::TYPE_CODE_128)) }}" style="width: 150px;height: 40px;">
                    </td>
                    ...
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>Admission Date : {{$ipd_details->appointment_date }} PM</b>
                    </td>

                </tr>
                <tr>
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b> IPD no. : {{ @$ipd_details->ipd_prefix }}{{ @$ipd_details->patient_id
                            }} </b></td>
            ...
            <table style="width: 100%; margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
                <tr>
                    ...
                    <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$ipd_details->all_patient_details->guardian_contact_no }}
                    </td>
                </tr>
                <tr>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$ipd_details->all_patient_details->year }}-{{ @$ipd_details->all_patient_details->month }}-{{ @$ipd_details->all_patient_details->day }}
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Gender
                    </th>
                    ...
                    <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        {{ @$ipd_details->all_patient_details->patient_type }}
                    </td>
                </tr>
                <tr>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
