    ...
    <div style="padding: 0px 7px 0px 7px;">
        ...
        <table style="margin: 10px 0px 0px 0px;">
            <tr>
                <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;width:280px">
                    <b>UHID No. : {{ @$patient_discharge_details->patient_details->patient_prefix }}{{ @$patient_discharge_details->patient_details->id }}</b>
                </td>
                <td rowspan="2" style="text-align: center;border: 1px solid #899499;width: 250px;height:60px">
                    ...
                    <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode('@$ipd_details->ipd_prefix @$ipd_details->id', $generatorPNG::TYPE_CODE_128)) }}" style="width: 150px;height:60px">
                </td>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #899499;"><b>Discharge Date:{{ $patient_discharge_details->discharge_date }}  <br> Discharge Status:{{ $patient_discharge_details->discharge_status}}</b></td>
        ...
        <table style="width: 100%; margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ $patient_discharge_details->patient_details->first_name }} {{ $patient_discharge_details->patient_details->middle_name }} {{ $patient_discharge_details->patient_details->last_name }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Guardian Name
                </th>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ $patient_discharge_details->patient_details->guardian_name }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Mobile No.
                </th>
                <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ $patient_discharge_details->patient_details->phone }}
                </td>
            </tr>
            <tr>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ $patient_discharge_details->patient_details->year }}-{{ $patient_discharge_details->patient_details->month }}-{{ $patient_discharge_details->patient_details->day }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Gender
                </th>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ $patient_discharge_details->patient_details->gender }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Patient Type
                </th>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ $patient_discharge_details->doctor_details->doctor_first_name }} {{ $patient_discharge_details->doctor_details->doctor_last_name }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Ward
                </th>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td colspan="7" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ $patient_discharge_details->patient_details->address }} {{ $patient_discharge_details->patient_details->_state->name }} {{ $patient_discharge_details->patient_details->_district->name }}
                </td>
        ...
        <table style="width: 100%; margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ @$ipd_details->admissionTimeDiagnosis->diagonasis_name }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Final Diagnosis at time of Discharge
                </th>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ @$patient_discharge_details->diagnosis_details->diagonasis_name }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Icd-10 Code(s) for Final Diagnosis
                </th>
                <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ @$patient_discharge_details->diagnosis_details->icd_code  }}
                </td>
            </tr>
        ...
        <table style="width: 100%; margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ @$patient_discharge_details->next_appointment_date }}
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Consultant Doctor
                </th>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    {{ @$patient_discharge_details->doctor_details->first_name }} {{ @$patient_discharge_details->doctor_details->last_name }}
                </td>
