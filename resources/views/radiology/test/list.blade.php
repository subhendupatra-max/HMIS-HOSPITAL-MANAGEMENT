                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{ route('view-radiology-test-details',['id'=> base64_encode($value->id)]) }}"><i class="fa fa-eye"></i> View</a>
                                            @can('')
                                            <a class="dropdown-item" href="{{ route('edit-radiology-test-details',['id'=> base64_encode($value->id)]) }}"><i class="fa fa-edit"></i> Edit</a>
                                            @endcan
                                            @can('')
                                            <a class="dropdown-item" href="{{ route('delete-radiology-test-details',['id'=> base64_encode($value->id)]) }}"><i class="fa fa-trash"></i> Delete</a>
                                            @endcan
                                </td>
                            </tr>
                            @endforeach
