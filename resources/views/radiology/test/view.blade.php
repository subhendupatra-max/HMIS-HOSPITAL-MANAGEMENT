    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-2">
                        <div class="row">
                            @can('edit radiology test')
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('edit-radiology-test-details',['id'=> base64_encode($radiologyTest->id)]) }}"><i class="fa fa-edit"></i> Edit</a>
                            @endcan                       
                                                    
                            @can('delete radiology test')
                                <a class="btn btn-primary btn-sm ml-2 mb-2" href="{{ route('delete-radiology-test-details',['id'=> base64_encode($radiologyTest->id)]) }}"><i class="fa fa-trash"></i> Delete</a>
                            @endcan
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <span class="head_name">Category</span> : <span
                            class="value_name">{{ @$radiologyTest->radiology_catagory->catagory_name }}</span>
                    </div>
                    <div class="col-md-4">
                ...
                <hr class="ipd_header_border ">
                <div class="row">
                    {!! @$radiologyTest->description !!}
                </div>
                <hr class="ipd_header_border ">
                @if (isset($radiologyParameter[0]->parameter_name))
