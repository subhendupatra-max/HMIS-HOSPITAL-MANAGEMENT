...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <form method="POST" action="{{route('update_grn')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2-show-search" onchange="findPOdetails(this.value)" name="po_no" id="po">
                                @if(!empty($po_list))
                                <option value="{{$po_list->po_id}}" {{(($grn_list->po_no==$po_list->po_id)?'selected':'')}}>{{$po_list->po_prefix}}{{$po_list->po_id}}</option>
                                @endif
                            </select>
                        </div>
                            ...
                            <tbody id="alltextre">
                                ...
                                <tr id="rowid{{$i}}">
                                    ...
                                    <td>
                                        ...
                                        <input class="form-control" type="hidden" name="unit[]" required="" readonly="" value="{{$grnItem->fetch_medicine_unit->id}}">
                                        <input class="form-control" type="hidden" name="catagory[]" required="" readonly="" value="{{$grnItem->fetch_medicine_catagory->id}}">
                                        <select name="medicine[]" required="" class="form-control" readonly="">
                                            <option value="{{$grnItem->fetch_medicine_name->id}}">{{$grnItem->fetch_medicine_name->medicine_name}}(Catagory :{{$grnItem->fetch_medicine_catagory->medicine_catagory_name}})(Unit :{{$grnItem->fetch_medicine_unit->medicine_unit_name}})</option>
                                        </select>
                                    </td>
                                    <td>
                ...
                <div class="container mt-5">
                    <div class="d-flex justify-content-end">
                        ...
                        <input type="text" name="invoice_value" id="invoice_value" class="form-control myfld" value="{{$grn_list->invoice_value}}">
                    </div>
                    <div class="d-flex justify-content-end thrdarea">
                        <span class="biltext">PO. Value</span>
                        <input type="text" name="po_value" id="po_value" class="form-control myfld" value="{{$grn_list->po_value}}">
                    </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea name="note" class="form-control">{{$grn_list->note}}</textarea>
                        </div>
                    </div>
                </div>
