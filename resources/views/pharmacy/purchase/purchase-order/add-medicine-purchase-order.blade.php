                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select class="form-control select2-show-search" onchange="findrequisition()" id="storeroom" name="store_room_id">
                ...
                <div class="">
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap" id="subhendu">
                            <thead>
                                <tr>
                                    <th scope="col" style="width: 40%">Medicine  <span class="text-danger">*</span></th>
