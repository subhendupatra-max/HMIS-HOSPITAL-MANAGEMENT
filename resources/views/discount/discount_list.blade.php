                    ...
                    <tbody>
                        @if ($discountList[0]->section)
                            @foreach ($discountList as $value)
                                ...
                                <td>
                                    <a href="{{route('view-discount-details',['discount_id'=>base64_encode($value->id)])}}"> <span
                                        style="color:blue">{{ $value->patient_details->prefix . ' ' . $value->patient_details->first_name . ' ' . $value->patient_details->middle_name . ' ' . $value->patient_details->last_name }}<br>{{ $value->patient_details->patient_prefix . ' ' . $value->patient_details->id }}</span></a>
