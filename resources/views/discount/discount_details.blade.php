                        ...
                        <div class="mt-2">
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Patient details : </span><span
                                    class="requisition_text">{{ $discount->patient_details->prefix . ' ' . $discount->patient_details->first_name . ' ' . $discount->patient_details->middle_name . ' ' . $discount->patient_details->last_name }}<br>{{ $discount->patient_details->patient_prefix . ' ' . $discount->patient_details->id }}</span>
                            </div>
                            <div class="col-md-12 mt-3 mb-3">
                            ...
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Discount Requested By : </span><span
                                    class="requisition_text"><span
                                        class="requisition_text">{{ $discount->request_by_details->first_name }}
                                        {{ $discount->request_by_details->last_name }}</span>
                            </div>
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Discount Request Date : </span><span
                                    class="requisition_text"><span
                                        class="requisition_text">{{ date('d-m-Y h:i A', strtotime($discount->asking_discount_time)) }}</span>
                            </div>
