...
<body class="app sidebar-mini">
    ...
    <div id="global-loader">
        <img src="{{ asset('public/assets/images/svgs/Doctors_symbol.gif') }}" alt="loader" width="100px"
            height="100px">
    </div>
    <!--- End Global-loader-->
    <div class="new-page">
        <nav class="navbar navbar-expand-lg navbar-light ">
            <a class="navbar-brand" href="{{ route('dashboard') }}"><img
                    src="{{ asset('public/assets/images/brand/dashlogo.png') }}"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a
                                                href="{{ route('operation-catagory-details') }}">operation-catagory-details</a>
                                        </li>
                                        @can('operation type')
                ...
                <li class="nav-item {{ Request::segment(1) == 'pharmacy' ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('bed-status-list') }}">
                        <div class="icon-new"><img src="{{ asset('public/assets/images/brand/investigation.png') }}">
                        </div>Bed
                    </a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('discharge-patient-report') }}">Discharge Patient
                            Report</a>
                        @endif
                        ...
                        <a class="dropdown-item" href="{{ route('blood-components-issue-report') }}">Blood Components
                            Issue Report</a>
                        @endif
                ...
                <div class="popup-link">
                    <a href="#popup1">
                        <div class="dashprofileimg"><img
                                src="{{ asset('public/profile_picture') }}/{{ $login_details->profile_image }}"></div>
                </div>
            ...
            margin: 0px 0px 0px 109px;">
                        ...
                        <a class="btn btn-success btn-sm"
                            href="{{ route('user-profile') }}/{{ base64_encode(Auth::id()) }}"><i
                    ...
                    <div class="bell">
                        <div class="popup-link">
                            <a href="#popup1notification">
                                <div class="dashprofileimg"> <img
                                        src="{{ asset('public/assets/images/brand/bell.png') }}"><span
                        ...
                        <div id="popup1notification" class="popup-container">
                            <div class="popup-content">
                                ...
                                <div class="">
                                    ...
                                    <a href="{{ route('view-all-notification') }}" style="color:blue;margin: 0px 0px 0px 15px;
...
<script type="text/javascript">
    ...
    function fetchData() {
        ...
        $.ajax({
            url: "{{ route('get-notification-all') }}",
            type: 'GET',
