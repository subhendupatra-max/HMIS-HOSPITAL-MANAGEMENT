                ...
                <div class="col-md-12">
                    <div class="row no-gutters">
                        <div class="col-md-8 border-right">
                            <form method="POST" action="{{ route('fetch-blood-components-issue-report') }}">
                                @csrf
                                <div class="col-md-12">
                                    <div class="row">
            ...
            <div class="">
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap" id="example">
                        ...
                        <tbody>
                            <?php $i = 0; ?>
                            @if (@$blood_components_issue_details[0]->id != null)
                            @foreach ($blood_components_issue_details as $item)
                            <?php $i++; ?>
                            <tr>
                                ...
                                <td>{{ @$item->issued_details->first_name}} {{ @$item->issued_details->last_name}}</td>
                            </tr>
                            @endforeach
                            @endif
                        </tbody>
