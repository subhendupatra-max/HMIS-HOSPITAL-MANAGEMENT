                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4 newaddappon">
                                            ...
                                            <select name="visit_type" class="form-control select2-show-search"
                                                ...
                                                <option value="New Visit" {{@$all_search_data['visit_type'] == 'New Visit' ? 'selected':'' }} >New-Visit</option>
                                                <option value="Revisit" {{@$all_search_data['visit_type'] == 'Revisit' ? 'selected':'' }} >Revisit</option>
                                            </select>
                                            @error('visit_type')
                                        ...
                                        <div class="form-group col-md-4 newaddappon">
                                            ...
                                            <select name="patient_type" onchange="getDetailsAccordingType(this.value)"
                                                ...
                                                <option value="{{$patient_type}}" {{@$all_search_data['patient_type'] == 'Revisit' ? 'selected':'' }} > {{$patient_type}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-4 newaddappon">
                                            ...
                                            <select name="department" class="form-control select2-show-search"
                                                ...
                                                <option value="{{$department->id}}" {{@$all_search_data['department'] == $department->id ? 'selected':'' }}> {{$department->department_name}}
                                                </option>
                                                @endforeach
                                            </select>
                                            @error('department')
                                        ...
                                        <div class="form-group col-md-4 newaddappon">
                                            ...
                                            <select name="cons_doctor" class="form-control select2-show-search"
                                                ...
                                                <option value="{{$doctor->id}}" {{@$all_search_data['cons_doctor'] == $doctor->id ? 'selected':'' }} > {{$doctor->first_name}}
