...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <!-- ================================Save Requisition===================================== -->
        <form method="POST" action="{{route('save-item-issue-inventory')}}">
            @csrf
            <div class="card-body">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2-show-search" name="workshop_id" id="workshop_id">
                                ...
                                <option value="{{$valu->id}}">{{$valu->item_store_room}}
                                <option>
                                    @endforeach
                                    @endif
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <select class="form-control select2-show-search" name="issue_by" id="issue_by">
                                ...
                                <option value="{{$valu->id}}">{{$valu->first_name}} {{$valu->last_name}}
                                <option>
                                    @endforeach
                                    @endif
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <select class="form-control select2-show-search" name="department" id="department" onchange="getDepartment(this.value)">
                                ...
                                <option value="{{$valu->id}}">{{$valu->department_name}}
                                <option>
                                    @endforeach
                                    @endif
