        ...
        <div class="card-body p-0">
            <div class="row no-gutters">
                ...
                <div class="col-lg-8 col-xl-8">
                    <form method="post" action="{{route('update-operation-booking-details')}}">
                        @csrf
                        ...
                        <div class="options px-5 pt-1  border-bottom pb-3">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="opd_id" value="{{ @$operation_theathers->opd_id }}" />


                                <input type="hidden" name="ipd_id" value="{{ @$operation_theathers->ipd_id }}" />


                                <input type="hidden" name="emg_id" value="{{ @$operation_theathers->emg_id }}" />
