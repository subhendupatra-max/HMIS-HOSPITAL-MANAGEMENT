    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <div class="card-body border-top">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-5">{{ @$pathology_patient_test_details->section }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 px-5">
                                        ...
                                        <td class="py-2 px-5">{{ @date('d-m-Y h:i A', strtotime($pathology_patient_test_details->date)) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 px-5">
                                        ...
                                        <td class="py-2 px-5">
                                            @if($pathology_patient_test_details->test_status == '0')
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-5">
                                            @if($pathology_patient_test_details->billing_status == '0')
                                            <span class="badge badge-warning">Billing Not Done</span>
                                            @elseif ($pathology_patient_test_details->billing_status == '1')
                ...
                <h5 class="font-weight-bold text-center">       {{ @$pathology_patient_test_details->test_details->test_name }}({{ @$pathology_patient_test_details->test_details->short_name }}) </h5>
            <form action="{{ route('update-pathology-report') }}" method="POST">
                @csrf
                <div class="col-md-12">
