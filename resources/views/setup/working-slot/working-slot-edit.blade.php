...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-working-slot-details') }}">
                @csrf

                <input type="hidden" name="working_slot_id" value="{{ @$WorkingSlot->id }}" /> 
                <div class="">
                    <div class="form-group col-md-12">
                        <label for="working_slot_name" class="medicinelabel" style="margin: -15px 0px 0px 0px">Working Slot Name</label>
                        <input type="text" class="form-control" id="working_slot_name" name="working_slot_name" placeholder="Enter Working Slot Name" value="{{ @$WorkingSlot->working_slot_name }}" required>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="time" class="form-control" id="from_time" name="from_time" value="{{ @$WorkingSlot->from_time }}"  style=" margin: 0px 0px 0px 0px;">
                        @error('from_time')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <input type="time" class="form-control" id="to_time" name="to_time" value="{{ @$WorkingSlot->to_time }}" style=" margin: 0px 0px 0px 0px;">
                        @error('to_time')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="height:10px;width:10px;backgroud-color:{{ @$item->color }}"></div>
                                </td>
                                <td>
