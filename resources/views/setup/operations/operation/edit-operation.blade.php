...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-operation-details') }}">
                @csrf
                <div class="">
                  <input name="id" value="{{ $editOperation->id }}" type="hidden">
                    <div class="form-group">
                        ...
                        <select id="operation_department" class="form-control" name="operation_department">
                            ...
                            <option value="{{$item->id}}" {{ $item->id == $editOperation->operation_department ? 'selected' : " "  }}>{{$item->department_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="operation_catagory" class="form-control" name="operation_catagory">
                            ...
                            <option value="{{$item->id}}"  {{ $item->id == $editOperation->operation_catagory ? 'selected' : " "  }}> {{$item->operation_catagory_name}} </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="operation_name" name="operation_name" placeholder="Enter Operation Name" value="{{ $editOperation->operation_name }}" required>
