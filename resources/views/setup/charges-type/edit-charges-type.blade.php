...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Charges Type</h4>
        </div>
        @if (session('success'))
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-charges-type-details') }}">
                @csrf
                <div class="">
                    <input type="hidden" name="id" value="{{ $editChargesType->id }}">
                    <div class="form-group">
                        <label for="charge_type_name" class="medicinelabel">Enter Charges Type name <span class="text-danger">*</span></label>
                        <input type="text" id="charge_type_name" name="charge_type_name" placeholder="Enter Charges Type Name" value="{{ $editChargesType->charge_type_name }}" required>
