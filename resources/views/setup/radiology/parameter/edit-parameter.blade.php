...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Radiology Parameter</h4>
        </div>
        @if (session('success'))
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-radiology-parameter-details') }}">
                @csrf
                <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="parameter_name" name="parameter_name" placeholder="Enter Parameter Name" value="{{ $editParameter->parameter_name }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="content" id="reference_range" name="reference_range"> {{ $editParameter->reference_range }} </textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="unit_id" class="form-control select2-show-search" id="unit_id">
                            ...
                            <option value="{{$items->id}}" {{ $items->id == $editParameter->unit_id ? 'selected' : " "}}>{!! $items->unit_name !!}</option>
                            @endforeach
                        </select>
                        @error('unit_id')
                        <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea  class="form-control" id="description" name="description"> {{ $editParameter->description }} </textarea>
                        @error('description')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
