...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('save-bed-unit-details') }}">
                @csrf
                <div class="">
                    <div class="form-group">
                        <label for="bedUnit_name" class="form-label"></label>
                        <input type="text" class="form-control" id="bedUnit_name" name="bedUnit_name" placeholder="Enter Bed Unit Name" value="{{ old('bedUnit_name')}}" required>
                        @error('bedUnit_name')
