            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <div class="d-block">
                        ...
                        @endcan
                        @can('add patient')
                        <a href="{{ route('add_new_patient') }}" class="btn btn-primary btn-sm"><i class="fa fa-user"></i> Add New Patient </a>
                        @endcan
                    </div>
                </div>
            </div>
                                ...
                                <td>
                                    ...
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" style="">
                                            ...
                                            <a class="dropdown-item" href="{{ route('view-new-patient', base64_encode($all_patients->id)) }}"><i class="fa fa-eye"></i> View</a>
                                            @can('edit patient')
