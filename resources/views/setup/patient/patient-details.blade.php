        ...
        <div class="row">
                ...
                <div class="box-widget widget-user">
                    <div class="widget-user-image1 d-sm-flex">
                        ...
                        <div class="mt-1 ml-lg-5">
                            <h4 class="pro-user-username mb-3 font-weight-bold">{{ $patient_details->prefix }} {{ $patient_details->first_name }} {{ $patient_details->last_name }}<i class="fa fa-check-circle text-success"></i></h4>
                            <ul class="mb-0 pro-details">
                                <li><span class="profile-icon"><i class="fe fe-mail"></i></span><span class="h6 mt-3">{{ $patient_details->email }}</span></li>
                                <li><span class="profile-icon"><i class="fe fe-phone-call"></i></span><span class="h6 mt-3">{{ $patient_details->phone }}</span></li>
                                <li><span class="profile-icon"><i class="fe fe-flag"></i></span><span class="h6 mt-3">{{ $patient_details->marital_status }}</span></li>
                                <li><span class="profile-icon"><i class="fe fe-flag"></i></span><span class="h6 mt-3">{{ $patient_details->marital_status }}</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-auto">
                <div class="text-lg-right btn-list mt-4 mt-lg-0">
                    ...
                    <a href="{{ route('edit-patient-details', base64_encode($patient_details->id)) }}" class="btn btn-primary">Edit Details</a>
                </div>
                <div class="mt-5">
                                ...
                                <div class="main-profile-contact-list d-lg-flex">
                                    ...
                                    <div class="media mr-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <!-- <span>2018 - present</span> -->
                                            <p>{!!$patient_details->date_of_birth!!} </p>
                                        </div>
                                    </div>
                                    <div class="media mr-4">
                                        <div class="media-icon bg-danger text-white mr-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <!-- <span>2018 - present</span> -->
                                            <p>{!!$patient_details->guardian_name_realation!!} {!!$patient_details->guardian_name!!} </p>
                                        </div>
                                    </div>
                                    <div class="media mr-4">
                                        <div class="media-icon bg-danger text-white mr-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <!-- <span>2018 - present</span> -->
                                            <p>{!!$patient_details->blood_group!!} </p>
                                        </div>
                                    </div>
                                    <div class="media mr-4">
                                        <div class="media-icon bg-danger text-white mr-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <!-- <span>2018 - present</span> -->
                                            <p>{!!$patient_details->identification_name!!} </p>
                                        </div>
                                    </div>
                                    <div class="media mr-4">
                                        <div class="media-icon bg-danger text-white mr-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <!-- <span>2018 - present</span> -->
                                            <p>{!!$patient_details->identification_number!!} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main-profile-contact-list d-lg-flex">
                                    ...
                                    <div class="media mr-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="font-weight-normal1">
                                            {!!$patient_details->_district->name!!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="media mr-4">
