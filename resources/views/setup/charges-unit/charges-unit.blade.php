            ...
            <form method="POST" action="{{ route('save-charges-unit-details') }}">
                ...
                <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="charges_units_name" name="charges_units_name" placeholder="Enter Charges Unit Name" value="{{ old('charges_units_name')}}" required>
