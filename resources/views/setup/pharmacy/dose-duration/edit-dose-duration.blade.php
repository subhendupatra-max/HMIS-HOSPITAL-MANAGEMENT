...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-dose-duration-details') }}">
                @csrf
                <div class="">
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        <thead>
                            <tr>
                                ...
                                @can('edit dose duration','delete dose duration')
                                <th>Action</th>
                                @endcan
                            </tr>
                        </thead>
                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @can('edit dose duration')
                                            <a class="dropdown-item" href="{{ route('edit-dose-duration-details',['id'=>$item->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                            @endcan

                                            @can('delete dose duration')
                                            <a class="dropdown-item" href="{{ route('delete-dose-duration-details',['id'=>$item->id]) }}"><i class="fa fa-trash"></i> Delete</a>
                                            @endcan
                                        </div>
                                    </div>
                                </td>
