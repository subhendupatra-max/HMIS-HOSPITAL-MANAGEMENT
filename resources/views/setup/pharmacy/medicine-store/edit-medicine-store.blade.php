...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-medicine-store-details') }}">
                @csrf
                <div class="">
                    <input type="hidden" name="id" value="{{ $editMedicineStore->id}}" />
                    <div class="form-group">
                        <label for="medicine_store_name" class="form-label">Medicine Store name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="medicine_store_name" name="medicine_store_name" value="{{ $editMedicineStore->medicine_store_name}}" required>
