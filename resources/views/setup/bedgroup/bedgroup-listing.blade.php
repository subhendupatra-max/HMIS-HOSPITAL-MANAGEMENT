...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('save-bedgroup-details') }}">
                @csrf
                <div class="">
                    <div class="form-group">
                        <label for="bedGroup_name" class="form-label"></label>
                        <input type="text" class="form-control" id="bedGroup_name" name="bedGroup_name" placeholder="Enter BedGroup Name" value="{{ old('bedGroup_name')}}" required>
                        @error('bedGroup_name')
