                ...
                <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <select id="charges_sub_catagory_id" class="form-control" name="charges_sub_catagory_id">
                            ...
                            <option value="{{$item->id}}">{{$item->charges_sub_catagories_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="charges_units_id" class="form-control" name="charges_units_id">
                            ...
                            <option value="{{$item->id}}">{{$item->charges_units_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="charges_name" name="charges_name" placeholder="Enter Charges Name" value="{{ old('charges_name')}}" required>
                        @error('charges_name')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="standard_charges" name="standard_charges" placeholder="Enter Standard Charges" value="{{ old('standard_charges')}}" required>
