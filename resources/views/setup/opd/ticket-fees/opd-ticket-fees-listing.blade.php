...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('save-opd-ticket-fees-details') }}">
                @csrf
                <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ticket_fees" name="ticket_fees" placeholder="Enter Ticket Fees" value="{{ old('ticket_fees')}}" required>
                        @error('ticket_fees')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
