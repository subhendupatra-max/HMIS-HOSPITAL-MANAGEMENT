...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-designation-details') }}">
                @csrf
                <input type="hidden" name="id" value="{{ $editDesignation->id }}">
                <div class="">
                    <div class="form-group">
                        <label for="designation_name" class="medicinelabel">Enter Designation Name</label>
                        <input type="text" class="form-control" id="designation_name" name="designation_name" value="{{ $editDesignation->designation_name }}" required>
