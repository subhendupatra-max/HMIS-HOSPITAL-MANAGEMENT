...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Symptoms Type</h4>
        </div>
        @if (session('success'))
        ...
        @endif
        <div class="card-body">
            <form method="POST" action="{{ route('update-symptoms-type-details') }}">
                @csrf
                <div class="">
                ...
                <button type="submit" class="btn btn-primary mt-4 mb-0">Edit Type</button>
            </form>
        </div>
    </div>
</div>
                            ...
                            <tr>
                                ...
                                <div class="card-options">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" >
                                        @can('edit department')
                                        <a class="dropdown-item" href="{{ route('edit-symptoms-type-details',['id'=>$item->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                        @endcan

                                        @can('delete department')
                                        <a class="dropdown-item" href="{{ route('delete-symptoms-type-details',['id'=>$item->id]) }}"><i class="fa fa-trash"></i> Delete</a>
                                        @endcan
                                    </div>
                                </div>
                                </td>
