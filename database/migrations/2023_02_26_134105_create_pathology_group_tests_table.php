...
class CreatePathologyGroupTestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pathology_group_tests', function (Blueprint $table) {
            $table->id();
            $table->string('group_test_name')->nullable();
    ...
    {
        Schema::dropIfExists('pathology_group_tests');
    }
}
