...
class CreateInventoryGRNSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventory_g_r_n_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('purpose_grm')->nullable();
    ...
    {
        Schema::dropIfExists('inventory_g_r_n_s');
    }
}
