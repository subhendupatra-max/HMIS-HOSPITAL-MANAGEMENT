                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap">
                                ...
                                <tbody id="chargeTable">
                                    <tr id="row">
                                        <td>
                                            <select class="form-control select2-show-search" onchange="getChargeCategory(<?php echo e($patient_charge_details->charge_category); ?>)" name="charge_set[]" id="charge_set">
                                                <option value="" disable >Select One..</option>
                                                <option value="Normal" <?php echo e($patient_charge_details->charge_set == 'Normal' ? 'selected':''); ?> >Normal</option>
                                                <option value="Package" <?php echo e($patient_charge_details->charge_set == 'Package' ? 'selected':''); ?>>Package</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select class="form-control select2-show-search" name="charge_type[]" id="charge_type" onchange="getchargetype_details()">
                                                ...
                                                <?php $__currentLoopData = Config::get('static.charges_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $charges_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($charges_type); ?>" <?php echo e($patient_charge_details->charge_type == $charges_type ? 'selected':''); ?>> <?php echo e($charges_type); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/OPD/charges/edit-charges.blade.php ENDPATH**/ ?>