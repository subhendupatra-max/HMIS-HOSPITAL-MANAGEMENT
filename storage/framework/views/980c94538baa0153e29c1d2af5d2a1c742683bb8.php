                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <span class="head_name">Charges</span> : <span
                            class="value_name"><?php echo e(@$pathologyTest->charges->charge_name); ?></span>
                    </div>
                    <div class="col-md-4">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DITS-HMIS\resources\views/pathology/test-pathology/pathology-test-details.blade.php ENDPATH**/ ?>