        ...
        <div class="card-body">
            <ul class="nav nav-pills nav-pills-circle" id="tabs_2" role="tablist">
                ...
                <li class="nav-item" style="margin-left: auto;">
                    <a class="btn btn-primary btn-sm" data-placement="top" data-toggle="tooltip" title="Admission" href="<?php echo e(route('ipd-registation-from-opd', ['id' => base64_encode($opd_patient_details->id), 'patient_source' => 'opd', 'source_id' => '$opd_patient_details->emg_details_id'])); ?>"><i class="fa fa-address-card"></i></a>
                </li>
