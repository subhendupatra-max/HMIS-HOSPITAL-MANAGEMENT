            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <div class="d-block">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add medicine vendor')): ?>
                        <a href="<?php echo e(route('add-medicine-vendor-details')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-user"></i> Add New Vendor </a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                    ...
                    <table id="example" class="table table-bordered text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete role')): ?>
                                <td>
                                    <form action="<?php echo e(route('delete-medicine-vendor-details')); ?>" method="POST" id="delete">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit role')): ?>
                                <td>
                                    <a href="<?php echo e(route('edit-medicine-vendor-details',['id'=>base64_encode($item->id)])); ?>" class="btn btn-warning" data-toggle="tooltip-primary" data-placement="top" title="Edit Vendor Details"><i class="fa fa-edit"></i></a>
                                </td>
                                <?php endif; ?>
                            </tr>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/setup/pharmacy/medicine-vendor/vendor-listing.blade.php ENDPATH**/ ?>