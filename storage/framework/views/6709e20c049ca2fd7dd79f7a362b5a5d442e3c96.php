            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <div class="d-block">
                        ...
                        <a href="<?php echo e(route('all-medicine-listing')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-file-invoice-dollar"></i> Generate Bill</a>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DITS-HMIS\resources\views/pharmacy/generate-bill/generate-bill-listing.blade.php ENDPATH**/ ?>