                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <span class="requisition_header">GRN No. : </span><span class="requisition_text"><?php echo e(@$grm_list->grm_prefix); ?><?php echo e(@$grm_list->grm_id); ?></span>
                            </div>
                            <div class="col-md-6">
                            ...
                            <?php if(@isset($grm_list->bill_rec_date)): ?>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <span class="requisition_header">Challan Date : </span><span class="requisition_text"><?php echo e(@$grm_list->challan_date); ?>

                                </span>
                            </div>
                            <div class="col-md-6">
                                <span class="requisition_header">Invoice Date : </span><span class="requisition_text"><?php echo e(@$grm_list->invoice_date); ?></span>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <span class="requisition_header">PO. No. : </span><span class="requisition_text"><a target="_blank" href="<?php echo e(route('purchase-order-details-inventory',['id' => base64_encode($po_details->id) ] )); ?>" style="color: blue;"><?php echo e($po_details->po_prefix); ?><?php echo e($po_details->id); ?></a>
                                </span>
                            </div>
                            <div class="col-md-6">
                                <span class="requisition_header">PO. Value : </span><span class="requisition_text"><?php echo @$grm_list->po_value; ?></span>
                            </div>
                            <?php if(isset($grm_list->note)): ?>
                            <div class="col-md-12">
                                <span class="requisition_header">Note : </span><span class="requisition_text"><?php echo e(@$grm_list->note); ?></span>
                            </div>
                            <?php endif; ?>
                            <?php if(isset($grm_list->challan_copy) && $grm_list->challan_copy != '' && $grm_list->challan_copy != null): ?>
                            <div class="col-md-6">
                                <a href="<?php echo e(asset('Challan_copy/')); ?>/<?php echo e(@$grm_list->challan_copy); ?>" target="_blank" style="color: blue;font-size: 15px;"><i class="fa fa-eye"><b>
                                            View Challan</b></i></a>
                            </div>
                            <?php endif; ?>
                            <?php if(isset($grm_list->invoice_copy) && $grm_list->invoice_copy != '' && $grm_list->invoice_copy != null): ?>
                            <div class="col-md-6">
                                <a href="<?php echo e(asset('invoice_copy/')); ?>/<?php echo e(@$grm_list->invoice_copy); ?>" target="_blank" style="color: blue;font-size: 15px;"><i class="fa fa-eye"><b>
                                            View Invoice</b></i></a>
                            </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Inventory/grn/grm-details-inventory.blade.php ENDPATH**/ ?>