    ...
    <div class="card">
        <div class="card-body">
            <ul class="nav nav-pills nav-pills-circle" id="tabs_2" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link border py-2 px-2 m-1" href="<?php echo e(route('payment-listing-in-emg',['id' => base64_encode($emg_patient_details->id)])); ?>" role="tab" aria-selected="false">
                        <span class="nav-link-icon d-block"><i class="fa fa-rupee-sign"></i> Payment </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link border py-2 px-2 m-1" href="<?php echo e(route('timeline-lisitng-in-emg',['id' => base64_encode($emg_patient_details->id)])); ?>" aria-selected="false">
                ...
                <li class="nav-item" style="margin-left: auto;">
                    <a class="btn btn-primary btn-sm" data-placement="top" data-toggle="tooltip" title="Admission" href="<?php echo e(route('ipd-registation-from-emg', ['id' => base64_encode($emg_patient_details->id)])); ?>"><i class="fa fa-address-card"></i></a>
                </li>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/emg/emg-patient-profile.blade.php ENDPATH**/ ?>