                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2-show-search" name="vehicle_reg_no" data-placeholder="Choose one">
                                            ...
                                            <option value="<?php echo e($value->registration_no); ?>"><?php echo e($value->registration_no); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                    </select>
                                    <?php $__errorArgs = ['vehicle_reg_no'];
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ame_inventory\resources\views/appPages/job/add-job.blade.php ENDPATH**/ ?>