...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <select required class="form-control select2-show-search select2-hidden-accessible"  tabindex="-1" aria-hidden="true" name="role">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" required id="inputPassword3" name="password" placeholder="Password">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="inputName" name="father_name" placeholder="Father's Name">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" required class="form-control"  name="age" >
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" required class="form-control"  name="phone_no" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control"  name="emg_phone_no" >
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-4">
                            ...
                            <input type="number" required class="form-control"  name="whatapps_no" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea required class="form-control" name="highest_qualification"></textarea>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/Users/userCreation.blade.php ENDPATH**/ ?>