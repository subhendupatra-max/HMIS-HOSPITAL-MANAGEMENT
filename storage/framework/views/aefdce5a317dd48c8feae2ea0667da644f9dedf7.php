...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('update-prescription-in-ipd')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <input type="hidden" name="ipd_id" value="<?php echo e($ipdPrescriptionDetails->ipd_id); ?>" />
                    <input type="hidden" name="section" value="<?php echo e($ipdPrescriptionDetails->section); ?>" />
                    <input type="hidden" name="patient_id" value="<?php echo e($ipdPrescriptionDetails->patient_id); ?>" />
                    <input type="hidden" name="case_id" value="<?php echo e($ipdPrescriptionDetails->case_id); ?>" />

                    <input type="hidden" name="id" value="<?php echo e($ipdPrescriptionDetails->id); ?>" />
                    ...
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap">
                            ...
                            <tbody id="chargeTable">
                                <?php if($ipdPrescriptionMedicineDetails[0]->medicine_category_id != null): ?>
                                <?php $__currentLoopData = $ipdPrescriptionMedicineDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <script>
                                    getMedicine_name({
                                        {
                                    ...
                                    <div class="table-responsive">
                                        <table class="table card-table table-vcenter text-nowrap">
                                            ...
                                            <tbody id="addPathologyTable">
                                                <?php if($ipdPrescriptionPathologyDetails[0]->test_id != null): ?>
                                                <?php $__currentLoopData = $ipdPrescriptionPathologyDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table card-table table-vcenter text-nowrap">
                                            ...
                                            <tbody id="addRadiologyTable">
                                                <?php if($ipdPrescriptionRadiologyDetails[0]->test_id != null): ?>
                                                <?php $__currentLoopData = $ipdPrescriptionRadiologyDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row  mt-5 col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <input type="datetime-local" class="form-control" id="date" name="date" required <?php if(isset($ipdPrescriptionDetails->prescription_date)): ?> value="<?php echo e(date('Y-m-d h:m:s', strtotime($ipdPrescriptionDetails->prescription_date))); ?>" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="note" id="note" class="form-control" value="<?php echo e($ipdPrescriptionDetails->note); ?>" />
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Ipd/prescription/edit-prescription.blade.php ENDPATH**/ ?>