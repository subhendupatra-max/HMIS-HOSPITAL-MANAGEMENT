...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <div class="card-title">IPD Patient Report</div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="row no-gutters">
                        <div class="col-md-8 border-right">
                            <form method="POST" action="<?php echo e(route('fetch-ipd-patient-report')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4 newaddappon">
                                            ...
                                            <select name="patient_type" onchange="getDetailsAccordingType(this.value)"
                                                ...
                                                <?php $__currentLoopData = Config::get('static.patient_types'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>
                                                $patient_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="form-group col-md-4 newaddappon">
                                            ...
                                            <select name="department" class="form-control select2-show-search"
                                                ...
                                                <option value="<?php echo e($department->id); ?>"
                                                    <?php echo e(@$all_search_data['department']==$department->id ?
                                                    'selected':''); ?>> <?php echo e($department->department_name); ?>
                                        ...
                                        <div class="form-group col-md-4 newaddappon">
                                            ...
                                            <select name="cons_doctor" class="form-control select2-show-search"
                                                ...
                                                <option value="<?php echo e($doctor->id); ?>"
                                                    <?php echo e(@$all_search_data['cons_doctor']==$doctor->id ? 'selected':''); ?> > <?php echo e($doctor->first_name); ?>
            ...
            <div class="">
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap" id="example">
                        ...
                        <tbody>
                            <?php $i = 0; ?>
                            <?php if(@$ipd_patient_report[0]->id != null): ?>
                            <?php $__currentLoopData = $ipd_patient_report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $i++; ?>
                            <tr>
                                <td><?php echo e(@$value->ipd_prefix); ?><?php echo e(@$value->id); ?></td>
                                <td><?php echo e(@$value->all_patient_details->prefix); ?>

                                    <?php echo e(@$value->all_patient_details->first_name); ?>

                                    <?php echo e(@$value->all_patient_details->middle_name); ?>

                                    <?php echo e(@$value->all_patient_details->last_name); ?>(<?php echo e(@$value->all_patient_details->id); ?>)</td>
                                <td> <?php if(@$value->all_patient_details->year != 0): ?>
                                ...
                                <td><?php echo e(@$value->doctor_details->first_name); ?>

                                    <?php echo e(@$value->doctor_details->last_name); ?></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/report/ipd_patient_report.blade.php ENDPATH**/ ?>