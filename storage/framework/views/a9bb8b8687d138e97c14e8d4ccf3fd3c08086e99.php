...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <div class="card-title">IPD Registation </div><span class="text-danger mr-4" style="margin:0px 0px 0px 20px">** Please Patient Select First **</span>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-lg-4 col-xl-4 border-right">
                    ...
                    <div class="options px-5 pt-2  border-bottom pb-1">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <a class="btn btn-primary btn-sm" href="<?php echo e(route('add_new_patient-in-ipd')); ?>"><i class="fa fa-plus"></i> Add New Patient</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="options px-5 pt-5  border-bottom pb-3">
                        ...
                        <form method="post" action="<?php echo e(route('direct-ipd-admission')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    <select class="form-control  select2-show-search" name="patient_id">
                                        ...
                                        <option value="<?php echo e(@$patient->id); ?>" <?php echo e(@$patient_details_information->id == $patient->id ? 'Selected' : ''); ?>> <?php echo e(@$patient->prefix); ?> <?php echo e(@$patient->first_name); ?> <?php echo e(@$patient->middle_name); ?> <?php echo e(@$patient->last_name); ?> ( <?php echo e(@$patient->id); ?> ) ( <?php echo e(@$patient->phone); ?> ) </option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-8 col-xl-8">
                    <form method="post" action="<?php echo e(route('ipd-registation')); ?>">
                        ...
                        <input type="hidden" name="patient_source" value="Direct Admission" />
                        ...
                        <div class="options px-5 pt-1  border-bottom pb-3">
                            <div class="row">
                                <div class="form-group col-md-2 newaddappon">
                                    ...
                                    <input type="date" required class="form-control" id="date_of_birth" name="date_of_birth" onchange="getagefromdate(this.value)" value="<?php echo e(date('Y-m-d',strtotime($patient_details_information->date_of_birth))); ?>" required />
                                ...
                                <div class="form-group col-md-4 ">
                                    <div class="row">
                                        <div class="col-lg-4 newdesignadd">
                                            <input type="text" required onkeyup="getage()" id="date_of_birth_year" value="<?php echo e(@$patient_details_information->year); ?>" name="date_of_birth_year">
                                            <label for="date_of_birth_year"> Year</label>
                                            <small class="text-danger"><?php echo e($errors->first('date_of_birth_year')); ?></small>
                                        </div>

                                        <div class="col-lg-4 newdesignadd">
                                            <input type="text" required onkeyup="getage()" id="date_of_birth_month" value="<?php echo e(@$patient_details_information->month); ?>" name="date_of_birth_month">
                                            <label for="date_of_birth_month"> Month</label>
                                            <small class="text-danger"><?php echo e($errors->first('date_of_birth_month')); ?></small>

                                        </div>
                                        <div class="col-lg-4 newdesignadd">
                                            <input type="text" required onkeyup="getage()" id="date_of_birth_day" value="<?php echo e(@$patient_details_information->day); ?>" name="date_of_birth_day">
                                ...
                                <div class="col-md-3 newdesignadd">
                                    <input type="text" required id="admitted_by" value="<?php echo e(@$patient_details_information->local_guardian_name); ?>" name="admitted_by">
                                    <label for="admitted_by"> Admitted By</label>
                                    <small class="text-danger"><?php echo e($errors->first('admitted_by')); ?></small>
                                </div>
                                <div class="col-md-3 newdesignadd">
                                    <input type="text" required id="admitted_by_contact_no" value="<?php echo e(@$patient_details_information->local_guardian_contact_no); ?>" name="admitted_by_contact_no">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/Ipd/admission.blade.php ENDPATH**/ ?>