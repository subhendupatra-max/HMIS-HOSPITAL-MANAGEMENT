...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-ward-details')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e($editWard->id); ?>">
                <div class="">
                    <div class="form-group">
                        <label for="ward_name" class="form-label"></label>
                        <input type="text" class="form-control" id="ward_name" name="ward_name" placeholder="Enter Ward Name" value="<?php echo e($editWard->ward_name); ?>" required>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\hospital_software\resources\views/setup/ward/ward-edit.blade.php ENDPATH**/ ?>