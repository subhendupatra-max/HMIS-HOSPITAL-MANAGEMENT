...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('workshopEditAction')); ?>">
                <?php echo csrf_field(); ?>

                <div class="">
                    <div class="form-group">
                        <label for="workshop_name" class="form-label">Workshop Name</label>
                        <input type="text" class="form-control" id="workshop_name" name="workshop_name" placeholder="Enter workshop" value="<?php echo e($Workshop->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <select class="form-control select2-show-search" id="warehouse_incharge" name="warehouse_incharge"   data-placeholder="Choose one (with searchbox)">
                            <optgroup label="Mountain Time Zone">
                                <?php $__currentLoopData = $allUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php if($item->id == $Workshop->incharge): ?> selected <?php endif; ?>><?php echo e($item->name); ?></option> 
                    ...
                    <div>
                        <div  class="form-group">
                            ...
                            <textarea class="form-control mb-4" id="workshop_addr" name="workshop_addr" placeholder="Workshop Address" rows="3"><?php echo e($Workshop->address); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control mb-4" id="workshop_desc" name="workshop_desc" placeholder="Workshop Description" rows="3"><?php echo e($Workshop->desc); ?></textarea>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary mt-4 mb-0">Edit workshop</button>
            </form>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ame_inventory\resources\views/appPages/master/workshops/workshopEdit.blade.php ENDPATH**/ ?>