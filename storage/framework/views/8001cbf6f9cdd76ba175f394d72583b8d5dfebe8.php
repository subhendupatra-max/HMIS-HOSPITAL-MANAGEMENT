        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <div class="d-block">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add opd charges')): ?>
                        <a href="<?php echo e(route('add-opd-charges', ['id' => base64_encode($opd_id)])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-money-bill"></i> Add Charges </a>
                        <?php endif; ?>
                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" style="">
                                            ...
                                            <?php if($value->billing_status == '0'): ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete opd charges')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('delete-opd-charges',['id'=>base64_encode($opd_id),'charge_id'=>base64_encode($value->id)])); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/OPD/charges/charges-list.blade.php ENDPATH**/ ?>