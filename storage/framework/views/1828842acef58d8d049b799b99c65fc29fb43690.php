...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <!-- ================================Save Requisition===================================== -->
        <form method="POST" action="<?php echo e(route('update-item-issue-inventory')); ?>">
            <?php echo csrf_field(); ?>
            <div class="card-body">
                <div class="col-md-12">
                    <div class="row">
                        <input type="hidden" name="item_issue_id" value="<?php echo e($item_issue->id); ?>">
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2-show-search" name="workshop_id" id="workshop_id">
                                ...
                                <option value="<?php echo e($valu->id); ?>" <?php echo e($valu->id == $item_issue->stock_room_id ? 'selected' : " "); ?>><?php echo e($valu->item_store_room); ?>
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <input type="date" name="issue_date" class="form-control" <?php if(!empty($item_issue->issue_date)): ?> value="<?php echo e(date('Y-m-d', strtotime($item_issue->issue_date))); ?>" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <select class="form-control select2-show-search" name="issue_by" id="issue_by">
                                ...
                                <option value="<?php echo e($valu->id); ?>" <?php echo e($valu->id == $item_issue->issued_by ? 'selected' : " "); ?>><?php echo e($valu->first_name); ?> <?php echo e($valu->last_name); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <select class="form-control select2-show-search" name="department" id="department" onchange="getDepartment(this.value,<?php echo e($item_issue->issue_to); ?>)">
                                <option value="">Select One</option>
                                ...
                                <option value="<?php echo e($valu->id); ?>" <?php echo e($valu->id == $item_issue->department_id ? 'selected' : " "); ?>><?php echo e($valu->department_name); ?>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <textarea name="note" class="form-control"><?php echo $item_issue->note; ?></textarea>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Inventory/item-issue/edit-item-issue.blade.php ENDPATH**/ ?>