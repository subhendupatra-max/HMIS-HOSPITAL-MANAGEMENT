                    ...
                    <div class="form-group">
                      <div class="bededit">
                        ...
                        <select id="bedType_id" class="form-control" name="bedType_id">
                            ...
                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->bedType_name); ?></option>
                    ...
                    <div class="form-group">
                      <div class="bededit">
                        ...
                        <select id="bedGroup_id" class="form-control" name="bedGroup_id">
                            ...
                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->bedGroup_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="bedUnit_id" class="form-control" name="bedUnit_id">
                            ...
                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->bedUnit_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(@$item->bed_ward->ward_name); ?></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/setup/bed/bed-listing.blade.php ENDPATH**/ ?>