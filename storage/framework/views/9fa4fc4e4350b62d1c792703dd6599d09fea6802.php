...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-bed-unit-details')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e($editBedUnit->id); ?>">
                <div class="">
                    <div class="form-group">
                        <label for="bedUnit_name" class="form-label"></label>
                        <input type="text" class="form-control" id="bedUnit_name" name="bedUnit_name" placeholder="Enter Bed Unit Name" value="<?php echo e($editBedUnit->bedUnit_name); ?>" required>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\hospital_software\resources\views/setup/bedunit/bedunit-edit.blade.php ENDPATH**/ ?>