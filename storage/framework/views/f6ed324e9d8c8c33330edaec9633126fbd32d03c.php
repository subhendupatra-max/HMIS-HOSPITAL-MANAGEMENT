                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('brand-manufacturer')): ?>
                                <li><a href="<?php echo e(route('medicine-vendor-details')); ?>">Brand-Manufacturer</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
