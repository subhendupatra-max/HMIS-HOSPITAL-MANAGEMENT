                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item <?php echo e(Request::segment(1) == 'Patient' ? 'nav-active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(route('patient_details')); ?>">
                            <div class="icon-new"> <img src="<?php echo e(asset('public/assets/images/brand/hospitalisation.png')); ?>"></div>Patient
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item <?php echo e(Request::segment(1) == 'pharmacy' ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(route('pharmacy-bill-listing')); ?>">
                            <div class="icon-new"><img src="<?php echo e(asset('public/assets/images/brand/investigation.png')); ?>"></div>Pharmacy
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('charges-sub-catagory-details')); ?>">Charges sub catagory</a></li>
                                <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('add-complain-type-in-front-office')); ?>">Complain Type</a></li>
                                <?php endif; ?>
                                ...
                                <li><a href="<?php echo e(route('add-appointment-priority-in-front-office')); ?>">Appointment Priority</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('charges-package-catagory-details')); ?>">package catagory</a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('package sub catagory')): ?>
                                <li><a href="<?php echo e(route('charges-package-sub-catagory-details')); ?>">package sub catagory</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('add-inventory-item-catagory')); ?>">Inventory Item Catagory</a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inventory Item Unit')): ?>
                                <li><a href="<?php echo e(route('add-inventory-item-unit')); ?>">Inventory Item Unit</a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inventory Item Brand')): ?>
                                <li><a href="<?php echo e(route('add-inventory-item-brand')); ?>">Inventory Item Brand</a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inventory Item Manufacture')): ?>
                                <li><a href="<?php echo e(route('add-inventory-manufacture')); ?>">Inventory Item Manufacture</a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inventory Item Type')): ?>
                                <li><a href="<?php echo e(route('add-inventory-item-type')); ?>">Inventory Item Type</a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inventory Store Room')): ?>
                                <li><a href="<?php echo e(route('add-inventory-item-store-room')); ?>">Inventory Store Room</a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inventory Item Attribute')): ?>
                                <li><a href="<?php echo e(route('inventory-item-attribute')); ?>">Inventory Item Attribute</a></li>
                                <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('medicine-store-room-details')); ?>">medicine storeroom</a></li>
                                <?php endif; ?>
                                ...
                                <li><a href="<?php echo e(route('medicine-supplier-details')); ?>">medicine supplier</a></li>
                                <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('operation-catagory-details')); ?>">operation-catagory-details</a></li>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('operation type')): ?>
                                <li><a href="<?php echo e(route('operation-type-details')); ?>">operation-type-details</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('opd-ticket-fees-details')); ?>">opd-ticket-fees-details</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('pathology-catagory-details')); ?>">pathology catagory</a></li>
                                <?php endif; ?>
                                ...
                                <li><a href="<?php echo e(route('pathology-parameter-details')); ?>">pathology parameter</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('radiology-catagory-details')); ?>">radiology catagory</a></li>
                                <?php endif; ?>
                                ...
                                <li><a href="<?php echo e(route('radiology-parameter-details')); ?>">radiology parameter</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('blood-bank-product-details')); ?>">blood bank product</a></li>
                                <?php endif; ?>
