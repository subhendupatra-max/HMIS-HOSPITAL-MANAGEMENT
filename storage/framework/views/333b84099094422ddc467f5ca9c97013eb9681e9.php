...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                    <select  id="unit" name="unit[]"  class="form-control select2" data-placeholder="---Select Unit---" multiple>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ame_inventory\resources\views/appPages/master/item/add-item.blade.php ENDPATH**/ ?>