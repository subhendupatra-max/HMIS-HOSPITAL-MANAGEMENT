...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('update-charges-package-name-details')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <input type="hidden" name="id" value="<?php echo e($editPackageName->id); ?>" />
                    <div class="form-group col-md-4">
                        <label for="charge_package_catagory_id" class="form-label">Charges Package Catagory <span class="text-danger">*</span></label>
                        <select id="charge_package_catagory_id" class="form-control" name="charge_package_catagory_id" onchange="getChargersPackageCatagoryId(this.value)" data-subCatagory_id="<?php echo e($editPackageName->charge_package_sub_catagory_id); ?>">
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id = $editPackageName->charge_package_catagory_id ? 'selected' : " "); ?>><?php echo e($item->charges_package_catagories_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="package_name" name="package_name" value="<?php echo e($editPackageName->package_name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="tax" value="<?php echo e($editPackageName->tax); ?>" name="tax" placeholder="Enter Tax">
                        <small class="text-danger"><?php echo e($errors->first('tax')); ?></small>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="total_amount">Total Amount<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="total_amount" name="total_amount" value="<?php echo e($editPackageName->total_amount); ?>" readonly>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/setup/charges-package/package-name/edit-package-name.blade.php ENDPATH**/ ?>