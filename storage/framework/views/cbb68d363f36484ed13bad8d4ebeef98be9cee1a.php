                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control select2-show-search select2-hidden-accessible" value="<?php echo e(old('vehicle_model')); ?>" name="vehicle_model" id="vehicle_model" required>
                            <optgroup>
                                ...
                                <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $editAmbulanceCall->vehicle_model ? 'selected' : " "); ?>><?php echo e($item->vehicle_model); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" id="date" name="date" <?php if(isset($editAmbulanceCall->date)): ?> value="<?php echo e(date('Y-m-d',strtotime($editAmbulanceCall->date))); ?>" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="charge_category" class="form-control select2-show-search" name="charge_category" required  data-subcatagory_id="<?php echo e($editAmbulanceCall->charge_sub_category); ?>">
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $editAmbulanceCall->charge_category ? 'selected' : " "); ?>><?php echo e($item->charges_catagories_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="charge_sub_category" class="form-control select2-show-search" id="charge_sub_category" required data-charge_id="<?php echo e($editAmbulanceCall->charge_name); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="tax" value="<?php echo e(old('tax')); ?>" onkeyup="totalAmount()" name="tax" value="<?php echo e($editAmbulanceCall->tax); ?>" required>
                        <?php $__errorArgs = ['tax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 ">
                        ...
                        <input type="text" class="form-control" id="total_amount" name="total_amount" required readonly value="<?php echo e($editAmbulanceCall->total_amount); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 ">
                        ...
                        <input type="text" class="form-control" id="net_amount" name="net_amount" required readonly value="<?php echo e($editAmbulanceCall->net_amount); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="payment_mode" class="form-control" name="payment_mode" onchange="paymentMode(this.value)" required>
                            ...
                            <option value="<?php echo e($item); ?>" <?php echo e($item == $editAmbulanceCall->payment_mode ? 'selected' : " "); ?>> <?php echo e($item); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 ">
                        ...
                        <input type="text" class="form-control" id="payment_amount" name="payment_amount" readonly required value="<?php echo e(@$editAmbulanceCall->payment_amount); ?>">
                    ...
                    <div class="mt-3 form-group col-md-12" id="check" style="display:none">
                        <div class="row">
                            <div class="form-group col-lg-4 ">
                                ...
                                <input type="text" class="form-control" id="cheque_no" name="cheque_no" value="<?php echo e(@$editAmbulanceCall->payment_amount); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-lg-4 ">
                                ...
                                <input type="date" class="form-control" id="cheque_date" name="cheque_date" <?php if(isset($editAmbulanceCall->cheque_date)): ?> value="<?php echo e(date('Y-m-d',strtotime($editAmbulanceCall->cheque_date))); ?>" <?php endif; ?>>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        let sel = (value.id == subCatagory ? 'selected' : '');
...
<script>
    $(document).ready(function() {
        $("#charge_sub_category").change(function(event) {
            ...
            let charge = $(this).val();
            // alert(charge);
            let chargeId = $(this).attr("data-charge_id");
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        let sel = (value.id == chargeId  ? 'selected' : "");
                        $('#charge_name').append(`<option value="${value.id}" ${sel}>${value.charges_name}</option>`);
                    });
                },
                error: function(error) {
                    console.log(error);
