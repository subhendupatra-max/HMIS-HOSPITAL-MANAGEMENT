...
<div class="col-lg-12 col-xl-4 col-md-6 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-inventory-item-unit')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                    <div class="form-group">
                        <label for="role" class="form-label">Item Unit</label>
                        <input type="text" class="form-control" id="item_unit" name="item_unit" placeholder="Enter Item Unit" value="<?php echo e($itemUnit->units); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        <input type="hidden" name="item_unit_id" value="<?php echo e($itemUnit->id); ?>">
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)" name="base_val" id="base_val">
                                <optgroup label="Base Unit">
                                    ...
                                    <option value="<?php echo e($item->units); ?>" <?php echo e($item->units == $itemUnit->base_unit ? 'selected':''); ?>>
                                        <?php echo e($item->units); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)" id="operator" name="operator" id="operator">
                                    <optgroup label="Mountain Time Zone">
                                        <option value="+" <?php echo e($itemUnit->operator == '+'  ? 'selected':''); ?>>+</option>
                                        <option value="-" <?php echo e($itemUnit->operator == '-'  ? 'selected':''); ?>>-</option>
                                        <option value="*" <?php echo e($itemUnit->operator == '*'  ? 'selected':''); ?>>*</option>
                                        <option value="/" <?php echo e($itemUnit->operator == '/'  ? 'selected':''); ?>>/</option>
                                    </optgroup>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="operation_value" name="operation_value" placeholder="Enter Operation Value" value="<?php echo e($itemUnit->operation_value); ?>">
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete item unit')): ?>
                                <td>
                                    <form action="<?php echo e(route('delete-inventory-item-unit')); ?>" method="POST" id="delete">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit item unit')): ?>
                                <td>
                                    <a href="<?php echo e(route('edit-inventory-item-unit',['id'=>base64_encode($item->id)])); ?>" class="btn btn-warning" data-toggle="tooltip-primary" data-placement="top" title="Edit Item unit"><i class="fa fa-edit"></i></a>
                                </td>
                                <?php endif; ?>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/setup/Inventory/item-unit/edit-item-unit.blade.php ENDPATH**/ ?>