        ...
        <nav class="navbar navbar-expand-lg navbar-light ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('billing-summary')); ?>">
                ...
                <li class="nav-item <?php echo e(Request::segment(1) == 'pharmacy' ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('bed-status-list')); ?>">
                        <div class="icon-new"><img src="<?php echo e(asset('public/assets/images/brand/investigation.png')); ?>">
                        </div>Bed
                    </a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <?php endif; ?>
                        <a class="dropdown-item" href="<?php echo e(route('opd-billing-report')); ?>">OPD Billing Report</a>
                        ...
                        <?php endif; ?>
                        <?php if(auth()->user()->can('EMG Billing Report')): ?>
                        <a class="dropdown-item" href="<?php echo e(route('emg-billing-report')); ?>">EMG Billing Report</a>
                        <?php endif; ?>
                        <a class="dropdown-item" href="<?php echo e(route('ipd-patient-report')); ?>">IPD Patient Report</a>
                        <?php if(auth()->user()->can('IPD Billing Report')): ?>
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('discharge-patient-report')); ?>">Discharge Patient
                            Report</a>
                        <?php endif; ?>
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('blood-components-issue-report')); ?>">Blood Components
                            Issue Report</a>
                        <?php endif; ?>
                    ...
                    <div class="bell">
                        <div class="popup-link">
                            <a href="#popup1notification">
                                <div class="dashprofileimg"> <img
                                        src="<?php echo e(asset('public/assets/images/brand/bell.png')); ?>"><span
                                        class="icon-button__badge pulse" ></span>
                                </button>
                            </div>
                        </div>
                        <div id="popup1notification" class="popup-container">
                            <div class="popup-content">
                                ...
                                <div class="">
                                     <table class="table">
                                        <tbody id="nnotification_list">
                                    
                                        </tbody>
                                    </table> 
                                    <a href="<?php echo e(route('view-all-notification')); ?>" style="color:blue;margin: 0px 0px 0px 15px;
                                    font-weight: 500;">View all....</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function fetchData() {
        var div_data_notification = '';
        $.ajax({
            url: "<?php echo e(route('get-notification-all')); ?>",
            type: 'GET',
            success: function(response) {
                $.each(response.all_notification, function(i, obj) {
                        div_data_notification +=
                                        `<tr>
                                            <td>
                                                <i class="fa fa-envelope text-primary"></i>  ${obj.message}
                                            </td>
                                        </tr>`;
                        });
                    $('#nnotification_list').html(div_data_notification); 
