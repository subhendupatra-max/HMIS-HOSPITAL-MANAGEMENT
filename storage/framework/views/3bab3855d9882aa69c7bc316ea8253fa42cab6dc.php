    ...
    <div class="card">
        <div class="card-body">
            <ul class="nav nav-pills nav-pills-circle" id="tabs_2" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link border py-2 px-2 m-1" href="<?php echo e(route('payment-listing-in-opd',['id' => base64_encode($opd_patient_details->id)])); ?>" role="tab" aria-selected="false">
                        <span class="nav-link-icon d-block"><i class="fa fa-rupee-sign"></i> Payment </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link border py-2 px-2 m-1" href="<?php echo e(route('timeline-lisitng-in-opd',['id' => base64_encode($opd_patient_details->id)])); ?>" aria-selected="false">
                ...
                <li class="nav-item" style="margin-left: auto;">
                    <a class="btn btn-primary btn-sm" data-placement="top" data-toggle="tooltip" title="Admission" href="<?php echo e(route('ipd-registation-from-opd', ['id' => base64_encode($opd_patient_details->id), 'patient_source' => 'emg', 'source_id' => '$opd_patient_details->emg_details_id'])); ?>"><i class="fa fa-address-card"></i></a>
                </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update-timeline-lisitng-in-opd')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- <input type="hidden" name="e_opd_id" value="<?php echo e($opd_patient_details->id); ?>" /> -->
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DITS-HMIS\resources\views/OPD/opd-patient-profile.blade.php ENDPATH**/ ?>