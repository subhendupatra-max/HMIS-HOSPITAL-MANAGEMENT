...
<a class="dropdown-item <?php echo e(Request::segment(2) == 'emg-radiology-investigation' ? 'active' : ''); ?>" href="<?php echo e(route('emg-radiology-investigation', ['id' => base64_encode($emg_patient_details->id)])); ?>"><i class="fa fa-x-ray"></i> Radiology Investigation</a>
<?php endif; ?>
...
<a class="dropdown-item <?php echo e(Request::segment(2) == 'emg-physical-condition' ? 'active' : ''); ?>" href="<?php echo e(route('physical-condition-in-emg', ['id' => base64_encode($emg_patient_details->id)])); ?>"><i class="fa fa-file"></i> Physical Conditions</a>
<a class="dropdown-item <?php echo e(Request::segment(2) == 'emg-operation-details' ? 'active' : ''); ?>" href="<?php echo e(route('emg-operation-in-emg', ['id' => base64_encode($emg_patient_details->id)])); ?>"><i class="far fa-calendar-check"></i> Operation</a>

<a class="dropdown-item <?php echo e(Request::segment(2) == 'blood-bank-detials-in-emg' ? 'active' : ''); ?>" href="<?php echo e(route('blood-bank-detials-in-emg', ['id' => base64_encode($emg_patient_details->id)])); ?>"><i class="fas fa-tint"></i> Blood Details</a>

<a class="dropdown-item <?php echo e(Request::segment(2) == 'emg-prescription' ? 'active' : ''); ?>" href="<?php echo e(route('prescription-lisitng-in-emg', ['id' => base64_encode($emg_patient_details->id)])); ?>"><i class="fa  fa-file-prescription "></i> Prescription</a><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/emg/include/menu.blade.php ENDPATH**/ ?>