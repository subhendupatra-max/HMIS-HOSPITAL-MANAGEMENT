        ...
        <div style="margin: 0px 0px 0px 0px;">
            ...
            <table style="width: 100%; margin: 20px 0px 20px 0px;">
                <tr>
                    ...
                    <td style="padding: 0px 0px 5px 5px;font-size: 14px;width: 120px;border-bottom: 1px dashed #bfb2b2;">
                        <?php echo e(@$job_card->registration_no); ?>
                    ...
                    <td style="padding: 0px 0px 5px 5px;font-size: 14px;width: 120px;border-bottom: 1px dashed #bfb2b2;">
                         <?php echo e(@$job_card->prefix); ?><?php echo e(@$job_card->job_id); ?>
                    ...
                    <td style="padding: 0px 0px 5px 5px;font-size: 14px;width: 120px;border-bottom: 1px dashed #bfb2b2;">
                        <?php echo e(date('d-m-Y h:i'),strtotime($job_card->job_date)); ?>
            ...
            <table style="width: 100%; margin: 20px 0px 20px 0px;">
                <tr>
                    ...
                    <td style="padding: 0px 0px 5px 5px;font-size: 14px;width: 120px;border-bottom: 1px dashed #bfb2b2;">
                        <?php echo e(@$job_card->driver_name); ?>

                    </td>
                    <th style="padding: 0px 0px 0px 15px;text-align: left;font-size: 13px;width: 50px;">
                       Mechnaic & Helper Name:
                    </th>
                    <td style="padding: 0px 0px 5px 5px;font-size: 14px;width: 120px;border-bottom: 1px dashed #bfb2b2;">
                        <?php echo e(@$job_card->mechanic_helper_name); ?>
                    ...
                    <td style="padding: 0px 0px 5px 5px;font-size: 14px;width: 120px;border-bottom: 1px dashed #bfb2b2;">
                        <?php echo e($job_card->reference_no); ?>
            ...
            <table style="width: 100%; margin: 20px 0px 20px 0px;">
                <tr>
                    <th style="padding:0px 0px 0px 0px;text-align:left;font-size: 13px;width:13%;">Workshop</th>
                    <td style="padding:0px 0px 5px 5px;font-size: 14px;width: 80%;border-bottom: 1px dashed #bfb2b2"><?php echo e(@$job_card->name); ?></td>
                </tr>
            </table>
            <!-- ========================================head down details============================= -->
            <!-- ========================================table details============================= -->
...
<!-- ================================================================= --><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/job/job-card-pdf.blade.php ENDPATH**/ ?>