        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                    <b>UHID No. :
                        <?php echo e($emg_details->all_patient_details->patient_prefix); ?>/<?php echo e($emg_details->all_patient_details->id); ?></b>
                </td>
                <td rowspan="2" style="text-align: center;border: 1px solid #899499;">
                    ...
                    <span style="width: 80px;height:60px"><?php echo QrCode::size(90)->generate($emg_de); ?> </span>
                </td>
                <td rowspan="2" style="text-align: center;border: 1px solid #899499;">
                    ...
                    <img src="data:image/png;base64,<?php echo e(base64_encode($generatorPNG->getBarcode('@$emg_details->emg_prefix @$emg_details->id', $generatorPNG::TYPE_CODE_128))); ?>" style="width: 190px;height:60px">
                </td>
                <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                    <b>Admission Date : <?php echo e($emg_details->all_emg_visit_details->appointment_date); ?></b>
                </td>
            ...
            <tr>
                <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b>
                        EMG no.
                        : <?php echo e($emg_details->emg_prefix); ?>/<?php echo e($emg_details->id); ?></b></td>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #899499;">
                    <b> Department: <?php echo e(@$emg_details->all_emg_visit_details->patient_department_details->department_name); ?></b>
                </td>
        ...
        <table style="width: 100%; margin: 15px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_patient_details->first_name); ?> <?php echo e($emg_details->all_patient_details->middle_name); ?> <?php echo e($emg_details->all_patient_details->last_name); ?>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_patient_details->guardian_name); ?>
                ...
                <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_patient_details->phone); ?>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_patient_details->year); ?>Y <?php echo e($emg_details->all_patient_details->month); ?>M
                    <?php echo e($emg_details->all_patient_details->day); ?>D
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Gender
                </th>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_patient_details->gender); ?>
                ...
                <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_emg_visit_details->patient_type); ?>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e(@$emg_details->all_emg_visit_details->doctor->first_name); ?> <?php echo e(@$emg_details->all_emg_visit_details->doctor->last_name); ?>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td colspan="7" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_patient_details->address); ?>,<?php echo e($emg_details->all_patient_details->_state->name); ?>,<?php echo e($emg_details->all_patient_details->_district->name); ?>,<?php echo e($emg_details->all_patient_details->pin_no); ?>

                </td>

            </tr>
            <?php if($emg_details->all_emg_visit_details->patient_type == 'Swasthya Sathi' || $emg_details->all_emg_visit_details->patient_type == 'TPA' ): ?>
            <tr>
                <th colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php if($emg_details->all_emg_visit_details->patient_type == 'Swasthya Sathi'): ?>
                    Swasthya Sathi No.
                    <?php elseif($emg_details->all_emg_visit_details->patient_type == 'TPA'): ?>
                    TPA <?php echo e($emg_details->all_emg_visit_details->tpa_details->TPA_name); ?>

                    <?php endif; ?>

                </th>
                <td colspan="7" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($emg_details->all_emg_visit_details->tpa_details->type_no); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/emg/billing/_print_emg_billing.blade.php ENDPATH**/ ?>