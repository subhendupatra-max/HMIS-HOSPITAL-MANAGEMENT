...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-work-station-details')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                    <input type="hidden" name="id" value="<?php echo e($editWorkStation->id); ?>">
                    <div class="form-group">
                        <label for="work_station_name" class="medicinelabel">Work Station Name</label>
                        <input type="text" class="form-control" id="work_station_name" name="work_station_name" value="<?php echo e($editWorkStation->work_station_name); ?>" required>
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(@$item->work_station_name); ?></td>
                                <td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/setup/work-station/edit-work-station.blade.php ENDPATH**/ ?>