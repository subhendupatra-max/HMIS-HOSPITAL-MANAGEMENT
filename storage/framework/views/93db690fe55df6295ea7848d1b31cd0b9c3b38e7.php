                                ...
                                <div class="col-md-12 mb-2">
                                    <select class="form-control  select2-show-search" name="patient_id">
                                        ...
                                        <option value="<?php echo e(@$patient->id); ?>" <?php echo e(@$patient_details_information->id ==
                                            ...
                                            <?php echo e(@$patient->last_name); ?> ( <?php echo e(@$patient->id); ?> )
                                        </option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-7 col-xl-8">
                    <form method="post" action="<?php echo e(route('update-radiology-charge')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="options px-5 pt-1  border-bottom pb-3">
                            <div class="row">
                                <div class="form-group col-md-6 adcharge ">
                                    <label class="date-format"> Date <span class="text-danger">*</span></label>
                                    <input type="datetime-local" name="date" value="<?php echo e(date('Y-m-d h:m:s',strtotime($test_details->date))); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6 adchargee ">
                                    ...
                                    <select required class="form-control select2-show-search" name="test_id" id="test_id">
                                        ...
                                        <?php if(isset($radiology_all_test)): ?>
                                        <?php $__currentLoopData = $radiology_all_test; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/radiology/patient-test/patient-test-edit.blade.php ENDPATH**/ ?>