            ...
            <aside class="app-sidebar">
                <div class="app-sidebar__logo">
                    <a class="header-brand" href="<?php echo e(route('dashboard')); ?>">
                        <img src="<?php echo e(asset('assets/images/brand')); ?>/<?php echo e(@$general_details->logo); ?>" style="width: 241px;  height: 48px;" class="header-brand-img desktop-lgo" alt="<?php echo e(@$general_details->software_name); ?>">
                        <img src="<?php echo e(asset('assets/images/brand')); ?>/<?php echo e(@$general_details->logo); ?>" class="header-brand-img dark-logo" alt="<?php echo e(@$general_details->software_name); ?>">

                        <img src="<?php echo e(asset('assets/images/brand')); ?>/<?php echo e(@$general_details->logo); ?>" class="header-brand-img mobile-logo" alt="<?php echo e(@$general_details->software_name); ?>">

                        <img src="<?php echo e(asset('assets/images/brand')); ?>/<?php echo e(@$general_details->logo); ?>" class="header-brand-img darkmobile-logo" alt="<?php echo e(@$general_details->software_name); ?>">
                    </a>
                    ...
                    <ul class="side-menu app-sidebar3">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu ">
                                <!-- FOR ADMIN ONLY -->
                                <li><a href="<?php echo e(route('report.requisition')); ?>" class="slide-item">Requisition</a></li>
                                <!-- FOR ADMIN ONLY END -->
                                ...
                                <div class="d-flex order-lg-2 ml-auto">
                                    ...
                                    <div class="dropdown profile-dropdown">
                                        <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                            <span>
                                                <img src="<?php echo e(asset('profile_picture')); ?>/<?php echo e($login_details->profile_image); ?>" alt="My Profile Picture" class="avatar avatar-md brround">
                                            </span>
                                        </a>
...
</html><?php /**PATH E:\xampp\ameInventory\resources\views/layouts/layout.blade.php ENDPATH**/ ?>