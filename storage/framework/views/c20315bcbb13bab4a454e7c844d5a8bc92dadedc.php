            ...
            <div class="table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="width: 10%">GST <span class="text-danger">*</span></th>
                        <th scope="col" style="width: 10%">Rate <span class="text-danger">*</span></th>
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class=" text-right">
                <button class="btn btn-primary" type="submit"><i class="fa fa-send"></i> Submit</button></div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\ame_inventory\resources\views/appPages/item/purchase-order/po_create.blade.php ENDPATH**/ ?>