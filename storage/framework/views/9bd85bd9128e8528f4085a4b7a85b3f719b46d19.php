...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Tpa Management</h4>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-tpa-management-details')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                    <input type="hidden" value="<?php echo e($editTpaManagement->id); ?>" name="id">
                    <div class="form-group">
                        <label for="TPA_name" class="form-label">TPA Name</label>
                        <input type="text" class="form-control" id="TPA_name" name="TPA_name" placeholder="Enter Tpa Name" value="<?php echo e($editTpaManagement->TPA_name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contact_person_name" name="contact_person_name" placeholder="Enter Contact Person Name " value="<?php echo e($editTpaManagement->contact_person_name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contact_person_ph_no" name="contact_person_ph_no" placeholder="Enter Contact Person Ph No" value="<?php echo e($editTpaManagement->contact_person_ph_no); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit" class="btn btn-primary mt-4 mb-0">Edit Tpa Management</button>
            </form>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/setup/tpa-management/edit-tpa-management.blade.php ENDPATH**/ ?>