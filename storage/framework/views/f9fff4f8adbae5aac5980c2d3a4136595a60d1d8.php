...
>>>>>>> bf886e12387b355327729051e191fbb23d532952
...
<<<<<<< HEAD
                                            ...
                                            <div class="form-group col-md-2 newdesignadd">
                                                ...
                                                <input type="text" id="Phone_no" value="<?php echo e(@$patient->phone); ?>" >
                                            ...
                                            <div class="form-group col-md-4 newdesignadd">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <input type="text" id="date_of_birth_year  value="<?php echo e(@$patient->year); ?>">
                                                    ...
                                                    <div class="col-lg-4 ">
                                                        ...
                                                        <input type="text" id="date_of_birth_month" value="<?php echo e(@$patient->month); ?>">
                                    ...
                                    <div class="main-profile-contact-list ">
                                        <div class="row">
                                            <div class="form-group col-md-4 newuserchangee ">
                                                ...
                                                <input type="text" id="address" value="<?php echo e(@$patient->address); ?>"name="address">
