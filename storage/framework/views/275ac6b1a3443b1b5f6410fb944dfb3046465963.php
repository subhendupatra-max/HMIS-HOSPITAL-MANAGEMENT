            ...
            <table cellspacing="0" border="0" width="100%" style="">
                <tr>
                    ...
                    <td style="padding: 10px 0px 0px 10px;font-size: 14px;line-height: 23px;font-family: inherit;vertical-align:top;border-bottom: 2px solid black;border-right:2px solid black;">
                        ...
                        <b><?php echo e($po_list->get_store_details->name); ?></b><br>
                        <?php echo e($po_list->get_store_details->address); ?><br>
                    </td>
                    <td colspan="6" style="padding: 10px 0px 0px 10px;font-size: 14px;line-height: 23px;font-family: inherit;vertical-align:top;border-bottom: 2px solid black;border-right:2px solid black;">
                        ...
                        <b><?php echo e($po_list->get_vendor_details->vendor_name); ?></b><br>
                        <?php echo e($po_list->get_vendor_details->vendor_address); ?><br>
                        GSTIN/UIN : <?php echo e($po_list->get_vendor_details->vendor_gst); ?>
...
<?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/pharmacy/purchase/purchase-order/print/_PurchaseOrder.blade.php ENDPATH**/ ?>