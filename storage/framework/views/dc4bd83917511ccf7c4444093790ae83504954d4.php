...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-finding')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e($finding_edit->id); ?>" />
                <div class="">
                    <div class="form-group">
                        <label for="finding_name" class="form-label"> Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="finding_name" name="finding_name" placeholder="Enter Finding Name" value="<?php echo e($finding_edit->finding_name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <select class="form-control" name="finding_category" required>
                            ...
                            <?php $__currentLoopData = $finding_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value->category_name); ?>" <?php echo e($finding_edit->finding_category_id == $value->category_name ? 'selected':''); ?>><?php echo e($value->category_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <textarea name="description" class="form-control"><?php echo e(@$finding_edit->description); ?></textarea>
                        <?php $__errorArgs = ['finding_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DITS-HMIS\resources\views/setup/finding/finding/edit.blade.php ENDPATH**/ ?>