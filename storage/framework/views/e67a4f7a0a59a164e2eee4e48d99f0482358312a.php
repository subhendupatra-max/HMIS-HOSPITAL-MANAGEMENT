...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="">
                <form action="<?php echo e(route('report.requisition-report-details')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                    <div class="col-md-3">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $requisition_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                <td><a href="<?php echo e(url('requisition-details')); ?>/<?php echo e($value->req_no); ?>" class="text-info"><?php echo e(@$value->requisition_prefix); ?><?php echo e(@$value->req_no); ?></a></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/item/reports/requisition.blade.php ENDPATH**/ ?>