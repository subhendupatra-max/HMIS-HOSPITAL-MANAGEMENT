            ...
            <form action="<?php echo e(route('update-new-patient-details')); ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="<?php echo e(@$patient->phone); ?>" id="phone" name="phone" placeholder="Enter Your Phone No.">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\hospital_software\resources\views/setup/patient/edit-patient.blade.php ENDPATH**/ ?>