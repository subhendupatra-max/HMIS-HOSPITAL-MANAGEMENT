        ...
        <div class="card-header  d-block">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <div class="d-block">
                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('opd-false-generation')); ?>"><i class="fa fa-reply"></i> Change Department</a>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group col-md-12 opd-bladedesign ">
                                                <button class="btn btn-primary btn-sm text-center ml-2" type="button" onclick="validate()" name="save" value="save"><i class="fa fa-plus"></i> Add OPD Registation</button>
                                            </div>
                                        </div>
                            </form>
                        </div>
...
<div class="col-lg-3 col-xl-3">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <ul class="list-group">
                    <li class="list-group-item"><i class="fa fa-cog text-danger" aria-hidden="true"></i> Today's total OPD Patient : <?php echo e(@$todays_total_opd); ?> <br>
                        <span class="badge badge-success badge-pill">Original : <?php echo e(@$todays_total_opd_ori); ?></span> <span class="badge badge-danger badge-pill">False : <?php echo e(@$todays_total_opd_sys); ?></span>
                    </li>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/false/opd/false_patient_list.blade.php ENDPATH**/ ?>