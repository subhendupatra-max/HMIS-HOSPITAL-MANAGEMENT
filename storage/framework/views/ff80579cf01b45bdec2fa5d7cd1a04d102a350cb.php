...
<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('itemCategoryEditAction')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                    <div class="form-group">
                        <label for="role" class="form-label">Item Category</label>
                        <input type="text" class="form-control" id="item_category" name="item_category" placeholder="Enter Item Category" value="<?php echo e($itemCategory->categories); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="hidden" name="item_category_id" value="<?php echo e($itemCategory->id); ?>">
                </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ame_inventory\resources\views/appPages/master/itemCategory/itemCategoryEdit.blade.php ENDPATH**/ ?>