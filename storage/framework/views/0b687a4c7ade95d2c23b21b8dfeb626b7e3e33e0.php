...
<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('prefixEditAction')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                    <div class="form-group">
                        <label for="role" class="form-label">Name</label>
                        <input type="text" class="form-control" id="prefix_name" name="prefix_name" placeholder="Enter Name" value="<?php echo e($prefix->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="prefix" name="prefix" placeholder="Enter prefix" value="<?php echo e($prefix->prefix); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="year" name="year" value="<?php echo e(date('Y')); ?>" placeholder="Enter Year" value="<?php echo e($prefix->year); ?>"  required readonly>
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="hidden" name="item_unit_id" value="<?php echo e($prefix->id); ?>">
                            ...
                            <?php $__currentLoopData = $allPrefix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                <tr>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit prefix')): ?>
                                      <td>
                                        <a href="<?php echo e(route('editPrefix',['id'=>base64_encode($item->id)])); ?>" class="btn btn-warning"  data-toggle="tooltip-primary" data-placement="top" title="Edit Item unit"><i class="fa fa-pencil"></i></a>
                                      </td>
                                    <?php endif; ?>
                                </tr>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ame_inventory\resources\views/appPages/master/prefix/prefixEdit.blade.php ENDPATH**/ ?>