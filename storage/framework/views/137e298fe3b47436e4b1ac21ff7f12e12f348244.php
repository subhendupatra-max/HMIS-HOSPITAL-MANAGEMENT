                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <span style="color:blue;cursor: pointer;" data-placement="top" data-toggle="tooltip"
                                    title="<?php echo e($value->comment); ?>"><i class="fa fa-eye"></i> View Note</span>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
                        ...
                        <ul class="timeline mb-0">
                            ...
                            <li class="mt-0">
                                <div class="d-flex"><span
                                        class="time-data"><?php echo e(@$user->permission_user_details->first_name); ?>

                                        <?php echo e(@$user->permission_user_details->last_name); ?></span><span
                                ...
                                <p class="text-muted fs-12">
                                    <span class="text-info">
                                        <?php if($user->user_id == Auth::id() && ( $user->permission_type == 'Parallal' ||
                                        @$show_for_permission->user_id == Auth::id()) ): ?>
                                        <td><a class="btn btn-pill btn-info btn-sm" data-target="#modaldemo1"
                                                data-toggle="modal" type="button"><?php echo e($user->status); ?></a></td>
                                        <?php else: ?>
                                        <td><a class="btn btn-pill btn-info btn-sm" type="button"><?php echo e($user->status); ?></a>
                                        </td>
                                        <?php endif; ?>
                                    </span>
                                </p>
                                ...
                                <p class="text-muted fs-12"><span style="color:blue;cursor: pointer;"
                                        data-placement="top" data-toggle="tooltip" title="<?php echo e($user->comment); ?>"><i
                ...
                <div class="card-body">
                    <div class="latest-timeline scrollbar3" id="scrollbar3">
                        <ul class="timeline mb-0">
                            ...
                            <li class="mt-0">
                                <div class="d-flex"><span
                                        class="time-data"><?php echo e(@$user->permisison_users_vendor->first_name); ?>
