            ...
            <form method="POST" action="<?php echo e(route('save-diagonasis-details')); ?>">
                ...
                <div class="">
                    <div class="form-group">
                        ...
                        <input type="text" id="diagonasis_name" name="diagonasis_name" placeholder="Enter Diagonasis Name" value="<?php echo e(old('diagonasis_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <div class="diagonasisedit">
                            ...
                            <input type="text" id="icd_code" name="icd_code" placeholder="Enter Icd Code" value="<?php echo e(old('icd_code')); ?>" required>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/setup/diagonasis/diagonasis-listing.blade.php ENDPATH**/ ?>