                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="department" id="department">
                                ...
                                <optgroup label="">
                                    ...
                                    <option value="<?php echo e($item->name); ?>" <?php echo e(@$item->department_name == $user_details->department ? 'selected' : " "); ?>><?php echo e($item->department_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </optgroup>
                            </select>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\hospital_software\resources\views/appPages/Users/edit-user.blade.php ENDPATH**/ ?>