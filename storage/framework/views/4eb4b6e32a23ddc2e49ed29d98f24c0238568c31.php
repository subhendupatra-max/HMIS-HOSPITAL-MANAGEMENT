        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <?php if (@$requisition_details->status >= 3 &&  @$requisition_details->status <= 9) { ?>
                    <form method="POST" action="<?php echo e(route('add-inventory-vender-for-quatation')); ?>">
                        <?php echo csrf_field(); ?>
                    ...
                    <table class="table table-striped card-table table-vcenter text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="<?php echo e(route('add-vendor-quatation-in-inventory')); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                ...
                                <td>
                                    <form method="POST" action="<?php echo e(route('vendor-select-for-po-in-inventory')); ?>">
                                        <?php echo csrf_field(); ?>
...
<div class="modal" id="modaldemo2">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('give-approval-vendor-in-inventory')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-12">
...
<div class="modal" id="modaldemoadd_rfq_vendor">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('add-inventory-vendor-permission')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-12">
...
<div class="col-md-12">
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                                <span class="requisition_header">Store Room : </span><span class="requisition_text"><?php echo e(@$requisition_details->store_room->item_store_room); ?></span>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <span class="requisition_header">Requested By : </span><span class="requisition_text"><?php echo e(@$requisition_requested_by->first_name); ?> <?php echo e(@$requisition_requested_by->last_name); ?></span>
                            </div>
                            <div class="col-md-4">
                                <span class="requisition_header">Generated By : </span><span class="requisition_text"><?php echo e(@$requisition_details->generate_by_name->first_name); ?>

                                    <?php echo e(@$requisition_details->generate_by_name->last_name); ?>
                        ...
                        <table class="table table-striped card-table table-vcenter text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(@$requisition->item_brand_name); ?></td>
                                    <td><?php echo e(@$requisition->manufacture_name); ?></td>
        ...
        <div class="col-lg-4 col-xl-4 col-md-4 col-sm-4">
            <?php if(isset($permisison_users[0]->permission_user_details->first_name) && $permisison_users[0]->permission_user_details->first_name != ''): ?>
            <div class="card">
                <div class="card-header">
...
<div class="modal" id="modaldemo1">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form method="POST" action="<?php echo e(route('given-approval-inventory')); ?>">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        Comment:
                        <textarea name="comment" class="form-control"><?php echo e(@$permisison_status_own->comment); ?></textarea>
                    </div>
                    <div class="modal-footer">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Inventory/requisition/inventory-requisition-details.blade.php ENDPATH**/ ?>