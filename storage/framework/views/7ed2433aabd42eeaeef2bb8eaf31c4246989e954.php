                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('vendorActivation',['id'=>base64_encode($item->id)])); ?>" class="btn btn-info" data-toggle="tooltip-primary" data-bs-placement="top" title="PnNo.<?php echo e($item->vendor_ph_no); ?>  Email.<?php echo e($item->email); ?> Contact Person.<?php echo e($item->contact_name); ?>"><i class="fa fa-eye"></i></a>
                                </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\ameInventory\resources\views/appPages/master/vendor/vendorList.blade.php ENDPATH**/ ?>