    ...
    <table style="width: 100%; border:1px soild black;border-collapse: collapse">
        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                    <b>UHID No. : <?php echo e($Opd_details->all_patient_details->patient_prefix); ?><?php echo e($Opd_details->all_patient_details->id); ?></b>
                </td>
                <td rowspan="2" style="text-align: center;border: 1px solid #899499;">
                    ...
                    ?>
                    <?php echo QrCode::size(60)->generate($ipd_de); ?>
                ...
                <td rowspan="2" style="text-align: center;border: 1px solid #899499;">
                    ...
                    <img src="data:image/png;base64,<?php echo e(base64_encode($generatorPNG->getBarcode('@$Opd_details->all_patient_details->patient_prefix @$Opd_details->all_patient_details->id', $generatorPNG::TYPE_CODE_128))); ?>" style="width: 150px;height: 40px;">
            ...
            <tr>
                <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b> OPD no. : <?php echo e($Opd_details->opd_prefix); ?><?php echo e($Opd_details->id); ?></b></td>
        ...
        <table style="width: 100%; margin: 15px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($Opd_details->all_patient_details->first_name); ?> <?php echo e($Opd_details->all_patient_details->meddile_name); ?> <?php echo e($Opd_details->all_patient_details->last_name); ?>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($Opd_details->all_patient_details->year); ?>Y <?php echo e($Opd_details->all_patient_details->month); ?>M <?php echo e($Opd_details->all_patient_details->day); ?>D
                </td>
                <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    Gender
                </th>
        ...
        <table style="width: 100%; margin: 0px 0px 0px 0px; border-collapse: collapse; border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;">
            <tr>
                ...
                <td style="text-align: right;font-size: 13px; width:90px;padding: 0px 10px 0px 0px; "><?php echo e(@$Opd_details->billing_details->total_amount); ?></td>
            </tr>
            <tr>
                <th style="text-align: right;font-size: 13px;padding: 5px 0px 5px 0px; ">Tax :</th>
                <td style="text-align: right;font-size: 13px;padding: 0px 10px 0px 0px; "><?php echo e(@$Opd_details->billing_details->tax); ?></td>
            </tr>
            <tr>
                <th style="text-align: right;font-size: 13px;padding: 5px 0px 5px 0px; ">Discount :</th>
                <td style="text-align: right;font-size: 13px;padding: 0px 10px 0px 0px; "><?php echo e(@$Opd_details->billing_details->discount_details->discount_type); ?></td>
            </tr>
            <tr>
                <th style="text-align: right;font-size: 13px; padding: 5px 0px 5px 0px;">Grand Total :</th>
                <td style="text-align: right;font-size: 13px; padding: 0px 10px 0px 0px;"><?php echo e(@$Opd_details->billing_details->grand_total); ?></td>
            </tr>
        </table>
        <table style="width: 100%;
...
border-bottom: 1px solid black;">
            <tr>
                ...
                <td style="text-align: left;font-size: 13px;">
                    <?php echo e(@$Opd_details->billing_details->bill_date); ?>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 13px;">
                    <?php echo e(@$Opd_details->billing_details->payment_status); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/OPD/_print/opd-biling-charges.blade.php ENDPATH**/ ?>