					...
					<table class="table mb-0">
						<tbody>
							<tr>
								...
								<td class="py-2 px-0"><?php echo e($login_details->first_name); ?> <?php echo e($login_details->middle_name); ?> <?php echo e($login_details->last_name); ?></td>
							</tr>
							<tr>
								<td class="py-2 px-0">
						...
						<div class="media mr-5">
							...
							<div class="media-body">
								<h6 class="font-weight-bold mb-1">Whatsapp to <br>
									<a class="text-info" href="https://api.whatsapp.com/send?phone=+91<?php echo e($login_details->whatapps_no); ?>&amp;text=Hi%20<?php echo e($login_details->name); ?>" target="_blank"><?php echo e($login_details->whatsapp_no); ?></a>
					...
					<div class="main-profile-contact-list d-lg-flex">
						...
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="font-weight-normal1">
									<?php echo $login_details->current_address; ?> 
								</div>
							</div>
						</div>
					</div><!-- main-profile-contact-list -->
					...
					<div class="main-profile-contact-list d-lg-flex">
						...
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="font-weight-normal1">
									<?php echo $login_details->permanent_address; ?> 
								</div>
							</div>
						</div>
					</div><!-- main-profile-contact-list -->
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/appPages/Users/user-details.blade.php ENDPATH**/ ?>