...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('return-update-inventory')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card-body">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 grncreateadd">
                            <input type="hidden" value="<?php echo e($rejection_list->return_id); ?>" name="return_id">
                            <label class="requisition_header1">Purchase Order<span class="text-danger">*</span></label>
                            <input type="text" readonly value="<?php echo e($po_list->po_prefix); ?><?php echo e($po_list->po_id); ?>" class="form-control" name="po_no" id="po" />
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <input type="date" name="material_rec_date" class="form-control" value="<?php echo e(@$rejection_list->material_rec_date); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <input type="date" required name="rejection_date" value="<?php echo e(@$rejection_list->rejection_date); ?>" class="form-control">
                            <?php $__errorArgs = ['rejection_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <input type="date" name="bill_rec_date" class="form-control" value="<?php echo e(@$rejection_list->bill_rec_date); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <input type="text" name="challan_no" class="form-control" value="<?php echo e(@$rejection_list->challan_no); ?>">
                        </div>
                        <div class="col-md-4 grncreateadd" >
                            <label class="requisition_header">Challan Date (DD-MM-YYYY)</label>
                            <input type="text" name="challan_date" class="form-control" value="<?php echo e(@$rejection_list->challan_date); ?>">
                        </div>
                        ...
                        <div class="col-md-4 grncreateadd">
                            ...
                            <input type="text" name="invoice_no" class="form-control" value="<?php echo e(@$rejection_list->invoice_no); ?>">
                        </div>
                        <div class="col-md-4 grncreateadd">
                            <label class="requisition_header">Invoice Date (DD-MM-YYYY)</label>
                            <input type="text" name="invoice_date" class="form-control" value="<?php echo e(@$rejection_list->invoice_date); ?>">
                        </div>
                        

                        <div class="col-md-12">
                            <span class="requisition_header">Purchase Order : </span><span id="po_no" class="requisition_header" style="color:blue"><?php echo e(@$po_details->po_prefix); ?><?php echo e(@$po_details->po_id); ?></span>
                        </div>
                        <div class="col-md-4">
                            <span class="requisition_header">PO. Date : </span><span id="po_date" class="requisition_text"><?php echo e(date('d-m-Y',strtotime($po_details->po_date))); ?></span>
                        </div>
                        <div class="col-md-4">
                            <span class="requisition_header">Workshop : </span><span id="workshop" class="requisition_text"><?php echo e(@$po_details->workshop_name); ?></span>
                        </div>
                        <input type="hidden" name="workshop_id" id="wrk_id" value="<?php echo e($po_details->workshop_id_no); ?>">
                        <input type="hidden" name="vendor" id="vend_id" value="<?php echo e($po_details->vendor_id_no); ?>">
                        <div class="col-md-4">
                            <span class="requisition_header">Vendor : </span><span id="vendor_name" class="requisition_text"><?php echo e(@$po_details->vendor_name); ?></span>
                        </div>
                ...
                <div class="">
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap" id="subhendu">
                            ...
                            <tbody id="alltextre">
                                <!-- dynamic row -->
                                <?php if(!empty($rejection_item)): ?>
                                <?php $i = 0;
                                $req_ids = array();
                                ?>
                                <?php $__currentLoopData = $rejection_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grnItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                $i += 1;
                                $req_ids[] = $grnItem->req_id;
                                ?>
                                <tr id="rowid<?php echo e($i); ?>">
                                    <input class="form-control" type="hidden" name="return_details_id[]" required="" readonly="" value="<?php echo e($grnItem->return_setails_id); ?>">
                                    <td>
                ...
                <div class="container mt-5">
                    <div class="d-flex justify-content-end">
                        ...
                        <input type="text" name="invoice_value" id="invoice_value" class="form-control myfld" value="<?php echo e($rejection_list->invoice_value); ?>">
                    </div>
                    <div class="d-flex justify-content-end thrdarea">
                        <span class="biltext">PO. Value</span>
                        <input type="text" name="po_value" id="po_value" class="form-control myfld" value="<?php echo e($rejection_list->po_value); ?>">
                    </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea name="note" class="form-control"><?php echo e($rejection_list->note); ?></textarea>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function findPOdetails(po_id) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('get-po-item-details-by-grm-inven')); ?>/" + po_id,
            type: "get",
            dataType: 'json',
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Inventory/return/edit-return.blade.php ENDPATH**/ ?>