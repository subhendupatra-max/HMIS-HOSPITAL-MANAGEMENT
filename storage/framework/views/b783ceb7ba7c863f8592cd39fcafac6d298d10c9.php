...
<?php $__env->startSection('content'); ?>
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('save-radiology-test-details')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label for="test_name" class="form-label"> Test Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="test_name" name="test_name"
                                placeholder="Enter Test Name" value="<?php echo e(old('test_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="short_name" name="short_name"
                                placeholder="Enter Short Name" value="<?php echo e(old('short_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="test_type" name="test_type"
                                placeholder="Enter Test Type" value="<?php echo e(old('test_type')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="sub_catagory" name="sub_catagory"
                                placeholder="Enter Sub Catagory Name" value="<?php echo e(old('sub_catagory')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="method" name="method"
                                placeholder="Enter Sub Catagory Name" value="<?php echo e(old('method')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="report_days" name="report_days"
                                placeholder="Enter Report Days" value="<?php echo e(old('report_days')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="tax" value="<?php echo e(old('tax')); ?>"
    ...
    <script>
        function getParameter(i) {
            ...
            $.ajax({
                url: "<?php echo e(route('find-range-by-parameter-radiology')); ?>",
                type: "POST",
                data: {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/radiology/test-radiology/add-radiology-test.blade.php ENDPATH**/ ?>