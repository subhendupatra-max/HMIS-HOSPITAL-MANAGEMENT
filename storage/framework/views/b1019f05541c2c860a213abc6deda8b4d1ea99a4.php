                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="<?php echo e(route('add-vendor-quatation')); ?>" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="req_id" value="<?php echo e($requisition_details->req_no); ?>">
                                        <input type="file" <?php if(@$value['quatation_status']==1){ echo"disabled";} ?> name="vendor_quatation" required>
                                        <button class="btn btn-indigo btn-sm" <?php if(@$value['quatation_status']==1){ echo"disabled";} ?> type="submit"><i class="fa fa-file"></i> Save</button>
                                    </form>
                                ...
                                <td>
                                    <form method="POST" action="<?php echo e(route('vendor-select-for-po')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <textarea name="note" <?php if(@$value['quatation_status']==1){ echo"readonly";} ?> class="form-control"><?php echo e(@$value->comment); ?></textarea>
                                        <br>
                                        <select name="selection"
                                         <?php if(@$value['quatation_status']==1){ echo"disabled";} ?>
                                  ...
                                  <!--       <select name="item_quataion" required class="select2-show-search" class="form-control">
                                        ...
                                        <input type="hidden" name="req_no" value="<?php echo e($requisition_details->req_no); ?>">
                                        <button type="submit" <?php if(@$value['quatation_status']==1){ echo"disabled";} ?> class="btn btn-success btn-sm"><i class="fa fa-check"></i> Select</button>
                                        <br>
                                    </form>
                                </td>
                    <!--             <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('give-approval-vendor')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-12">
                        <select name="permission" class="form-control" required <?php if(@$permisison_status_own_vendor->status=='Approved' || @$permisison_status_own_vendor->status=='Rejected'){ echo"disabled";} ?> >
                            <option value="" disabled>Select One</option>
                            <option value="Pending" disabled <?php if(@$permisison_status_own_vendor->status=='Pending'){ echo"selected";} ?> >Pending</option>
                            <option value="Approved" <?php if(@$permisison_status_own_vendor->status=='Approved'){ echo"selected";} ?>>Approved</option>
                            <option value="Need Clarification" <?php if(@$permisison_status_own_vendor->status=='Need Clarification'){ echo"selected";} ?>>Need Clarification</option>
                            <option value="Rejected" <?php if(@$permisison_status_own_vendor->status=='Rejected'){ echo"selected";} ?>>Rejected</option>
                        </select>
                        <input type="hidden" name="requisition_id" value="<?php echo e($requisition_details->req_no); ?>">
                    </div>
                    <div class="col-md-12">
                        Comment:
                        <textarea name="comment" <?php if(@$permisison_status_own_vendor->status=='Approved' || @$permisison_status_own_vendor->status=='Rejected'){ echo"readonly";} ?>  class="form-control"><?php echo e(@$permisison_status_own_vendor->comment); ?></textarea>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-indigo" <?php if(@$permisison_status_own_vendor->status=='Approved' || @$permisison_status_own_vendor->status=='Rejected'){ echo"disabled";} ?> type="submit"><i class="fa fa-file"></i> Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-8 col-xl-8 col-md-8 col-sm-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?php echo e(url('print-req')); ?>/<?php echo e($requisition_details->req_no); ?>" class="btn btn-primary allbtndemo" ><i class="fa fa-print"> Print</i></a>
                    <?php endif; ?>
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                                <span class="requisition_header">Workshop : </span><span class="requisition_text"><?php echo e(@$requisition_details->workshop_name); ?></span>
                            </div>
                            <div class="col-md-4">
                                <span class="requisition_header">Requisition No : </span><span class="requisition_text"><?php echo e(@$requisition_details->requisition_prefix); ?><?php echo e(@$requisition_details->req_no); ?>
                            ...
                            <div class="col-md-6">
                                <span class="requisition_header">Selected Vendor Details : </span><br><span class="requisition_text"><?php echo e($value->vendor_name); ?>,<?php echo e($value->vendor_address); ?>,<?php echo e($value->vendor_gst); ?></span><br>
                    ...
                    <div class="latest-timeline scrollbar3" id="scrollbar3">
                        <ul class="timeline mb-0">
                            ...
                            <li class="mt-0">
                                ...
                                <p class="text-muted fs-12">
                                    <span class="text-info">
                                        <?php if($user->user_id == Auth::id() && ( $user->permission_type_user == 'Parallal' || @$show_for_permission_vendor->user_id == Auth::id())): ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form method="POST" action="<?php echo e(route('given-approval')); ?>">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <select name="permission" <?php if(@$permisison_status_own->status=='Approved' || @$permisison_status_own->status=='Rejected'){ echo"disabled";} ?>  class="form-control" required>
                            <option value="" disabled>Select One</option>
                    ...
                    <div class="col-md-12">
                        Comment:
                        <textarea name="comment" <?php if(@$permisison_status_own->status=='Approved' || @$permisison_status_own->status=='Rejected'){ echo"readonly";} ?> class="form-control"><?php echo e(@$permisison_status_own->comment); ?></textarea>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-indigo" type="submit" <?php if(@$permisison_status_own->status=='Approved' || @$permisison_status_own->status=='Rejected'){ echo"disabled";} ?>><i class="fa fa-file"></i> Save</button>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/item/requisition/requisition-details.blade.php ENDPATH**/ ?>