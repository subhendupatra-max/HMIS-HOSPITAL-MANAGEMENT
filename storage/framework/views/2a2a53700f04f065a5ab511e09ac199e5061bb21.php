...
<a class="dropdown-item <?php echo e(Request::segment(2) == 'opd-blood-issue' ? 'active' : ''); ?>" href="<?php echo e(route('blood-bank-detials-in-opd', ['id' => base64_encode($opd_patient_details->id)])); ?>"><i class="fa-solid fa-droplet"></i>Blood Details</a><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/OPD/include/menu.blade.php ENDPATH**/ ?>