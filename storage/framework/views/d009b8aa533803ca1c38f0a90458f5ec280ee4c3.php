            ...
            <form method="POST" action="<?php echo e(route('save-finding')); ?>">
                ...
                <div class="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="finding_name" name="finding_name" placeholder="Enter Finding Name" value="<?php echo e(old('finding_name')); ?>" required>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DITS-HMIS\resources\views/setup/finding/finding/add.blade.php ENDPATH**/ ?>