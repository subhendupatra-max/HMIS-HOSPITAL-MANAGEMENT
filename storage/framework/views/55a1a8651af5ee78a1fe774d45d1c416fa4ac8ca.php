                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('deleteBrand',$item->id)); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure?')" data-toggle="tooltip-primary" data-placement="top" title="Remove Brand"><i class="fa fa-trash"></i></a>
                            </td>
                            <?php endif; ?>
                            </tr>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\ameInventory\resources\views/appPages/master/brand/brand-list.blade.php ENDPATH**/ ?>