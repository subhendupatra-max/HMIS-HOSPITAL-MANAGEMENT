                        ...
                        <div class="options px-5 pt-1  border-bottom pb-3">
                            <div class="row">
                                <div class="form-group col-md-6 adcharge ">
                                    ...
                                    <input type="datetime-local" name="date" value="<?php echo e(date('Y-m-d h:m:s',strtotime($test_details->date))); ?>"
                                        required />
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/pathology/patient-test/patient-test-edit.blade.php ENDPATH**/ ?>