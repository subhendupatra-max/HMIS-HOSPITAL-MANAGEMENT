...
<a class="dropdown-item <?php echo e(Request::segment(2) == 'opd-profile' ? 'active' : ''); ?>" href=""><i class="fa fa-dna"></i> Oxygen Monitoring</a>
<a class="dropdown-item <?php echo e(Request::segment(2) == 'opd-profile' ? 'active' : ''); ?>" href=""><i class="fa fa-tablets"></i> Medication</a>
...
<a class="dropdown-item <?php echo e(Request::segment(2) == 'opd-profile' ? 'active' : ''); ?>" href=""><i class="fa fa-bed"></i> Bed History</a>
...
<?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/ipd/include/menu.blade.php ENDPATH**/ ?>