<div class="scrollable">
    ...
    <a class="dropdown-item <?php echo e(Request::segment(2) == 'ipd-blood-details' ? 'active' : ''); ?>" href="<?php echo e(route('prescription-lisitng-in-ipd', ['id' => base64_encode($ipd_details->id)])); ?>"><i class="fa fa-prescription"></i> Prescription</a>
 


</div><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/ipd/include/menu.blade.php ENDPATH**/ ?>