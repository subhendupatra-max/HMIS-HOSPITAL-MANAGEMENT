...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-symptoms-head-details')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="symptoms_type" class="form-control" name="symptoms_type">
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $editSymptomsHead->symptoms_type ? 'selected' : " "); ?>><?php echo e($item->symptoms_type_name); ?></option>
