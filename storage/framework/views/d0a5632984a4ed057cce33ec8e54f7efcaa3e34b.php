...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label for="reference_range" class="form-label">Reference Range <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="reference_range" name="reference_range" placeholder="Enter Reference Range" value="<?php echo e($editParameter->reference_range); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label for="unit_id" class="form-label">Unit Name <span class="text-danger">*</span></label>
                        <select name="unit_id" class="form-control select2-show-search" id="unit_id">
                            ...
                            <option value="<?php echo e($items->id); ?>" <?php echo e($items->id == $editParameter->unit_id ? 'selected' : " "); ?>><?php echo e($items->unit_name); ?></option>
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item->unitName->unit_name); ?></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/setup/pathology/parameter/edit-parameter.blade.php ENDPATH**/ ?>