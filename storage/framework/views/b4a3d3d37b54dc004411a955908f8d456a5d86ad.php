                                ...
                                <td>
                                    ...
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" style="">
                                            <a class="dropdown-item" href="<?php echo e(route('view-new-patient',  $all_patients->id)); ?>"><i class="fa fa-eye"></i> View</a>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit patient')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('edit-patient-details',['id'=>$all_patients->id])); ?>"><i class="fa fa-edit"></i>Edit</a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\hospital_software\resources\views/setup/patient/patient_list.blade.php ENDPATH**/ ?>