                        ...
                        <div class="container-fluid">
                            <div class="d-flex">
                                ...
                                <div class="d-flex order-lg-2 ml-auto">
                                    ...
                                    <?php endif; ?>
                                    <div class="dropdown   header-fullscreen">
                                        <a class="nav-link icon full-screen-link p-0" href="<?php echo e(route('create-requisition')); ?>" id="fullscreen-button" data-placement="bottom" data-toggle="tooltip" title="Add Item">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="header-icon" width="24" height="24" viewBox="0 0 24 24">
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2022 <a href="index-2.html#">Admintro</a>. Designed by <a href="index-2.html#">Devant IT Solutions Pvt. Ltd.</a> All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
...
</html><?php /**PATH C:\ame_inventory\resources\views/layouts/layout.blade.php ENDPATH**/ ?>