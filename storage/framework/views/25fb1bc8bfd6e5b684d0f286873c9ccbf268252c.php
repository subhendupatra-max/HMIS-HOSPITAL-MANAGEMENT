...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control" id="complaiints_duraiton" name="complaiints_duraiton" value="<?php echo e(@$patient_discharge_details->complaiints_duraiton); ?> "></textarea>
                    </div>

                    <div class="form-group col-md-4">
                        <label for="presenting_illness" class="form-label">Summary of Presenting Illness</label>
                        <textarea class="form-control" id="presenting_illness" name="presenting_illness" value="<?php echo e(@$patient_discharge_details->presenting_illness); ?> "></textarea>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control" id="physical_examinaiton_at_admission" name="physical_examinaiton_at_admission" value="<?php echo e(@$patient_discharge_details->physical_examinaiton_at_admission); ?> "></textarea>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="history_alcoholism" class="form-label"> History of alcoholism, tobacco or substance abuse, if nay</label>
                        <textarea class="form-control" id="history_alcoholism" name="history_alcoholism" value="<?php echo e(@$patient_discharge_details->history_alcoholism); ?> "></textarea>
                    </div>

                    <div class="form-group col-md-4">
                        <label for="medical_surgical_history" class="form-label"> Significant Past Medical and Surgical History, if any</label>
                        <textarea class="form-control" id="medical_surgical_history" name="medical_surgical_history" value="<?php echo e(@$patient_discharge_details->medical_surgical_history); ?> "></textarea>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control" id="family_history_diagnosis" name="family_history_diagnosis" value="<?php echo e(@$patient_discharge_details->family_history_diagnosis); ?> "></textarea>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control" id="summary_inves_during_hos" name="summary_inves_during_hos" value="<?php echo e(@$patient_discharge_details->summary_inves_during_hos); ?> "></textarea>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="discharge_status" class="form-control" id="discharge_status" required onchange="hide(this.value)">
                            ...
                            <option value="<?php echo e($dischargeType); ?>" <?php echo e($dischargeType == @$patient_discharge_details->discharge_status); ?>> <?php echo e($dischargeType); ?>
