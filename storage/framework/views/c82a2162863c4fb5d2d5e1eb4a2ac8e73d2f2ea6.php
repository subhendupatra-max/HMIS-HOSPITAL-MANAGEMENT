                        ...
                        <div class="d-block">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add patient')): ?>
                                <a href="<?php echo e(route('add_new_patient')); ?>" class="btn btn-primary btn-sm"><i
                                        class="fa fa-user"></i> Add New Patient </a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($all_patients->prefix); ?> <?php echo e($all_patients->first_name); ?>
                                            ...
                                            <?php echo e($all_patients->middle_name); ?> <?php echo e($all_patients->last_name); ?></td>
                                            ...
                                            <div class="card-options">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('view-new-patient', base64_encode($all_patients->id))); ?>"><i class="fa fa-eye"></i> View</a>
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('opd-registation', base64_encode($all_patients->id))); ?>"><i
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DITS-HMIS\resources\views/setup/patient/patient_list.blade.php ENDPATH**/ ?>