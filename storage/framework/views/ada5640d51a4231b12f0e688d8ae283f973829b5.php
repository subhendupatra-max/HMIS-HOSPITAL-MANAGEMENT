                    ...
                    <tbody>
                        <?php if($discountList[0]->section): ?>
                            <?php $__currentLoopData = $discountList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <a href="<?php echo e(route('view-discount-details',['discount_id'=>base64_encode($value->id)])); ?>"> <span
                                        style="color:blue"><?php echo e($value->patient_details->prefix . ' ' . $value->patient_details->first_name . ' ' . $value->patient_details->middle_name . ' ' . $value->patient_details->last_name); ?><br><?php echo e($value->patient_details->patient_prefix . ' ' . $value->patient_details->id); ?></span></a>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HMIS-HOSPITAL-MANAGEMENT\resources\views/discount/discount_list.blade.php ENDPATH**/ ?>