...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Issue Item</h4>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('edit_issue_form_action', $issue_form->id)); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="issue_by" class="form-control">
                                    ...
                                    <option value="<?php echo e($list->id); ?>" <?php echo e($list->id == $issue_form->issue_by ? 'selected' : ''); ?>><?php echo e($list->name); ?></option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="issue_date" value="<?php echo e($issue_form->issue_date); ?>" class="form-control">
            ...
            <div class="">
                <div class="table-responsive">
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $issue_form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ame_inventory\resources\views/appPages/item/tools-management/edit-issue-form.blade.php ENDPATH**/ ?>