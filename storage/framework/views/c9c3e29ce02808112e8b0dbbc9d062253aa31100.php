            ...
            <form method="POST"  action="<?php echo e(route('vendorEditAction')); ?>">
                ...
                <div class="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo e($data->vendor_name); ?>" placeholder="Enter Vendor Name" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg">
                            ...
                            <input class="form-control mb-4" placeholder="Enter Vendor Mobile No"  id="pnno" name="pnno" type="text" value="<?php echo e($data->vendor_ph_no); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row row-sm">
                        <div class="col-lg">
                            ...
                            <input class="form-control mb-4" placeholder="Input box" id="gst" name="gst" value="<?php echo e($data->vendor_gst); ?>" type="text">
                            <?php $__errorArgs = ['gst'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row row-sm">
                        <div class="col-lg">
                            ...
                            <textarea class="form-control mb-4" placeholder="Enter Vendor Address" id="address"  name="address"  rows="3"><?php echo e($data->vendor_address); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\ameInventory\resources\views/appPages/master/vendor/vendorEdit.blade.php ENDPATH**/ ?>