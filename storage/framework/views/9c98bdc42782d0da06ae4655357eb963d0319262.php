            ...
            <aside class="app-sidebar">
                <div class="app-sidebar__logo">
                    <a class="header-brand" href="index.html">
                        <img src="<?php echo e(asset('assets/images/brand/logo.png')); ?>" style="width: 241px;  height: 48px;" class="header-brand-img desktop-lgo"
                            alt="A.M Enterprise">
                ...
                <ul class="side-menu app-sidebar3">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="index.html">
                            ...
                            <!--<span class="badge badge-danger side-badge">Hot</span>--> </a>
                    </li>
                    <li class="slide">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu ">
                            ...
                            <li> <a href="<?php echo e(route('master_item_page')); ?>" class="slide-item"> Item</a></li>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view item categories')): ?>
                            <li><a href="<?php echo e(route('itemCategoryView')); ?>" class="slide-item"> Item Category</a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view item unit')): ?>
                            <li><a href="<?php echo e(route('unitAdd')); ?>" class="slide-item"> Item Unit</a></li>
                            <?php endif; ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
							<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"></path></svg>
                            <span class="side-menu__label"> System Settings </span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu ">

                            <li> <a href="#" class="slide-item">Item</a></li>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view item categories')): ?>
...
<?php /**PATH E:\xampp\ame_14_10_2022\ame_inventory\resources\views/layouts/layout.blade.php ENDPATH**/ ?>