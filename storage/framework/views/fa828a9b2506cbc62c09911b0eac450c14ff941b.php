        ...
        <div class="card-body">
            <div class="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="<?php echo e(route('save_item_issue')); ?>" method="post">
                                <?php echo csrf_field(); ?>

                                <input type="hidden" required name="job_id" value="<?php echo e($job_details->id); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/job/issue-item.blade.php ENDPATH**/ ?>