    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Edit Requisition</div>
              <div class="ggdtretew">
            <a href="<?php echo e(route('master_item_page')); ?>" class="btn btn-primary" data-placement="left" data-toggle="tooltip" title="Add New Item"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    ...
    <div class="card-body">
        <div class="col-md-12">
            ...
            <div class="col-md-4">
               ...
               <select class="form-control select2-show-search" name="workshop">
                   ...
                   <?php if($workshop_list): ?>
                     ...
                     <option value="<?php echo e($value->id); ?>" <?php if($requisition_details->workshop_id == $value->id){ echo "selected"; } ?> ><?php echo e($value->name); ?></option>
            ...
            <div class="col-md-4">
                 ...
                 <input type="datetime-local" value="<?php echo e($requisition_details->date); ?>" name="requisition_date" class="form-control">
            </div>
            <div class="col-md-4">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col"  style="width: 2%">
                            <button class="btn btn-success" type="button"  onclick="addnewrow()"><i class="fa fa-plus"></i></button>
                        </th>
                    </tr>
                </thead>
                <tbody>
...
<script type="text/javascript">
    ...
    function item(requisition_details_id = null)
    {
         $.ajax({
                url: "<?php echo e(url('/get-requisition-item')); ?>/"+ requisition_details_id,
                data: {
...
<?php if(!empty($requisition_item)): ?>
    <?php $__currentLoopData = $requisition_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <script type="text/javascript">
              item(<?php echo $res->requisition_details_id; ?>);
         </script>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ame_inventory\resources\views/appPages/item/requisition/edit-requisition.blade.php ENDPATH**/ ?>