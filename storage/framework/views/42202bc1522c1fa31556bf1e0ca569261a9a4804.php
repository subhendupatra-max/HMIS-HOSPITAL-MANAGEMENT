                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" value="<?php echo e(old('vehicle_model')); ?>" class="form-control" id="vehicle_model" name="vehicle_model" placeholder="Enter Vehicle Model">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" value="<?php echo e(old('engine_no')); ?>" class="form-control" id="engine_no" name="engine_no" placeholder="Enter Engine No">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" value="<?php echo e(old('date_of_manufacture')); ?>" id="date_of_manufacture" name="date_of_manufacture" placeholder="Enter Date of Manufacture">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo e(old('registration_no')); ?>" id="registration_no" name="registration_no" placeholder="Enter Registration No">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo e(old('chasis_no')); ?>" id="chasis_no" name="chasis_no" placeholder="Enter Chasis No">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" value="<?php echo e(old('purchase_date')); ?>" id="purchase_date" name="purchase_date" placeholder="Enter Purchase Date">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" value="<?php echo e(old('insurance_date')); ?>" id="insurance_date" name="insurance_date" placeholder="Enter Insurance Date">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group"> 
                                        <input type="date" class="form-control" value="<?php echo e(old('pollution_under_control')); ?>" id="pollution_under_control" name="pollution_under_control">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo e(old('depreciation_rate')); ?>" id="depreciation_rate" name="depreciation_rate" placeholder="Enter Depreciation Rate">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo e(old('depreciation_value')); ?>" id="depreciation_value" name="depreciation_value" placeholder="Depreciation Value">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo e(old('engine_cc')); ?>" id="engine_cc" name="engine_cc" placeholder="Engine CC">
                                    </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/vehicle/add-vehicle-reg.blade.php ENDPATH**/ ?>