        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <div class="d-block">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('emg prescription')): ?>
                        <a href="<?php echo e(route('add-prescription-in-emg',['id'=> base64_encode($emg_id)])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-report"></i> Add Prescription </a>
                        <?php endif; ?>
            ...
            <div class="">
                <div class="table-responsive">
                    <table id="example" class="table table-bordered text-nowrap key-buttons">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $emgPrescription; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="<?php echo e(route('edit-prescription-in-emg',['id'=> base64_encode($item->id),'emg_id'=> base64_encode($emg_patient_details->id)])); ?>"><i class="fa fa-edit"></i> Edit</a>
                                            <?php endif; ?>
                    ...
                    <?php echo $emgPrescription->links(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/emg/prescription/prescription-listing.blade.php ENDPATH**/ ?>