            ...
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <div class="d-block">
                        ...
                        <a href="<?php echo e(route('add-physical-condition-in-opd',['id'=> base64_encode($opd_id)])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-user"></i> Add Physical Condition </a>
                        <?php endif; ?>
                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="<?php echo e(route('edit-physical-condition-in-opd',['id'=> base64_encode($item->id),'opd_id'=> base64_encode($opd_patient_details->id)])); ?>"><i class="fa fa-edit"></i> Edit</a>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete physical condition')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('delete-physical-condition-in-opd',['id'=> base64_encode($item->id)])); ?>"><i class="fa fa-trash"></i> Delete</a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/OPD/physical-condition/physical-condition-listing.blade.php ENDPATH**/ ?>