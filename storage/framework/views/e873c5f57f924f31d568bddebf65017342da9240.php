...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-10">
                    <span class="head_name">Test Name</span> : <span class="value_name"><?php echo e(@$pathologyTest->test_name); ?></span>
                </div>
                <div class="col-md-2">
                    <div class="row">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit pathology test')): ?>
                        <a class="btn btn-primary btn-sm mb-2" href="<?php echo e(route('edit-pathology-test-details',['id'=> base64_encode($emg_id)])); ?>"><i class="fa fa-edit"></i> Edit</a>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete pathology test')): ?>
                        <a class="btn btn-primary btn-sm ml-2 mb-2" href="<?php echo e(route('delete-pathology-test-details',['id'=> base64_encode($emg_id)])); ?>"><i class="fa fa-trash"></i> Delete</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <span class="head_name">Date</span> : <span class="value_name"><?php echo e(@$emgPrescription->prescription_date); ?></span>
                </div>

                <div class="col-md-4">
                    <span class="head_name">Note</span> : <span class="value_name"><?php echo e(@$emgPrescription->note); ?></span>
                </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/emg/prescription/prescription-view.blade.php ENDPATH**/ ?>