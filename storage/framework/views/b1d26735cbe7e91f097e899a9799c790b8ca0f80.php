            ...
            <table>
                <tr>
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>UHID No: <?php echo e(@$ipd_patient_details->all_patient_details->patient_prefix); ?><?php echo e(@$ipd_patient_details->all_patient_details->id); ?></b>
                    </td>
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;width:270px;">
                        ...
                        <img src="data:image/png;base64,<?php echo e(base64_encode($generatorPNG->getBarcode('@$ipd_patient_details-all_patient_details->>patient_prefix @$ipd_patient_details->all_patient_details->patient_id', $generatorPNG::TYPE_CODE_128))); ?>" style="width: 170px;height: 50px;">
                    </td>
                    <td rowspan="2" style="text-align: center;border: 1px solid #899499;width:260px;">
                        ...
                        ?>
                        <!-- <img src="<?php echo e(asset('public/hospital_details/qr.png')); ?>" style="width: 80px;"> -->
                        <span style="width: 60px;height:60px"><?php echo QrCode::size(55)->generate($ipd_de); ?> </span>
                    </td>
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>Appointment Date: <?php echo e(@$ipd_patient_details->appointment_date); ?></b>
                    </td>
                ...
                <tr>
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b> IPD no. <?php echo e(@$ipd_patient_details->ipd_prefix); ?><?php echo e(@$ipd_patient_details->id); ?> </b></td>
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #899499;"><b>Patient Source:<?php echo e(@$ipd_patient_details->patient_source); ?> Source ID: <?php echo e(@$ipd_patient_details->patient_source_id); ?></b></td>
            ...
            <table style="width: 100%; margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->all_patient_details->first_name); ?> <?php echo e(@$ipd_patient_details->all_patient_details->middle_name); ?>

                        <?php echo e(@$ipd_patient_details->all_patient_details->last_name); ?>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->all_patient_details->gurdaian_name); ?>
                    ...
                    <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->all_patient_details->phone); ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->all_patient_details->year); ?>Y <?php echo e(@$ipd_patient_details->all_patient_details->month); ?>M <?php echo e(@$ipd_patient_details->all_patient_details->day); ?>D
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Gender
                    </th>
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->all_patient_details->gender); ?>
                    ...
                    <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->patient_type); ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->doctor_details->first_name); ?> <?php echo e(@$ipd_patient_details->doctor_details->last_name); ?>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->ward_details->ward_name); ?>
                    ...
                    <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->unit_details->bedUnit_name); ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->department_details->department_name); ?>
                    ...
                    <td colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->bed_details->bed_name); ?>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td colspan="7" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->all_patient_details->address); ?>,<?php echo e(@$ipd_patient_details->all_patient_details->_state->name); ?>,
                        <?php echo e(@$ipd_patient_details->all_patient_details->_district->name); ?>,
                        <?php echo e(@$ipd_patient_details->all_patient_details->pin_no); ?>

                    </td>

                </tr>
                <?php if(@$ipd_patient_details->patient_type == 'Swasthya Sathi' || @$ipd_patient_details->patient_type == 'TPA' ): ?>
                <tr>
                    <th colspan="3" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php if(@$ipd_patient_details->patient_type == 'Swasthya Sathi'): ?>
                        Swasthya Sathi No.
                        <?php elseif(@$ipd_patient_details->patient_type == 'TPA'): ?>
                        TPA <?php echo e(@$ipd_patient_details->tpa_details->TPA_name); ?>

                        <?php endif; ?>
                    </th>
                    <td colspan="7" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$ipd_patient_details->tpa_details->type_no); ?>
...
border-bottom: 1px solid black;">
                <tr>
                    ...
                    <td style="text-align: left;font-size: 13px;">
                        <?php echo e(@$ipdPaymentDetails->payment_date); ?>
                    ...
                    <td style="text-align: right;font-size: 13px; padding: 0px 10px 0px 0px;">
                        <?php echo e(@$ipdPaymentDetails->payment_amount); ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 13px;">
                        <?php echo e(@$ipdPaymentDetails->generated_by->first_name); ?> <?php echo e(@$ipdPaymentDetails->generated_by->last_name); ?>
                    ...
                    <td style="text-align: right;font-size: 13px; padding: 0px 10px 0px 0px;">
                        <?php echo e(@$ipdPaymentDetails->payment_mode); ?>
                ...
                <!-- <tr>
                    ...
                    <td style="text-align: right;font-size: 13px; padding: 0px 10px 0px 0px;">
                        <?php echo e(@$ipdPaymentDetails->payment_recived_by); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Ipd/payment/print-payment.blade.php ENDPATH**/ ?>