            ...
            <?php $__currentLoopData = $requisition_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requisition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="text-align: left; font-size: 13px;">
                    ...
                    <td style="width: 70px;padding: 7px 0px 7px 10px;text-align: left;vertical-align:top;border-bottom: 2px solid #010c45;border-right: 2px solid #010c45;">
                        <?php echo e(@$requisition->item_name); ?>(Brand : <?php echo e(@$requisition->brand_name); ?>)(Manufacturer : <?php echo e(@$requisition->manufacturar_name); ?>)<br>(<?php echo e(@$requisition->item_description); ?>)
                    </td>
               ...
               <tr>
                    <td style="padding: 5px 5px 5px 10px;font-size: 13px;text-align:left;border-left: 2px solid #010c45; border-bottom: 2px solid #010c45;">
                     ...
                     <td style="padding: 5px 5px 5px 10px;font-size: 13px;text-align:left;align:left;border-bottom: 2px solid #010c45;">
                        <?php echo e(@$requisition_details->issue_by_name); ?>
...
<!-- =================================================================================== -->
<?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/item/requisition/print/_printReq.blade.php ENDPATH**/ ?>