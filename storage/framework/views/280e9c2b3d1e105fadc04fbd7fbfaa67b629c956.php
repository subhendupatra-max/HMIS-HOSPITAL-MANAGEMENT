                                        ...
                                        <div>
                                            <div class="btn-list">
                                                <div class="dropdown">
                                                    ...
                                                    <!--     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Assign Tools Edit')): ?>
                                                        <a class="dropdown-item" href="<?php echo e(route('edit_issue_form_action', $item->id)); ?>"><i class="fa fa-pencil"></i> Edit</a>
                                                        <?php endif; ?> -->
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Assign Tools Delete')): ?>
                                                        <a class="dropdown-item" href="<?php echo e(route('assign-tools-delete', $item->id)); ?>"><i class="fa fa-trash"></i> Delete</a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/item/tools-management/assign-tools-list.blade.php ENDPATH**/ ?>