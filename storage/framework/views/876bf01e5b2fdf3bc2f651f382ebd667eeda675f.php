...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="re_order_level" name="re_order_level" value="<?php echo e($editMedicine->re_order_level); ?>" placeholder="Enter Min Level">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-8">
                        <table class="table card-table table-vcenter text-nowrap" id="baseUnit">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $editBaseUnit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="tabletrid<?php echo $key ?>">
                                    <td>
                                        <select id="medicine_base_unit" class="form-control select2-show-search" name="medicine_base_unit[]">
                                            ...
                                            <option value="<?php echo e($item->id); ?>" <?php echo e(@$item->id == @$value->medicine_base_unit ? 'selected' : " "); ?>><?php echo e($item->medicine_unit_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <select id="medicine_unit" class="form-control select2-show-search" name="medicine_unit[]">
                                            <option value="">Select Base Unit</option>
                                            <?php $__currentLoopData = $baseUnit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>" <?php echo e(@$item->id == @$value->medicine_unit ? 'selected' : " "); ?>><?php echo e($item->medicine_unit_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>

                                    <td>
                                        <input type="text" class="form-control" name="value[]" value="<?php echo e($value->value); ?>" id="value" />
                                    </td>

                                    <td>
                                        <button type="button" class="btn btn-danger" onclick="removeBaseUnitrow('<?php echo e($key); ?>')"><i class="fa fa-times"></i></button>
                                    </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/pharmacy/medicine/edit-medicine.blade.php ENDPATH**/ ?>