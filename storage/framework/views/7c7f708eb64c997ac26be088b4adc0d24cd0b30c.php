            ...
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <div class="d-block">
                        ...
                        <a href="<?php echo e(route('add-medicaiton-dose',['ipd_id' => base64_encode($ipd_details->id)])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-pills"></i> Add Medication</a>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/Ipd/show-medication-dose.blade.php ENDPATH**/ ?>