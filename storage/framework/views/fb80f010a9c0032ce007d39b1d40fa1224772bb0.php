...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">ABDM HF ID<span class="text-danger"></span></label>
                            <input type="text" required class="form-control" value="<?php echo e($general_details->abdm_hf_id); ?>"  name="abdm_hf_id" placeholder="ABDM-HF-ID">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">HMIS HF ID<span class="text-danger"></span></label>
                            <input type="text" required class="form-control" value="<?php echo e($general_details->hmis_hf_id); ?>"  name="hmis_hf_id" placeholder="HMIS-HF-ID">
                            <?php $__errorArgs = ['hmis_hf_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ame\ameInventory1\resources\views/general_setting/general-setting.blade.php ENDPATH**/ ?>