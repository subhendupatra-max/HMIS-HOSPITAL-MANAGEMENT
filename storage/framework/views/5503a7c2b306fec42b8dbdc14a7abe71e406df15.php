    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" enctype="multipart/form-data" method="POST"
                action="<?php echo e(route('UserCreateAction')); ?>">
                <?php echo csrf_field(); ?>
                <div class="col-md-12">
                    <div class="row">
                        <!-- //password  -->
                            ...
                            <div class="main-profile-bio mb-0">
                                <div class="row">
                                    <div class="col-md-2 useraddd">
                                        ...
                                        <input type="text" id="employee_id" value="<?php echo e(old('employee_id')); ?>"
                                            name="employee_id">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-2 useradddone">
                                        ...
                                        <select class="form-control select2-show-search " value="<?php echo e(old('role')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-2 useradddone">
                                        ...
                                        <select class="form-control select2-show-search" name="designation"
                                            ...
                                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->designation_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 useraddd">
                                        <input type="text" id="specialist" value="<?php echo e(old('specialist')); ?>"
                                            name="specialist">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-2 useradddtwoo">
                                        ...
                                        <input type="number" name="phone_no" id="phone_no" value="<?php echo e(old('phone_no')); ?>"
                                            required="">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3  newuserlisttchangee">
                                        ...
                                        <input type="number" name="whatsapp_no" id="whatsapp_no"
                                            value="<?php echo e(old('whatsapp_no')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 newuserlisttchangee ">
                                        ...
                                        <input type="number" name="emg_phone_no" id="emg_phone_no"
                                            value="<?php echo e(old('emg_phone_no')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 newuserchange  ">
                                        <input type="text" name="identification_name" id="identification_name"
                                            value="<?php echo e(old('identification_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 newuserchange ">
                                        ...
                                        <input type="text" name="identification_number" id="identification_number"
                                            value="<?php echo e(old('local_identification_number')); ?>">
                    ...
                    <div class="row border-top">
                        <div class="card-body hospital_allcardbodydesign">
                            ...
                            <div class="main-profile-bio mb-0">
                                <div class="row">
                                    <div class="col-md-3 useraddd">
                                        <input type="text" id="bank_account_no" value="<?php echo e(old('bank_account_no')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 useraddd">
                                        <input type="text" id="bank_name" value="<?php echo e(old('bank_name')); ?>"
                                            name="bank_name">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 useraddd">
                                        <input type="text" id="ifsc_code" value="<?php echo e(old('ifsc_code')); ?>"
                                            name="ifsc_code">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 useraddd">
                                        <input type="text" id="bank_branch_name" value="<?php echo e(old('bank_branch_name')); ?>"
                    ...
                    <div class="row border-top">
                        <div class="card-body hospital_allcardbodydesign">
                            ...
                            <div class="main-profile-bio mb-0">
                                <div class="row">
                                    <div class="col-md-3 useraddd">
                                        <input type="text" id="epf_no" value="<?php echo e(old('epf_no')); ?>"
                                            name="epf_no">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 useraddd">
                                        <input type="text" id="basic_salary" value="<?php echo e(old('basic_salary')); ?>"
                                            name="basic_salary">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3 useraddd">
                                        ...
                                        value="<?php echo e(old('contract_type')); ?>">
                                            ...
                                            <option value="<?php echo e($contract_types); ?>"> <?php echo e($contract_types); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                    ...
                    <div class="row border-top">
                        <div class="card-body hospital_allcardbodydesign">
                            ...
                            <div class="main-profile-bio mb-0">
                                <div class="row">
                                    <div class="col-md-2 useraddd">
                                        <input type="text" id="casual_leave" value="<?php echo e(old('casual_leave')); ?>"
                                            name="casual_leave">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-2 useraddd">
                                        <input type="text" id="privilege_leave" value="<?php echo e(old('privilege_leave')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-2 useraddd">
                                        <input type="text" id="sick_leave" value="<?php echo e(old('sick_leave')); ?>"
                                            name="sick_leave">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-2 useraddd">
                                        <input type="text" id="maternity_leave" value="<?php echo e(old('maternity_leave')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-2 useraddd">
                                        <input type="text" id="paternity_leave" value="<?php echo e(old('paternity_leave')); ?>"
