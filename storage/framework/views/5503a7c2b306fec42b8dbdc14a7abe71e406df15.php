...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2-show-search select2-hidden-accessible"
                                    value="<?php echo e(old('role')); ?>" tabindex="-1" aria-hidden="true" name="role"
                                    id="role">
                                    <optgroup>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 newuserlistchange">
                                <input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" id="first_name"
                                    required="">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 newuserlistchange">
                                <input type="text" name="last_name"value="<?php echo e(old('last_name')); ?>"id="last_name"
                                    required="">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3  newuserlisttchange">
                                ...
                                <input type="number" name="whatsapp_no" id="whatsapp_no"
                                    value="<?php echo e(old('whatsapp_no')); ?>" required="">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 newuserchange  ">
                                ...
                                <input type="text" name="identification_number" id="identification_number"
                                    value="<?php echo e(old('identification_number')); ?>" required="">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 newuserchange ">
                                ...
                                <input type="text" name="identification_number" id="identification_number"
                                    value="<?php echo e(old('local_identification_number')); ?>" required="">
                                <label for="identification_number">Identification Number</label>
