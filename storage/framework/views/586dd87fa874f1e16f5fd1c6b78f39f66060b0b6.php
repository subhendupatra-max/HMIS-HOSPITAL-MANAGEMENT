...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add radiology parameter')): ?>
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('save-radiology-parameter-details')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        <thead>
                            <tr>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit radiology parameter','delete radiology parameter')): ?>
                                <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit radiology parameter')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('edit-radiology-parameter-details',['id'=>$item->id])); ?>"><i class="fa fa-edit"></i> Edit</a>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete radiology parameter')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('delete-radiology-parameter-details',['id'=>$item->id])); ?>"><i class="fa fa-trash"></i> Delete</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/setup/radiology/parameter/parameter-listing.blade.php ENDPATH**/ ?>