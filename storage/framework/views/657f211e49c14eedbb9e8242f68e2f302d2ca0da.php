             ...
             <div class="row">
                 ...
                 <div class="col-md-8 text-right">
                     <div class="d-block">
                         ...
                         <a href="<?php echo e(route('blood-issue-listing')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-vials"></i> Blood Issue Details </a>
                         <?php endif; ?>
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('')): ?>
                         <a href="<?php echo e(route('listing-blood-components-details')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-mortar-pestle"></i> Components Issue </a>
                         <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Blood_Bank/blood-bank-listing.blade.php ENDPATH**/ ?>