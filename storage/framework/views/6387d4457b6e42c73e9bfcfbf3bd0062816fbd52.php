        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="<?php echo e(route('edit-opd-operation-in-opd',['id' => base64_encode($operation_booking_id)] )); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit Details</a>
                    <?php endif; ?>
