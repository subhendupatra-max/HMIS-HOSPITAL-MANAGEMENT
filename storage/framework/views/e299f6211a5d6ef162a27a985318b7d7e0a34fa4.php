...
<table style="width: 100%; border:1px soild black;border-collapse: collapse">
  ...
  <tr style="width:100%">
    <td style= "width:100%">
      <h1 style="text-align:center;font-size: 17px;margin: 5px 0px 0px 0px; color: #000;padding: 10px 0px 10px 0px;  width: 100%;">Radiology Test Report</h1>
   </td>
  </tr>
  <table style="width: 100%; margin: 0px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
    ...
    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
      ...
      <td colspan="3"  style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
        <?php echo e($radiology_patient_test_details->sample_collected_date != null ? date('d-m-Y',strtotime($radiology_patient_test_details->sample_collected_date)) : ''); ?>
    ...
    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
      ...
      <td colspan="3"style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
        <?php echo e($radiology_patient_test_details->report_date != null ? date('d-m-Y',strtotime($radiology_patient_test_details->report_date)) : ''); ?>
   ...
   <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
      ...
      <td colspan="5" style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
           <?php echo e($radiology_patient_test_details->generator_details->first_name); ?>  <?php echo e($radiology_patient_test_details->generator_details->last_name); ?>
...
<table style="width: 100%;">
  <td style= "width:100%">
    <h4 style="text-align:center;font-size: 13px;margin: 5px 0px 0px 0px; color: #000;padding: 10px 0px 10px 0px;  width: 100%;"><?php echo e(@$radiology_patient_test_details->test_details->test_name); ?><br>(<?php echo e(@$radiology_patient_test_details->test_details->short_name); ?>)</h4>
...
<table style="width: 100%;">
  <td style= "width:100%">
    <h5 style="text-align:center;font-size: 13px;margin: 5px 0px 0px 0px; color: #000;padding: 10px 0px 10px 0px;  width: 100%;">
      <?php echo @$radiology_patient_test_details->description; ?>

    </h5>
 </td>
</table>
<?php if(@$radiologyParameterResult[0]->parameter_name != null): ?>
...
<?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/radiology/printReport.blade.php ENDPATH**/ ?>