                        ...
                        <div class="mt-2">
                            ...
                            <div class="col-md-12 mt-3 mb-3">
                                <span class="requisition_header">Discount Status </span><span
                                    class="badge badge-success"><?php echo e($bill_details->discount_status); ?></span>
                            </div>
                            <?php if($bill_details->discount_status != 'Not applied'): ?>
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Requested Discount Amount  : </span><span
                                        style="color:red"> <?php echo e($discount_details->discount->asking_discount_amount); ?> <?php echo e($discount_details->discount->discount_type == 'flat' ? 'Rs' : '%'); ?></span>
                                </div>
                                <div class="col-md-12 mt-3 mb-3">
                            ...
                            <?php if($bill_details->discount_status == 'Approved'): ?>
                                ...
                                <div class="col-md-12 mt-3 mb-3">
                                    <span class="requisition_header">Appoved Discount By </span><span
                                        class="requisition_text"> : <?php echo e($discount_details->discount->given_by_details->first_name); ?> <?php echo e($discount_details->discount->given_by_details->last_name); ?> </span>
                                </div>
                            <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <span class="bilpo_name">Grand Total </span><span class="bilpo_value"> :
                                                <?php echo e(number_format((float) $bill_details->grand_total, 2, '.', '')); ?> Rs</span>
                                        </div>
