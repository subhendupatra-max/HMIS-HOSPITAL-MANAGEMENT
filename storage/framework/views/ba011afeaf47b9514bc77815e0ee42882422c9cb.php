    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="row">
                        ...
                        <a class="btn btn-primary btn-sm mb-2" href="<?php echo e(route('edit-pathology-test-details',['id'=> base64_encode($ipd_id)])); ?>"><i class="fa fa-edit"></i> Edit</a>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete pathology test')): ?>
                        <a class="btn btn-primary btn-sm ml-2 mb-2" href="<?php echo e(route('delete-pathology-test-details',['id'=> base64_encode($ipd_id)])); ?>"><i class="fa fa-trash"></i> Delete</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <span class="head_name">Date</span> : <span class="value_name"><?php echo e(@$ipdPrescription->prescription_date); ?></span>
                </div>

                <div class="col-md-4">
                    <span class="head_name">Note</span> : <span class="value_name"><?php echo e(@$ipdPrescription->note); ?></span>
                </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Ipd/prescription/prescription-view.blade.php ENDPATH**/ ?>