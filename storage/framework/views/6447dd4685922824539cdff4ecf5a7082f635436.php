...
unset($__errorArgs, $__bag); ?>
                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                        ...
                        <tbody id="subhendu">
                            <?php if($editDosage): ?>
                            <?php $__currentLoopData = $editDosage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr id="rowid0">
                                ...
                                <td>
                                    <select name="medicine_unit_id[]" class="form-control select2-show-search" id="medicine_unit_id">
                                        ...
                                        <option value="<?php echo e($items->id); ?>"  <?php echo e($items->id == $value->medicine_unit_id ? 'selected' : " "); ?>><?php echo $items->medicine_unit_name; ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </td>
                                <td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/setup/pharmacy/medicine-dosage/edit-medicine-dosage.blade.php ENDPATH**/ ?>