...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div>
                <a href="<?php echo e(route('addItem-form')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Item</a>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="data:image/png;base64,<?php echo e(base64_encode($generatorPNG->getBarcode($item->product_code, $generatorPNG::TYPE_CODE_128))); ?>">
                                    <br><span style="margin-left: 20px"><?php echo e(@$item->product_code); ?></span>
                                </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\ame_inventory\resources\views/appPages/master/item/item_list.blade.php ENDPATH**/ ?>