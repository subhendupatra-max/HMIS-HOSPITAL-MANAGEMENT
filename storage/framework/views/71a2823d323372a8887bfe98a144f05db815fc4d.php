...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Charges Sub Catagory</h4>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-charges-sub-catagory-details')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="charges_catagories_id" class="form-control" name="charges_catagories_id">
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php echo e(@$item->id == $editSubCatagory->charges_catagories_id ? 'selected' : " "); ?>><?php echo e($item->charges_catagories_name); ?></option>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/setup/charges-sub-catagory/edit-sub-catagory.blade.php ENDPATH**/ ?>