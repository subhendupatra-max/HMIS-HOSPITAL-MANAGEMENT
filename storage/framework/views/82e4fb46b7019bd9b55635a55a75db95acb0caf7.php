        ...
        <div class="row">
             <div class="col-lg-12 login_outerarea">
                 <video autoplay="" muted="" loop="" playsinline="" preload="none" class="basevideo">
                    <source src="<?php echo e(asset('public/assets/images/ame-video.mp4')); ?>" type="video/mp4">
                 </video>
                     ...
                     <div class="wrap-login100">
                        ...
                        <?php echo csrf_field(); ?>
                                <span class="login100-form-logo">
                                  <img src="<?php echo e(asset('public/assets/images/logo.png')); ?>" class="logoame">
                                </span>
...
</html><?php /**PATH C:\xampp\htdocs\hospital\ameInventory1\resources\views/auth/login.blade.php ENDPATH**/ ?>