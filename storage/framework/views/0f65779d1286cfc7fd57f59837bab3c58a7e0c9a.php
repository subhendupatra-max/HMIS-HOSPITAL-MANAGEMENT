        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="<?php echo e(route('edit-emg-operation-in-emg',['id' => base64_encode($operation_booking_id)] )); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit Details</a>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/emg/operation-emg/operation-details.blade.php ENDPATH**/ ?>