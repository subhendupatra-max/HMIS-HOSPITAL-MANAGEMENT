            ...
            <table>
                <tr>
                    ...
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        ...
                        <b>Date: <?php echo e(@$opd_patient_details->latest_opd_visit_details_for_patient->appointment_date); ?></b>
                    </td>
                    <td style="text-align: left; font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                        <b>Cons. Doctor: <?php echo e(@$opd_patient_details->doctor_details->first_name); ?> <?php echo e(@$opd_patient_details->doctor_details->last_name); ?></b>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;"><b>OPD No : <?php echo e(@$opd_patient_details->ipd_prefix); ?><?php echo e(@$opd_patient_details->id); ?> </b></td>
            ...
            <table style="width: 100%; ;margin: 10px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$opd_patient_details->all_patient_details->first_name); ?> <?php echo e(@$opd_patient_details->all_patient_details->middle_name); ?> <?php echo e(@$opd_patient_details->all_patient_details->last_name); ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$opd_patient_details->all_patient_details->year); ?>Y <?php echo e(@$opd_patient_details->all_patient_details->first_name); ?>M <?php echo e(@$opd_patient_details->all_patient_details->first_name); ?>D
                    </td>
                    <th style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        Gender
                    </th>
                ...
                <tr>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$opd_patient_details->all_patient_details->address); ?>, <?php echo e(@$opd_patient_details->all_patient_details->_state->name); ?>, <?php echo e(@$opd_patient_details->all_patient_details->_district->name); ?>
                    ...
                    <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                        <?php echo e(@$opd_patient_details->all_patient_details->blood_group); ?>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="position: fixed; right: 20px; bottom: 15px;">
                    <b>Date:</b> <?php echo e($opdPrescription->prescription_date); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/opd/prescription/print-prescription.blade.php ENDPATH**/ ?>