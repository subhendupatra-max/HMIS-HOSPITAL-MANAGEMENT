                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="employee_id"  value="<?php echo e(old('employee_id')); ?>" name="employee_id" placeholder="Employee Id" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="designation" value="<?php echo e(old('designation')); ?>" name="designation" placeholder="Designation">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control select2-show-search select2-hidden-accessible" value="<?php echo e(old('department')); ?>"  tabindex="-1" aria-hidden="true" name="department" id="department">
                                <option>Select Department</option>
                                <optgroup label="">
                                    <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->name); ?>"><?php echo e($item->department_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </optgroup>
                            </select>
                            <?php $__errorArgs = ['role'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="specialist" value="<?php echo e(old('specialist')); ?>" name="specialist" placeholder="Specialist">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="first_name" value="<?php echo e(old('first_name')); ?>" id="first_name" placeholder="First Name">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="<?php echo e(old('father_name')); ?>"  name="father_name" id="father_name" placeholder="Father Name">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="<?php echo e(old('mother_name')); ?>"  name="mother_name" id="mother_name" placeholder="Mother Name">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" value="<?php echo e(old('date_of_birth')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" class="form-control" name="date_of_joining" id="date_of_joining" value="<?php echo e(old('date_of_joining')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" name="phone_no" id="phone_no" value="<?php echo e(old('phone_no')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" name="emg_phone_no" id="emg_phone_no" value="<?php echo e(old('emg_phone_no')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="pan_number" id="pan_number" value="<?php echo e(old('pan_number')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="identification_number" id="identification_number" value="<?php echo e(old('identification_number')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="local_identification_number" id="local_identification_number" value="<?php echo e(old('local_identification_number')); ?>" >
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\hospital_software\resources\views/appPages/Users/userCreation.blade.php ENDPATH**/ ?>