...
<div class="row">
	<div class="col-lg-12">
		<div class="card custom_cardx">
			<div class="card-header">
				<div class="card-title">Income & Expance</div>
			</div>
			<div class="card-body">
				<canvas id="myChart" style="width: 552px;"></canvas>
			</div>
		</div>
		<div class="card custom_cardx">
			<div class="card-header">
			...
			<div class="card-body">
				<canvas id="myChart1" style="width: 552px;"></canvas>
			</div>
		</div>
	</div><!-- col-6 -->
</div>
...
new Chart("myChart", {
  ...
  data: {
    labels: xValues,
    datasets: [{ 
      data: [86000,114000,10600,10600,10708,11102,133001,221004,783042,247824,0,0],
      borderColor: "red",
      fill: false
    }, { 
      data: [30022,70022,200022,500022,60002,40002,20002,1000,200222,100,0,0],
      borderColor: "blue",
      fill: false
    }]
  },
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ame_inventory\resources\views/appPages/dashboard.blade.php ENDPATH**/ ?>