...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="">
                <form class="row g-3" method="POST" action="<?php echo e(route('update-Inventory-item')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-12">
                        <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <select name="item_type_id" class="form-control">
                                            ...
                                            <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $item->item_type_id ? 'selected' : ''); ?>><?php echo e($value->item_type_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 itemeditinventory">
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo e($item->part_no); ?>" id="part_no" name="part_no" required placeholder="Enter Part No">
                                    </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <select name="item_categoris[]" required class="form-control select2" multiple>
                                            ...
                                            <option value="<?php echo e($value->id); ?>" <?php for ($i = 0; $i < (count($cate) - 1); $i++) {
                                                                                if ($cate[$i] == $value->id) {
                                                                                    echo 'selected';
                                                                                }
                                                                            } ?>><?php echo e($value->item_catagory_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <select id="unit" name="unit" class="form-control select2">
                                            ...
                                            <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $item->unit_id ? 'selected' : ''); ?>><?php echo e($value->units); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <select name="manufacturer" class="form-control select2">
                                            ...
                                            <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $item->manufacturer ? 'selected' : ''); ?>><?php echo e($value->manufacture_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                            ...
                                            <td>
                                                <select class="form-control" name="item_attribute[]">
                                                    ...
                                                    <option <?php if ($value->attribute_name == $values->attribute_name) {
                                                                echo "Selected";
                                                            } ?> value="<?php echo e($value->attribute_name); ?>"><?php echo e($value->attribute_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                </select>
                                            </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/setup/Inventory/item/edit-item.blade.php ENDPATH**/ ?>