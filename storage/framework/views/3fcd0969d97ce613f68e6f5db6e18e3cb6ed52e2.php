                        ...
                        <div class="col-md-8">
                            ...
                            <select name="vendor_name[]" multiple="multiple" class="multi-select select2-show-search">
                                ...
                                <option value="<?php echo e($value->id); ?>">
                                    <?php echo e($value->vendor_name); ?>,<?php echo e($value->vendor_address); ?>,<?php echo e($value->vendor_gst); ?></option>
                    ...
                    <table class="table table-striped card-table table-vcenter text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="<?php echo e(route('add-vendor-quatation')); ?>"
                                    ...
                                    <a style="color:blue"
                                        href="<?php echo e(asset('public/quatation/')); ?>/<?php echo e(@$value->vendor_quatation); ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <span class="requisition_header">Requisition No : </span><span
                                            class="requisition_text"><?php echo e(@$requisition_details->requisition_prefix); ?><?php echo e(@$requisition_details->id); ?>
                                    ...
                                    <div class="col-md-4">
                                        <span class="requisition_header">Generated By : </span><span
                                            class="requisition_text"><?php echo e(@$requisition_details->generate_by_name->first_name); ?>

                                            <?php echo e(@$requisition_details->generate_by_name->last_name); ?></span>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <span class="requisition_header">Selected Vendor Details : </span><br><span
                                            class="requisition_text"><?php echo e($value->sl_vendors_join->vendor_name); ?>,<?php echo e($value->sl_vendors_join->vendor_address); ?>,<?php echo e($value->sl_vendors_join->vendor_gst); ?></span><br>
                                        <?php if(!empty($value->comment)): ?>
                                        <span style="color:blue;cursor: pointer;" data-placement="top"
                                            data-toggle="tooltip" title="<?php echo e($value->comment); ?>"><i class="fa fa-eye"></i>
                                            View Note</span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-6">
                                            ...
                                            <ul class="timeline mb-0">
                                                ...
                                                <li class="mt-0">
                                                    <div class="d-flex"><span
                                                            class="time-data"><i class="fa fa-circle text-danger"></i> <?php echo e(@$user->permisison_users_vendor->first_name); ?>

                                                            <?php echo e(@$user->permisison_users_vendor->last_name); ?></span><span
                                                    ...
                                                    <p class="text-muted fs-12">
                                                        <span class="text-info">
                                                            <?php if($user->user_id == Auth::id() && ( $user->permission_type
                                                            == 'Parallal' ||
                                                            ...
                                                            <td><a class="btn btn-pill btn-info btn-sm"
                                                                    ...
                                                                    type="button"><?php echo e($user->status); ?></a></td>
                                                            <?php else: ?>
                                                            <td><a class="btn btn-pill btn-info btn-sm"
                                                                    type="button"><?php echo e($user->status); ?></a>
                                                            </td>
                                                            <?php endif; ?>
                                                        </span>
                                                    </p>
                                                    ...
                                                    <p class="text-muted fs-12"><span
                                                            ...
                                                            data-toggle="tooltip" title="<?php echo e($user->comment); ?>"><i
                    ...
                    <table class="table table-striped card-table table-vcenter text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(@$requisition->fetch_medicine_name->medicine_name); ?>(<?php echo e(@$requisition->fetch_medicine_name->catagory_name->medicine_catagory_name); ?>)
                                </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/pharmacy/purchase/requisition/medicine-requisition-details.blade.php ENDPATH**/ ?>