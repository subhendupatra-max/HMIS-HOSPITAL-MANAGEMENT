        ...
        <div class="card-header d-block">
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Item Transfer From One workshop to Another')): ?>
                        <a href="<?php echo e(route('item-transfer')); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>  Transfer </a>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/item/main-stock.blade.php ENDPATH**/ ?>