...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 ">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($editSlots->total_amount); ?>" id="total_amount" name="total_amount" readonly>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DITS-HMIS\resources\views/setup/appointment/slots/edit-slots.blade.php ENDPATH**/ ?>