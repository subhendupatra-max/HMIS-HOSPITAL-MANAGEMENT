...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Add New Pathology Group Test</h4>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('save-pathology-test-group')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="group_name" class="form-label"> Test Group Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Enter Group Name" value="<?php echo e(old('group_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group col-md-12 mt-0 ">
                    <table class="table card-table table-vcenter text-nowrap" id="subhendu">
                        <thead>
                            <tr>
                                <th scope="col" style="width: 98%"> Test Name <span class="text-danger">*</span></th>
...
<script>
    ...
    function addnewrow() {
        var html = `<tr id="rowid${i}">
                        <td>
                            <select id="test_name${i}" class="form-control select2-show-search"
                                name="test_name[]">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/pathology/test-group/add-group.blade.php ENDPATH**/ ?>