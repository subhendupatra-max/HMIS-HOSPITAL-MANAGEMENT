...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="charge_category" class="form-control select2-show-search" name="charge_category" data-subcatagory_id="<?php echo e($editSlots->charge_sub_category); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="charge_sub_category" class="form-control select2-show-search" data-charge_id="<?php echo e($editSlots->charge); ?>" id="charge_sub_category" required>
...
<script>
    $(document).ready(function() {
        $("#charge_sub_category").change(function(event) {
            event.preventDefault();
            let charge = $("#charge_sub_category").val();
            let chargeName = $(this).attr("data-charge_id");
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        let sel = (value.id == chargeName ? 'selected' : '');
