...
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('update-opd-ticket-fees-details')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                  <input type="hidden" name="id" value="<?php echo e($editTicketFees->id); ?>">
                    <div class="form-group">
                        ...
                        <select name="patient_type" class="form-control select2-show-search" id="patient_type">
                            ...
                            <option value="<?php echo e($patient); ?>" <?php echo e($patient == $editTicketFees->patient_type ? 'selected' : " "); ?>> <?php echo e($patient); ?></option>
