    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="btn-list ggdtretew">
                <a href="<?php echo e(route('addmanufactureList')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Manufacture</a>
            </div>
                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(url('/editItem')); ?>/<?php echo e($item->item_id); ?>" class="btn btn-success btn-sm" data-toggle="tooltip-primary" data-placement="top" title="Edit Item"><i class="fa fa-pencil"></i></a>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ame_inventory\resources\views/appPages/master/manufacture/manufacture-list.blade.php ENDPATH**/ ?>