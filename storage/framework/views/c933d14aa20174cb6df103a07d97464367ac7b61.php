...
<div class="col-lg-12 col-xl-4 col-md-6 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('unitEditAction')); ?>">
                <?php echo csrf_field(); ?>
                <div class="">
                            ...
                            <select class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)" name="base_val" id="base_val">
                                <optgroup label="Base Unit">
                                    ...
                                    <?php $__currentLoopData = $allItemUnit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->units); ?>">
                                            <?php echo e($item->units); ?></option>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\ameInventory\resources\views/appPages/master/itemUnit/itemUnitEdit.blade.php ENDPATH**/ ?>