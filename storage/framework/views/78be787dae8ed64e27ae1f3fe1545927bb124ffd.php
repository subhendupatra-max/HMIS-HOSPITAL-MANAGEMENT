...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <div class="">
                <form class="row g-3" method="POST" action="<?php echo e(route('itemattributeAdd')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ameInventory\resources\views/appPages/master/item/add-item-attribute.blade.php ENDPATH**/ ?>