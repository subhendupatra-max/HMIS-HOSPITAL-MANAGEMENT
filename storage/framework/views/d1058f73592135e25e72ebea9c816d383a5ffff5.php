            ...
            <form method="POST"  action="<?php echo e(route('vendorEditAction')); ?>">
                ...
                <div class="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="vendor_name" name="vendor_name" value="<?php echo e($data->vendor_name); ?>" placeholder="Enter Vendor Name" required>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ame_inventory\resources\views/appPages/master/vendor/vendorEdit.blade.php ENDPATH**/ ?>