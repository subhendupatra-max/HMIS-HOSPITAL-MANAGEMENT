                        ...
                        <div class="card-body">
                            <div class="media mt-0">
                                <figure class="rounded-circle align-self-start mb-0">
                                    <img src="<?php echo e(asset('public/profile_picture')); ?>/<?php echo e($item->profile_image); ?>" class="avatar brround avatar-md mr-3">
                                </figure>
    ...
    <table id="example" class="table table-borderless text-nowrap key-buttons">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img alt="User Avatar" style="height:25px;width: 25px" class="rounded-circle" src="<?php echo e(asset('public/profile_picture')); ?>/<?php echo e($item->profile_image); ?>" >  <?php echo e(@$item->name); ?></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\hospital_software\resources\views/appPages/Users/user-list.blade.php ENDPATH**/ ?>