...
<div style="padding: 0px 7px 0px 7px;">
    ...
    <table style="width: 100%; border:1px soild black;border-collapse: collapse">
        ...
        <tr style="width:100%">
            <td style="width:100%">
                <h1
                    style="text-align:center;font-size: 20px;margin: 10px 0px 10px 0px; color: #000;padding: 5px 0px 5px 0px;  width: 100%;"> Bill Summary</h1>
            </td>
        </tr>
...
</html><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Ipd/billing/bill-print.blade.php ENDPATH**/ ?>