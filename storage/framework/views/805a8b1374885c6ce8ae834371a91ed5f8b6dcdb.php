                    ...
                    <table id="example" class="table table-borderless text-nowrap key-buttons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('vehicleDetails',$list->id)); ?>" class="text text-primary"><?php echo e(@$list->prefix); ?></a></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ame_inventory\resources\views/appPages/vehicle/vehicle-reg-list.blade.php ENDPATH**/ ?>