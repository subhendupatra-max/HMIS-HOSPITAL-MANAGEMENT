...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" id="medicine_company" name="medicine_company"
                                value="<?php echo e(old('medicine_company')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" id="medicine_composition" name="medicine_composition"
                                value="<?php echo e(old('medicine_composition')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" id="medicine_group" name="medicine_group"
                                value="<?php echo e(old('medicine_group')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" id="min_level" name="min_level" value="<?php echo e(old('min_level')); ?>"
                                required />
