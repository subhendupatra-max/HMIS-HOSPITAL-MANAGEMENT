            ...
            <form method="POST"  action="<?php echo e(route('editRoleAction')); ?>">
                ...
                <div class="">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($role->name); ?>"  id="role" name="role"  required>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS\resources\views/role/editRole.blade.php ENDPATH**/ ?>