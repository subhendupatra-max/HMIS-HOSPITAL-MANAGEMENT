...
<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('rackEditAction')); ?>">
                <?php echo csrf_field(); ?>
                
                <div class="">
                    <div class="form-group">
                        <label for="rack_name" class="form-label">Rack Name</label>
                        <input type="text" class="form-control" id="rack_name" name="rack_name" placeholder="Enter Rack Name"  value="<?php echo e($rack->name); ?>" required>
                        <input type="text" name="rack_id" id="rack_id" value="<?php echo e($rack->id); ?>" hidden>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2-show-search" id="store_id" name="store_id"   data-placeholder="Choose one (with searchbox)">
                            <optgroup label="All Stores">
                                <?php $__currentLoopData = $allStore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php if($item->id == $rack->store_id): ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ame_inventory\resources\views/appPages/master/rack/rackEdit.blade.php ENDPATH**/ ?>