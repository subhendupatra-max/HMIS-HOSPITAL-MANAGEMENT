            ...
            <div class="row no-gutters">
                <div class="col-lg-5 col-xl-4 border-right">
                    ...
                    <div class="options px-5 pt-5  border-bottom pb-3">
                        <form method="post" action="<?php echo e(route('add-radiology-charges-for-a-patient')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-12 mb-2">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-7 col-xl-8">
                    <form method="post" action="<?php echo e(route('save-radiology-charge')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6 adchargee ">
                                    ...
                                    <?php $__errorArgs = ['billing_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/radiology/patient-test/patient-test-add.blade.php ENDPATH**/ ?>