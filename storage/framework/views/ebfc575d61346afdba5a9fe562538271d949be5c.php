    ...
    <table style="width: 100%; border:1px soild black;border-collapse: collapse">
        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: left;font-size: 11px; padding: 5px 10px 5px 10px;border: 1px solid #899499;">
                    <b>UHID No. :
                        <?php echo e($ipd_details->all_patient_details->patient_prefix); ?>/<?php echo e($ipd_details->all_patient_details->id); ?></b>
                </td>
        ...
        ?>
                ...
                <td rowspan="2" style="text-align: center;border: 1px solid #899499;">
                    ...
                    <img src="data:image/png;base64,<?php echo e(base64_encode($generatorPNG->getBarcode('@$ipd_details->ipd_prefix @$ipd_details->ipd_id', $generatorPNG::TYPE_CODE_128))); ?>"
        ...
        <table style="width: 100%; margin: 15px 0px 0px 0px;border: 1px solid #899499;border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;">
                    <?php echo e($ipd_details->all_patient_details->year); ?>Y <?php echo e($ipd_details->all_patient_details->month); ?>M
        ...
        <table style="width: 100%;margin:10px 0px 0px 0px">
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;"><?php echo e(@$value->standard_charges); ?>

                </td>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;"><?php echo e(@$value->cgst); ?>

                </td>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;"><?php echo e(@$value->sgst); ?>

                </td>
                <td style="text-align: left;font-size: 11px; padding: 10px 10px 10px 10px;border: 1px solid #000;"><?php echo e(@$value->igst); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/Ipd/_print/draft-bill.blade.php ENDPATH**/ ?>