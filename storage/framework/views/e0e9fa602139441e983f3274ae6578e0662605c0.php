...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('update-radiology-test-details')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e(@$radiology_test->id); ?>" />
                <div class="row">
                    <div class="form-group col-md-4">

                        <input type="text" id="test_name" value="<?php echo e(@$radiology_test->test_name); ?>" name="test_name" required="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="short_name"  value="<?php echo e(@$radiology_test->short_name); ?>" name="short_name" required="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="test_type" name="test_type"  value="<?php echo e(@$radiology_test->test_type); ?>" required="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 addnew">
                        ...
                        <select id="catagory_id" class="form-control" name="catagory_id">
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == @$radiology_test->catagory_id ?'selected':''); ?>><?php echo e($item->catagory_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 addnewblade">
                        ...
                        <input type="text"id="sub_catagory" name="sub_catagory" value="<?php echo e(@$radiology_test->sub_catagory); ?>"  required="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 addnewblade">
                        ...
                        <input type="text" id="method" name="method"  value="<?php echo e(@$radiology_test->method); ?>" required="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 addnewbladee ">
                        ...
                        <input type="text"  id="report_days" name="report_days"  value="<?php echo e(@$radiology_test->report_days); ?>" required="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 addnewde">
                        ...
                        <select id="charge_category" data-charge_name = <?php echo e($radiology_test->charge); ?> data-charge_sub_category="<?php echo e($radiology_test->charge_sub_category); ?>" class="form-control select2-show-search" name="charge_category">
                            ...
                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == @$radiology_test->charge_category ?'selected':''); ?> ><?php echo e($item->charges_catagories_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-4 addnewde">
                        ...
                        <select name="charge_sub_category" class="form-control select2-show-search" onchange="getChargeName(this.value,<?php echo e($radiology_test->charge); ?>)" id="charge_sub_category" required >
                    ...
                    <div class="form-group col-md-12 addnewblade">
                        ...
                        <textarea class="content" name="description"><?php echo e(@$radiology_test->description); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group col-md-12 mt-0 ">
                    <table class="table card-table table-vcenter text-nowrap">
                        ...
                        <tbody  id="subhendu">
                            <?php if(@$radiology_test_details[0]->id != null): ?>
                                <?php $__currentLoopData = $radiology_test_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    function getParameter(i) {
        ...
        $.ajax({
            url: "<?php echo e(route('find-range-by-parameter-in-radiology')); ?>",
            type: "POST",
            data: {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/radiology/test/edit.blade.php ENDPATH**/ ?>