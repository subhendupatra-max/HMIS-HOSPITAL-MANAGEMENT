                    ...
                    <ul class="side-menu app-sidebar3">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu ">
                                ...
                                <?php if(auth()->user()->can('Patient')): ?>
                                <li> <a href="<?php echo e(route('patient_details')); ?>" class="slide-item">Patient</a></li>
                                <?php endif; ?>
                                ...
                                <div class="mt-1">
                                    <form class="form-inline">
                                        <div class="search-element">
                                            <input type="search" class="form-control header-search" id="item_entry_reslt" onkeyup="get_all_item_result()" placeholder="Search With Patient Name" aria-label="Search" tabindex="1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
</html><?php /**PATH C:\xampp\htdocs\hospital\ameInventory1\resources\views/layouts/layout.blade.php ENDPATH**/ ?>