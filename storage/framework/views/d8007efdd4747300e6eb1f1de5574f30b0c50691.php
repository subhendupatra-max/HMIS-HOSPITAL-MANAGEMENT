                ...
                <div class="col-lg-4 col-xl-4 border-right">
                    <div class="mt-2">
                        <div class="col-md-12 mt-3 mb-3">
                            <span class="requisition_header">Patient details : </span><span class="requisition_text"><?php echo e($discount->patient_details->prefix . ' ' . $discount->patient_details->first_name . ' '
                                . $discount->patient_details->middle_name . ' ' . $discount->patient_details->last_name); ?><br><?php echo e($discount->patient_details->patient_prefix . ' ' .
                        ...
                        <div class="col-md-12 mt-3 mb-3">
                            <span class="requisition_header">Discount Requested By : </span><span
                                class="requisition_text"><span class="requisition_text"><?php echo e($discount->request_by_details->first_name); ?>

                                    <?php echo e($discount->request_by_details->last_name); ?></span>
                        </div>
                        <div class="col-md-12 mt-3 mb-3">
                            <span class="requisition_header">Discount Request Date : </span><span
                                class="requisition_text"><span class="requisition_text"><?php echo e(date('d-m-Y h:i A',
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/discount/discount_details.blade.php ENDPATH**/ ?>