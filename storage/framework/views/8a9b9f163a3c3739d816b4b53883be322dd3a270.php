    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <div class="card-body border-top">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-5"><?php echo e(@$pathology_patient_test_details->section); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-5"><?php echo e(@date('d-m-Y h:i A', strtotime($pathology_patient_test_details->date))); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-5">
                                            <?php if($pathology_patient_test_details->test_status == '0'): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-5">
                                            <?php if($pathology_patient_test_details->billing_status == '0'): ?>
                                            <span class="badge badge-warning">Billing Not Done</span>
                                            <?php elseif($pathology_patient_test_details->billing_status == '1'): ?>
                ...
                <h5 class="font-weight-bold text-center">       <?php echo e(@$pathology_patient_test_details->test_details->test_name); ?>(<?php echo e(@$pathology_patient_test_details->test_details->short_name); ?>) </h5>
            <form action="<?php echo e(route('update-pathology-report')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="col-md-12">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/pathology/add-pathology-test-result-details.blade.php ENDPATH**/ ?>