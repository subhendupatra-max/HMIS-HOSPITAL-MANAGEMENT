...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add medicine storeroom')): ?>
<div class="col-lg-12 col-xl-4 col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Add StoreRoom</h4>
        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DITS-HMIS-15-04-23\HMIS-HOSPITAL-MANAGEMENT\resources\views/setup/pharmacy/store-room/store-room-listing.blade.php ENDPATH**/ ?>