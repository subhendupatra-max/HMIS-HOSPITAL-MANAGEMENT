                                ...
                                <td>
                                    <div class="card-options">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Purchase Order')): ?>   
                                            <a class="dropdown-item" href="<?php echo e(url('po-delete')); ?>/<?php echo e(base64_encode($po->po_id)); ?>"><i class="fa fa-pencil"></i>   Edit</a>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\ameInventory\resources\views/appPages/item/purchase-order/purchase-order-list.blade.php ENDPATH**/ ?>